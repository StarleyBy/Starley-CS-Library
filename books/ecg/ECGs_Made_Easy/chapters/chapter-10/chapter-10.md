...
**1.** A branch of the __________ supplies the right atrium and right ventricle with blood.
...
**Answer: b.** A branch of the RCA supplies the right atrium and right ventricle with blood.
...
**2.** Stimulation of parasympathetic nerve fibers typically results in which of the following actions?
...
**Answer: d.** Parasympathetic stimulation slows conduction through the AV node, slows SA node discharge, and decreases atrial contractility.
...
**3.** The contribution of blood that is added to the ventricles and results from atrial contraction is called
a. afterload.
b. atrial kick.
c. cardiac output.
...
**Answer: b.** Atrial kick contributes an additional 10% to 30% of blood flow to ventricular filling.
...
**4.** Which of the following are semilunar valves?
...
**Answer: a.** The aortic and pulmonic valves are semilunar valves. The tricuspid and mitral are atrioventricular valves.
...
**5.** The left main coronary artery divides into the
...
**Answer: d.** The left main coronary artery divides into the left anterior descending (LAD) and circumflex (Cx) arteries.
**OBJ:** Name the primary branches and areas of the heart supplied by the right and left coronary arteries.
...
**6.** __________ cells are specialized cells of the electrical conduction system responsible for the spontaneous generation and conduction of electrical impulses.
a. Working
b. Pacemaker
c. Mechanical
d. Contractile
...
**Answer: b.** Pacemaker cells (also called conducting or automatic cells) generate and conduct electrical impulses spontaneously.
...
**7.** The absolute refractory period
...
**Answer: b.** The ARP begins with the onset of the QRS complex and terminates at approximately the apex of the T wave.
...
**8.** Which of the following statements is true regarding the QT interval?
...
**Answer: d.** The QT interval is measured from the beginning of the QRS complex to the end of the T wave, representing total ventricular activity (depolarisation + repolarisation).
**OBJ:** Define and describe the significance of the QT interval.

</div></details>

<details class="med-details"><summary>

**9.** How do you determine whether the atrial rhythm on an electrocardiogram (ECG) tracing is regular or irregular?
...
**Answer: d.** Atrial regularity is determined by comparing P‑P intervals. Ventricular regularity is determined by comparing R‑R intervals.
**OBJ:** Describe a systematic approach to rhythm analysis.

</div></details>

<details class="med-details"><summary>

**10.** Which of the following ECG leads use two distinct electrodes, one of which is positive and the other negative?
...
**Answer: a.** Leads I, II, and III are bipolar limb leads – they use two distinct electrodes (positive and negative). Augmented leads (aVR, aVL, aVF) and chest leads (V₁–V₆) are unipolar.
**OBJ:** Describe correct anatomic placement of the standard limb leads, augmented leads, and chest leads.

</div></details>

<details class="med-details"><summary>

**11.** In sinus arrhythmia, a gradual decreasing of the heart rate is usually associated with
a. expiration.
b. inspiration.
...
**Answer: a.** In sinus arrhythmia, heart rate increases during inspiration and decreases during expiration.
...
**12.** An ECG rhythm strip shows a ventricular rate of 46 beats/min, a regular rhythm, a PR interval of 0.14 second, a QRS duration of 0.06 second, and one upright P wave before each QRS. This rhythm is
a. sinus arrest.
b. sinus rhythm.
c. SA block.
d. sinus bradycardia.
...
**Answer: d.** Rate <60 beats/min with normal P waves and normal intervals is sinus bradycardia.
...
**13.** SA block is a disorder of impulse __________, and sinus arrest is a disorder of impulse __________.
a. formation, conduction
b. conduction, formation
c. conduction, conduction
d. formation, formation

</summary><div class="details-content">

**Answer: b.** SA block is a disorder of impulse conduction (impulse formed but blocked from exiting). Sinus arrest is a disorder of impulse formation (SA node fails to generate impulse).
**OBJ:** Describe the ECG characteristics of SA block and sinus arrest.

</div></details>

<details class="med-details"><summary>

**14.** Signs and symptoms experienced during a tachydysrhythmia are usually primarily related to
a. vasoconstriction.
b. atrial irritability.
c. slowed conduction through the AV node.
d. decreased ventricular filling time and stroke volume.

</summary><div class="details-content">

**Answer: d.** Rapid heart rates shorten diastole, reducing ventricular filling time and stroke volume, which decreases cardiac output.
...
**15.** Which of the following correctly reflects examples of ectopic (latent) pacemakers?
...
**Answer: b.** Ectopic (latent) pacemakers include the AV junction and Purkinje fibres (ventricles). The SA node is the primary pacemaker, not latent.
**OBJ:** Describe the location, function, and intrinsic rate of pacemaker sites.

</div></details>

<details class="med-details"><summary>

**16.** A wandering atrial pacemaker rhythm with a ventricular rate of 60 to 100 beats/min may also be referred to as
a. atrial flutter.
b. atrial fibrillation (AFib).
c. multiform atrial rhythm.
d. multifocal atrial tachycardia.

</summary><div class="details-content">

**Answer: c.** Wandering atrial pacemaker (rate 60–100) is also called multiform atrial rhythm. If rate >100, it is called multifocal atrial tachycardia (MAT).
**OBJ:** Describe the ECG characteristics of wandering atrial pacemaker.

</div></details>

<details class="med-details"><summary>

**17.** The most common type of supraventricular tachycardia (SVT) is
a. atrial flutter.
...
**Answer: d.** AVNRT is the most common type of SVT.
**OBJ:** Describe the ECG characteristics of AVNRT.

</div></details>

<details class="med-details"><summary>

**18.** Which of the following is true with regard to treatment of a symptomatic patient with AFib?
...
b. With rate control, measures are taken (either pharmacologic or electrical) to reestablish sinus rhythm.
c. With rate control, the ventricular rate is increased to meet metabolic demands.
d. With rate control, the patient is cardioverted immediately regardless of anticoagulation status.

</summary><div class="details-content">

**Answer: a.** Rate control means the patient remains in AFib but the ventricular rate is controlled. Rhythm control reestablishes sinus rhythm.
**OBJ:** Describe the initial emergency care for AFib.

</div></details>

<details class="med-details"><summary>

**19.** If the onset or end of paroxysmal atrial tachycardia or paroxysmal supraventricular tachycardia (PSVT) is not observed on the ECG, the dysrhythmia is called
a. sinus tachycardia.
...
**Answer: c.** Without observed onset/offset, the rhythm is simply called SVT.
**OBJ:** Explain the terms paroxysmal atrial tachycardia and PSVT.

</div></details>

<details class="med-details"><summary>

**20.** Which of the following is the most common sustained dysrhythmia in adults?
a. AFib
b. Sinus bradycardia
c. Junctional rhythm
...
**Answer: a.** Atrial fibrillation is the most common sustained dysrhythmia in adults.
**OBJ:** Describe the ECG characteristics of AFib.

</div></details>

<details class="med-details"><summary>

**21.** Which of the following statements is true regarding the differences between premature atrial complexes (PACs) and premature junctional complexes (PJCs) in leads II, III, and aVF?
a. A PAC has a narrow QRS complex, and a PJC has a wide QRS complex.
b. A PAC has a negative P wave before the QRS complex, and a PJC has a positive P wave before each QRS complex.
c. A P wave may or may not be present with a PAC, whereas a PJC typically has a positive P wave before the QRS complex.
d. A PAC typically has a positive P wave before the QRS complex, whereas a P wave may or may not be present with a PJC.

</summary><div class="details-content">

**Answer: d.** PAC typically has an upright P wave before QRS. PJC may have no P wave, or an inverted P wave before/after QRS.
**OBJ:** Describe the ECG characteristics of PJCs.

</div></details>

<details class="med-details"><summary>

**22.** A Wolff‑Parkinson‑White (WPW) pattern is associated with a
a. long PR interval, delta wave, and wide QRS complex.
...
**Answer: b.** WPW pattern: short PR, delta wave, wide QRS.
**OBJ:** Describe the ECG characteristics of WPW pattern.

</div></details>

<details class="med-details"><summary>

**23.** Which of the following ECG characteristics distinguishes atrial flutter from other atrial dysrhythmias?
...
**Answer: d.** Atrial flutter is characterised by saw‑tooth flutter waves (F waves).
**OBJ:** Describe the ECG characteristics of atrial flutter.

</div></details>

<details class="med-details"><summary>

**24.** When a junctional rhythm is viewed in lead II, where is the location of the P wave on the ECG if atrial and ventricular depolarization occur simultaneously?
...
**Answer: b.** If atria and ventricles depolarise simultaneously, the P wave is hidden within the QRS complex.
**OBJ:** Describe the ECG characteristics of a junctional escape rhythm.

</div></details>

<details class="med-details"><summary>

**25.** The usual rate of nonparoxysmal junctional tachycardia is
a. 50 to 80 beats/min.
b. 80 to 120 beats/min.
c. 101 to 140 beats/min.
d. 150 to 300 beats/min.

</summary><div class="details-content">

**Answer: c.** Nonparoxysmal (automatic) junctional tachycardia usually has a rate of 101–140 bpm. Paroxysmal (focal) junctional tachycardia is often ≥140 bpm.
**OBJ:** Describe the ECG characteristics of junctional tachycardia.

</div></details>

<details class="med-details"><summary>

**26.** Junctional (or ventricular) complexes may come early (before the next expected sinus beat) or late (after the next expected sinus beat). If the complex is *early*, it is called a(n) __________; if the complex is *late*, it is called a(n) __________.
a. escape beat; premature complex
b. premature complex; escape beat
c. ectopic beat; sinus beat
d. sinus beat; ectopic beat

</summary><div class="details-content">

**Answer: b.** Early = premature complex; late = escape beat.
...
**27.** Depending on the severity of the patient's signs and symptoms, management of slow rhythms may require therapeutic intervention including
a. defibrillation.
b. administration of atropine.
c. synchronized cardioversion.
d. vagal maneuvers and administration of adenosine.

</summary><div class="details-content">

**Answer: b.** Atropine is the drug of choice for symptomatic bradycardia. Defibrillation and cardioversion are for tachyarrhythmias. Vagal maneuvers slow the heart (used for tachycardias, not bradycardias).
**OBJ:** Describe the initial emergency care for a junctional escape rhythm.

</div></details>

<details class="med-details"><summary>

**28.** The term for three or more premature ventricular complexes (PVCs) occurring in a row at a rate of more than 100/min is
...
**Answer: c.** Three or more PVCs in a row at >100 bpm is a run of ventricular tachycardia (VT).
**OBJ:** Explain the terms bigeminy, trigeminy, quadrigeminy, and run.

</div></details>

<details class="med-details"><summary>

**29.** PVCs that look alike in the same lead and begin from the same anatomic site (i.e., focus) are called __________ PVCs.
a. uniform
b. isolated
c. multiform
d. interpolated
...
**Answer: a.** Uniform PVCs arise from the same focus and look identical. Multiform PVCs differ in shape.
**OBJ:** Describe the ECG characteristics of PVCs.

</div></details>

<details class="med-details"><summary>

**30.** Which of the following dysrhythmias has QRS complexes that vary in shape and amplitude from beat to beat and appear to twist from upright to negative or negative to upright and back, resembling a spindle?
a. AFib
b. Idioventricular rhythm
c. Polymorphic VT (PMVT)
d. Monomorphic VT

</summary><div class="details-content">

**Answer: c.** Polymorphic VT (including torsades de pointes) has twisting QRS morphology.
**OBJ:** Describe the ECG characteristics of PMVT.

</div></details>

<details class="med-details"><summary>

**31.** When a delay or interruption in impulse conduction from the atria to the ventricles occurs as a result of a transient or permanent anatomic or functional impairment, the resulting dysrhythmia is called a(n)
a. sinus arrest.
b. SA block.
...
**Answer: d.** AV block refers to delayed or interrupted conduction from atria to ventricles.
**OBJ:** Describe the ECG characteristics of first‑degree AV block.

</div></details>

<details class="med-details"><summary>

**32.** Whenever the criteria for BBB have been met and lead V₁ displays an rSR′ pattern, you should suspect a
...
**Answer: b.** rSR′ pattern in V₁ (rabbit ears) is characteristic of RBBB.
...
**33.** The PR interval of a first‑degree AV block
...
**Answer: b.** First‑degree AV block: constant PR interval >0.20 sec, 1:1 relationship.
**OBJ:** Describe the ECG characteristics of first‑degree AV block.
...
**34.** Which of the following is an example of a complete AV block?
...
**Answer: d.** Third‑degree AV block (complete heart block) – no P waves conducted to ventricles.
**OBJ:** Describe the ECG characteristics of third‑degree AV block.

</div></details>

<details class="med-details"><summary>

**35.** Which of the following statements is correct regarding 2:1 AV block?
a. The atrial rhythm is irregular.
b. The PR interval remains constant.
c. The ventricular rate is twice the atrial rate.
d. The level of the block is located within the SA node.

</summary><div class="details-content">

**Answer: b.** In 2:1 AV block, the PR interval is constant. Atrial rhythm is regular (P waves plot through). Atrial rate is twice the ventricular rate. The block is in the AV node or His‑Purkinje system, not SA node.
...
**36.** The terms *advanced* or *high‑grade* second‑degree AV block may be used to describe __________ or more consecutive P waves that are not conducted.
a. one
b. three
c. six
d. twelve
...
**Answer: b.** Advanced second‑degree AV block: three or more consecutive nonconducted P waves.
**OBJ:** Describe 2:1 AV block and advanced second‑degree AV block.
...
**37.** Which lead is probably the best to use when differentiating between RBBB and LBBB?
a. V₁
b. V₄
c. II
d. aVR
...
**Answer: a.** Lead V₁ is the best lead for differentiating RBBB from LBBB (rSR′ vs QS pattern).
**OBJ:** Describe the appearance of RBBB and LBBB as seen in lead V₁.
...
d. the successful conduction of an artificial pacemaker's impulse through the myocardium, resulting in depolarization.

</summary><div class="details-content">

**Answer: d.** Capture = pacemaker stimulus successfully depolarises the myocardium.
**OBJ:** Discuss the terms pacing, capture, electrical capture, mechanical capture, and sensitivity.

</div></details>

<details class="med-details"><summary>

**39.** How many seconds of each lead are provided on a standard 12‑lead ECG?
a. 2.5 seconds
b. 5 seconds
c. 6 seconds
d. 10 seconds
...
**Answer: a.** A standard 12‑lead ECG provides a 2.5‑second view of each lead. A continuous rhythm strip (usually lead II) is often included at the bottom for rate/rhythm assessment.
...
**40.** Although a right ventricular infarction may occur by itself, it is more commonly associated with a(n) __________ wall myocardial infarction (MI).
a. septal
b. lateral
c. inferior
d. anterior
...
**Answer: c.** RVI is most commonly associated with inferior MI (RCA occlusion).
...
**41.** Poor R‑wave progression is a phrase used to describe R waves that decrease in size from V₁ to V₄. This is often seen in a(n) __________ infarction.
a. inferobasal
b. anteroseptal
c. anterolateral
d. inferoposterior
...
**Answer: b.** Poor R‑wave progression (decreasing R wave amplitude from V₁ to V₄) is often seen in anteroseptal infarction, but may be a normal variant (especially in young women) or caused by LBBB, LVH, COPD.
...
**42.** The right atrium receives deoxygenated blood from the __________ (which carries blood from the head and upper extremities), the __________ (which carries blood from the lower body), and the __________ (which receives blood from the intracardiac circulation).
...
**43.** A beat originating from the AV junction that appears later than the next expected sinus beat is called a(n) __________.

</summary><div class="details-content">

**Answer:** junctional escape beat  
...
**44.** A rapid, wide‑QRS rhythm associated with pulselessness, shock, or heart failure should be presumed to be __________.
...
**45.** PACs associated with a wide QRS complex are called __________ PACs, indicating that conduction through the ventricles is abnormal.

</summary><div class="details-content">

**Answer:** aberrantly conducted  
**OBJ:** Describe the ECG characteristics of PACs.

</div></details>

<details class="med-details"><summary>

**46.** __________ is the period of relaxation during which a heart chamber is filling.
...
**47.** The thick, muscular middle layer of the heart wall that contains the atrial and ventricular muscle fibers necessary for contraction is the __________.
...
**48.** Delivery of an electrical current timed for delivery during the QRS complex is called __________.
...
**49.** Sometimes when a PAC occurs very prematurely and close to the T wave of the preceding beat, only a P wave may be seen with no QRS after it (appearing as a pause). This type of PAC is termed a(n) __________ PAC.

</summary><div class="details-content">

**Answer:** nonconducted (blocked)  
**OBJ:** Describe the ECG characteristics of PACs.
...
**50.** If the AV junction paces the heart, the electrical impulse must travel in a(n) __________ direction to activate the atria.

</summary><div class="details-content">

**Answer:** retrograde (backward)  
**OBJ:** Describe the location, function, and intrinsic rate of the AV junction.

</div></details>

<details class="med-details"><summary>

**51.** A demand pacemaker is also known as a(n) __________ pacemaker.

</summary><div class="details-content">

**Answer:** synchronous (or noncompetitive)  
**OBJ:** Explain the differences between fixed‑rate and demand pacemakers.

</div></details>

<details class="med-details"><summary>

**52.** The axes of leads I, II, and III form an equilateral triangle with the heart at the center (Einthoven's triangle). If the augmented limb leads are added to this configuration and the axes of the six leads moved in a way in which they bisect each other, the result is the __________.

</summary><div class="details-content">

**Answer:** hexaxial reference system  
...
Leads II, III, aVF: __________
Leads V₁, V₂: __________
Leads V₃, V₄: __________
Leads I, aVL, V₅, V₆: __________
...
List the following structures in correct order:
Right atrium
Mitral valve
Aorta
Tricuspid valve
...
**56.** List three uses for ECG monitoring.
...
**57.** Describe the appearance of a pathologic Q wave.

</summary><div class="details-content">

**Answer:** A pathologic Q wave is more than 0.04 second in duration or more than one third the height of the following R wave in that lead.  
**OBJ:** Define and describe the significance of the Q wave.

</div></details>

<details class="med-details"><summary>

**58.** What is the important difference between a sinus tachycardia and a sinus rhythm?

</summary><div class="details-content">

**Answer:** A sinus rhythm has a rate of 60 to 100 beats/min. A sinus tachycardia has a rate of 101 to 180 beats/min (or up to 220 minus age).  
**OBJ:** Describe the ECG characteristics of sinus tachycardia.

</div></details>

<details class="med-details"><summary>

**59.** List two possible causes of artifact on an ECG tracing.

</summary><div class="details-content">

**Answer:** Any two of: loose electrodes, broken wires or ECG cables, muscle tremor, patient movement, external chest compressions, 60‑cycle interference.  
**OBJ:** Define the term artifact and explain methods used to minimize its occurrence.

</div></details>

<details class="med-details"><summary>

**60.** How do coarse and fine ventricular fibrillation differ?

</summary><div class="details-content">

**Answer:** Coarse VF has waves that are 3 mm or more in amplitude. Fine VF has waves less than 3 mm in amplitude.  
**OBJ:** Describe the ECG characteristics of VF.

</div></details>

<details class="med-details"><summary>

**61.** List four reasons why the AV junction may assume responsibility for pacing the heart.

</summary><div class="details-content">

**Answer:**  
1. The SA node fails to discharge (e.g., sinus arrest).  
2. An impulse from the SA node is generated but blocked as it exits the SA node (e.g., SA block).  
3. The rate of discharge of the SA node is slower than that of the AV junction (e.g., sinus bradycardia or slower phase of sinus arrhythmia).  
4. An impulse from the SA node is generated and conducted through the atria but is not conducted to the ventricles (e.g., AV block).  
**OBJ:** Describe the location and function of the AV junction.

</div></details>

<details class="med-details"><summary>

**62.** Explain why patients who experience AFib are at increased risk of having a stroke.

</summary><div class="details-content">

**Answer:** Because the atria do not contract effectively and expel all of the blood within them, blood may pool within them and form clots. A clot may dislodge on its own or because of conversion to a sinus rhythm. A stroke can result if a clot moves from the atria and lodges in an artery in the brain.  
**OBJ:** Describe the ECG characteristics and complications of AFib.

</div></details>

<details class="med-details"><summary>

**63.** On the ECG, what do the ST segment and T wave represent?

</summary><div class="details-content">

**Answer:** The ST segment represents the early part of ventricular repolarization. The T wave represents ventricular repolarization.  
**OBJ:** Define and describe the significance of the ST segment and T wave.

</div></details>

<details class="med-details"><summary>

**64.** Fill in the blank areas in the table below.
...
| Rate (beats/min) | 150 to 250 | Atrial rate typically 240 to 300; ventricular rate variable | Atrial rate 300 to 600; ventricular rate variable |
...
| PR interval | If P waves are seen, PRI usually 0.12–0.20 sec | Not measurable | Not measurable |
...
**OBJ:** Describe the ECG characteristics of AVNRT, atrial flutter, and AFib.

</div></details>

<details class="med-details"><summary>

**65.** Explain the difference between electrical capture and mechanical capture.

</summary><div class="details-content">

**Answer:** Electrical capture is evidenced on the ECG as a pacemaker spike followed by an atrial or ventricular complex. Mechanical capture is assessed by palpating the patient's pulse or observing pressure waveforms (right atrial, left atrial, pulmonary artery, or arterial).  
**OBJ:** Discuss the terms capture, electrical capture, and mechanical capture.

</div></details>

<details class="med-details"><summary>

**66.** List four characteristics of cardiac cells.
...
**67.** Explain what is meant by the phrase "anatomically contiguous leads".

</summary><div class="details-content">

**Answer:** Anatomically contiguous leads are leads that look at the same or adjacent areas of the heart, or numerically consecutive chest leads (e.g., V₁–V₂, V₂–V₃, V₃–V₄, etc.).  
**OBJ:** Relate the cardiac surfaces or areas represented by the ECG leads.
...
**68.** Indicate the ECG criteria for the following dysrhythmias:
...
**69.** Fill in the blank areas in the table below.
...
| ECG Finding | Idioventricular Rhythm | Accelerated Idioventricular Rhythm | Monomorphic Ventricular Tachycardia |
|-------------|------------------------|------------------------------------|--------------------------------------|
| Rhythm | Essentially regular | Essentially regular | Usually regular |
| Rate (beats/min) | 20 to 40 | 41 to 100 (some say 41–120) | 101 to 250 (some say 121–250) |
...
**OBJ:** Describe the ECG characteristics of idioventricular rhythm, accelerated idioventricular rhythm, and monomorphic VT.

</div></details>

<details class="med-details"><summary>

**70.** What is the purpose of a dual‑chamber pacemaker?

</summary><div class="details-content">

**Answer:** A dual‑chamber pacemaker stimulates the right atrium and right ventricle sequentially, mimicking normal cardiac physiology and preserving the atrial contribution to ventricular filling (atrial kick).  
**OBJ:** Explain the differences between single‑chamber and dual‑chamber pacemakers.
...
## Posttest Rhythm Strips</summary>
<div class="details-content">
...
**72. Fig. 10.2** (Modified from Aehlert B: ECG study cards, St. Louis, 2004, Mosby.)
...
**73. Fig. 10.3** (From Aehlert B: ECG study cards, St. Louis, 2004, Mosby.)
...
Interpretation: Second‑degree AV block type I at 70 beats/min
...
Ventricular paced activity? Yes  
Pacemaker malfunction? No  
Interpretation: Ventricular paced rhythm with 100% capture at 65 pulses/min (from the answer section for Fig. 10.16 – but this is Fig. 10.75. However, checking the provided answers, the last few strips (145–146) have answers from the file. Let me use the provided answer for Fig. 10.75 from the Posttest Rhythm Strip Answers section: it says:  
Rhythm: Irregular; Rate: 71 beats/min (sinus beats); P waves: Upright before each QRS; one early P wave distorts the T wave of beat 4 (most clearly seen in lead MCL₁); PR interval: 0.20 second (lead II); QRS duration: 0.12 second (lead II); QT interval: 0.40 to 0.44 second (lead II); Interpretation: Sinus rhythm at 71 beats/min with a wide QRS and a nonconducted PAC.
