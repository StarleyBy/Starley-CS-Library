...
##### Dilated cardiomyopathy (DCM) is a chronic heart muscle disease defined by left or biventricular dilatation and systolic dysfunction not explained by abnormal loading conditions or coronary artery disease. More than 60% of DCM cases are familial with identifiable genetic defects, while acquired phenocopies are sporadic and potentially reversible. This chapter provides a comprehensive overview of genetic and nongenetic DCM, including autoimmune, peripartum, alcoholic, cirrhotic, and toxic forms, as well as transient and reversible cardiomyopathies, cardiovascular oncotoxicity, and prognosis.
...
* **DCM definition:** Chronic heart muscle disease with LV (or biventricular) dilatation and systolic impairment, unexplained by abnormal loading conditions or significant coronary artery disease (ESC/ AHA criteria). LV wall thickness is normal.
* **Familial vs. nongenetic:** >60% of DCM is familial (genetic), with >100 disease genes identified. Nongenetic (acquired) DCM includes autoimmune, toxic, inflammatory, peripartum, and metabolic forms, often potentially reversible if the cause is removed.
* **Incidence/prevalence:** Phenotype‑based estimates: ~6.0 per 100,000 person‑years; prevalence ~36.5 per 100,000 (1:2500). These are pre‑genetic era data; new estimates will rise with early diagnosis and family screening.
* **Etiology‑based prevalence:** Most DCM subtypes are rare (<1:2000). Familial DCM (FDCM) burden is dynamic and evolving.

### Diagnostic Workup and Family Screening
* **Clinical presentation:** Symptoms of systolic HF – fatigue, dyspnoea, palpitations, fluid retention. Diagnosis requires LV systolic dysfunction (reduced EF on 2D echo) and LV dilatation (Z‑score >2 SD for volumes/diameters corrected for BSA, height, age).
* **Exclusion of CAD:** Coronary angiography (or CT angiography) is routine to rule out ischaemic cause. Functional testing (perfusion imaging) helps assess ischaemia.
* **Advanced imaging:** CMR is increasingly used to confirm diagnosis, quantify myocardial fibrosis, detect hypertrabeculation/LVNC, and identify early phenotypes. 3D echo and contrast echo improve volume assessment; deformation imaging and tagging aid early diagnosis.
* **Family screening (three‑step):** (1) Deep phenotyping of proband (anthropometry, skin, hair, vision, musculoskeletal, auditory, nervous systems). (2) Genetic counselling, pedigree construction, collection of relatives' history. (3) Clinical screening of relatives (ECG, echo, biochemistry) independent of genetic testing.
* **Findings in relatives:** Asymptomatic affected individuals; early LV remodelling/borderline dysfunction; ECG abnormalities (conduction defects, PR/QT changes, low/high voltages); elevated CK or lactate; extracardiac traits (hearing loss, diabetes, skin/skeletal/ocular abnormalities). Family screening provides natural history data and is indispensable for FDCM diagnosis.

### Genetics of DCM
* **Inheritance:** Most FDCM is autosomal dominant (50% transmission). Minority: autosomal recessive (25% risk), X‑linked recessive (50% risk when mother carrier; father transmits to all daughters but no sons), matrilineal (mitochondrial DNA; only females transmit).
* **Genetic heterogeneity:** >100 genes. Major groups:
    - Sarcomere genes (*TTN, MYH7, MYBPC3, TNNT2, TNNI3, MYL2, MYL3*) – 25‑30% of DCM. *TTN* truncating variants reported in 25% of DCM, but 1 in 500 controls carry such variants, so interpretation is cautious.
    - Nuclear envelope genes (*LMNA, EMD, SYNE1, TMPO*) – 7‑10% (LMNA is dominant).
    - Z‑disc genes (*ACTN2, ANKRD1, BAG3, CRYAB, CSRP3, FHL2, LDB3, MYPN, MURC, NEXN, PGM1, VCL*) – <10%.
    - Intermediate filament (*DES*) – ~1%.
    - Mitochondrial genes (nuclear and mtDNA) – <5%.
    - Dystrophin defects (*DMD*) – 6‑7% in male series; sarcoglycan complex – <1%.
    - Ion channels (*SCN5A*), *ABCC9*, *CHRM2* – <1%.
    - *PLN* (phospholamban) – variable; founder mutation R14del in Netherlands accounts for >10% of DCM in that population.
* **Mechanisms:** Mutations cause functional/structural damage via haploinsufficiency, altered contractility (gain/loss of function), mitochondrial dysfunction, etc. Two genes (*LMNA* and *DMD*) cause DCM without HCM; most other genes can cause multiple phenotypes (HCM, RCM, ARVC). MYH7 mutations can cause either HCM (gain of function) or DCM (loss of function).
* **Genetic testing:** Next‑generation sequencing (NGS) panels for nuclear and mitochondrial genes are routine. Interpretation is challenging: need to assess pathogenicity via pipelines, known mutation databases, functional studies (biopsy, iPSC‑derived myocytes), and segregation in families. Healthy mutation carriers are usually younger than affected. Up to 15% of DCM in Netherlands from *PLN* R14del.

### Grouping Genetic DCM by Disease Gene
* **Dilated cardiolaminopathies (DCM‑LMNA):** DCM with conduction system disease (up to 80%). Conduction defects (PR prolongation, AV block) often precede LV dysfunction. High arrhythmogenic risk (atrial and ventricular arrhythmias, sudden death). ICD implantation recommended (Class IIa, Level B) if LMNA mutation plus risk factors: NSVT, LVEF <45%, male sex, non‑missense mutations.
* **Dilated cardioemerinopathies (DCM‑EMD):** X‑linked recessive, mimic laminopathies (DCM + conduction disease + myopathy). Caused by *EMD* mutations. Management includes antiarrhythmics, pacing, ICD, transplantation.
* **Dilated cardiodystrophinopathies (DCM‑DYS):** X‑linked, caused by *DMD* rearrangements (mostly deletions). Present in males with DCM, often elevated CK (>80%). Low arrhythmogenic risk despite severe dysfunction. May show LVNC (~30%, prognostic marker). VAD and transplantation possible.
* **Dilated cardiozaspopathies (DCM‑LDB3):** Mutations in *LDB3* (Z‑disc Cypher‑ZASP). Associated with LVNC/hypertrabeculation. The common variant p.(D117N) may be a polymorphism in some populations.
* **Dilated cardiomyosinopathies (DCM‑MYH7):** MYH7 mutations causing DCM (loss of function) vs HCM (gain of function). Complex interactions with mitochondrial mutations and modifier genes may explain phenotype.
* **Dilated cardioMITOmyopathies:** Mitochondrial DNA or nuclear genes. Multiorgan syndromes (hearing loss, ptosis, myopathy, renal failure, stroke, diabetes). Phenotype may be HCM evolving to DCM, or primary DCM. Maternal inheritance for mtDNA; Mendelian for nuclear.
* **Dilated cardiotitinopathies (DCM‑TTN):** *TTN* truncating variants in 25% of FDCM and 18% sporadic DCM. Penetrance >95% in patients >40 years. No conduction or skeletal muscle involvement. Missense variants require bioinformatic filtering. Antisense exon skipping is a potential therapy.
* **Dilated phospholambanopathies (DCM‑PLN):** Mutations in *PLN* impair SR calcium handling. p.(Arg14del) is founder in Netherlands (10‑15% of DCM and ARVC). High arrhythmic risk, sudden death. ECG: low QRS voltage, inverted T waves in V4‑V6.

### Nongenetic DCM
* **Categories:** Autoimmune/immune‑mediated (systemic sclerosis, RA, SLE, etc.), toxic (drug‑induced), inflammatory (myocarditis), peripartum. Many are potentially reversible if cause is removed.
* **Autoimmune DCM:** Cardiac involvement includes HF/DCM, valve disease, conduction defects, arrhythmias, pericarditis, myocardial fibrosis. Familial clustering of autoimmune diseases may occur. Iatrogenic cardiomyopathy from hydroxychloroquine (restrictive/dilated) and TNF‑α inhibitors (dilated) must be distinguished.

### Systemic Sclerosis (Scleroderma)
* **Prevalence/incidence:** 50‑300 per 10⁶; incidence 2.3‑22.8 per 10⁶/year. Female predominance (3:1 to 14:1).
* **Pathology:** Interstitial fibrosis, microvascular damage, perivascular mononuclear infiltrates. Late: dense fibrosis.
* **Cardiac involvement:** Myocarditis, pericarditis/effusion, conduction disturbances, systolic/diastolic dysfunction, valve disease, ischaemia, pulmonary hypertension. Dilated phenotype in up to 40% of diffuse scleroderma. Myocardial fibrosis is non‑ischaemic (no hemosiderin). CMR and coronary CT aid diagnosis.
* **Treatment:** HF medications; biologic therapies (TNF‑α, IL‑6, B‑cell, CTLA4) may be used; precise diagnosis is critical.

### Rheumatoid Arthritis (RA)
* **Cardiac manifestations:** DCM (accounts for ~20% mortality), pericarditis (up to 50%, but haemodynamic effusion rare), valve nodules/calcification, accelerated atherosclerosis.
* **HF risk:** RA is an independent risk factor for HF (after adjusting for CAD). Diastolic dysfunction is common, driven by cytokines (TNF‑α, IL‑1, IL‑6). CMR shows lower LV volumes rather than increased mass.
* **Iatrogenic damage:** Hydroxychloroquine – myelin figures/curvilinear bodies on biopsy, causing hypertrophic‑restrictive or dilated cardiomyopathy. TNF‑I may worsen HF; guidelines recommend caution (only in compensated HF if no alternatives).
* **Reactive amyloidosis:** AA amyloid in 21‑30% of RA (cardiac in 28%), restrictive phenotype; anti‑TNF may reverse.
* **Accelerated atherosclerosis:** 48% increased CV event risk. Both traditional and disease‑related factors contribute. Methotrexate + TNF‑I control reduces risk.

### Systemic Lupus Erythematosus (SLE)
* **Epidemiology:** Prevalence higher in African Americans, women of childbearing age. Incidence 1‑23 per 100,000/year.
* **Pathogenesis:** Environmental + genetic susceptibility (HLA, NCF2, etc.). Oestrogen, epigenetics (hypomethylation), autoantibodies. Not Mendelian.
* **Myocardial involvement:** DCM is a serious manifestation. Accelerated atherosclerosis not explained by traditional risk factors; antiphospholipid antibodies contribute but only 10% develop thrombotic events. Myocardial fibrosis on CMR (mid‑wall) is common and associated with diastolic dysfunction and poor outcome.
* **Prognosis:** SLE cardiomyopathy prognosis similar to idiopathic DCM. EULAR recommends yearly CV risk assessment.

### Peripartum Cardiomyopathy (PPCM)
* **Definition:** Idiopathic LV systolic dysfunction (EF <45%) in the last month of pregnancy or within 5 months postpartum, excluding other causes. Diagnosis of exclusion.
* **Incidence:** 1:4000 to 1:1000 in Western world; up to 1:300 in Haiti; varies regionally.
* **Risk factors:** Age >30, multiparity, African American race, obesity, pre‑eclampsia, chronic hypertension.
* **Aetiological hypotheses:**
    - Genetic: *TTN* truncating variants found in ~15% of PPCM (similar to DCM), suggesting genetic predisposition.
    - Haemodynamic: exaggerated response to pregnancy changes (unlikely alone).
    - Viral/inflammatory: unconfirmed; myocarditis does not affect outcome.
    - Selenium deficiency: risk factor in Nigeria.
    - Fetal microchimerism: may contribute to autoimmunity.
    - Prolactin: oxidative stress cleaves prolactin to 16‑kDa fragment causing microvascular damage; bromocriptine (D2 agonist) may be therapeutic (under investigation).
    - Prolonged tocolysis: β‑sympathomimetics >4 weeks.
* **Management:** ACEi/ARB and β‑blockers after delivery (Class I); avoid ACEi during pregnancy. Hydralazine, nitrates, β1‑selective blockers, cautious diuretics during pregnancy.
* **Recovery:** LV function recovers in 72% (IPAC study) to ≥50% at 12 months. Baseline LVEF <30% is poor prognostic factor. Bromocriptine plus standard therapy showed high recovery (96%) in German registry, but full recovery (EF >55%) only 47%.

### Alcoholic Heart Disease
* **Definition:** Heavy alcohol (>80 g/day for ≥5 years) causes DCM (alcoholic cardiomyopathy, A‑CMP). Exclude other causes.
* **Prevalence:** Among alcoholics, DCM ~0.43% women, 0.25% men.
* **Mechanisms:** Mitochondrial toxicity, oxidative stress, apoptosis, impaired excitation‑contraction coupling, mitochondrial dysfunction.
* **Prognosis:** Abstinence or reduction to <80 g/day improves survival and LV function. A‑CMP has better prognosis than idiopathic DCM. Atrial fibrillation, QRS >120 ms, no β‑blocker predict poor outcome.

### Cirrhotic Cardiomyopathy
* **Definition:** Chronic cardiac dysfunction in cirrhosis: impaired contractile responsiveness to stress, diastolic dysfunction, electrophysiological abnormalities (QT prolongation, dyssynchrony) in absence of other heart disease.
* **Haemodynamics:** Hyperdynamic circulation (high CO, low SVR). Latent HF unmasked by stress (TIPS, liver transplant).
* **Pathogenesis:** Splanchnic vasodilation → RAAS activation → LV dilation/dysfunction; inflammation (bacterial translocation), cytokines, negative inotropes (NO, CO, cannabinoids).
* **Diagnosis:** Echo (diastolic dysfunction – E/A<1, prolonged deceleration, isovolumic relaxation; systolic dysfunction on stress). CMR and CT may help. Diastolic dysfunction predicts post‑TIPS and post‑transplant mortality.

### Transient and Reversible DCM
* **Tachycardia‑induced:** Persistent tachycardia (>115‑120 bpm) causes biventricular dysfunction; recovery after rate control/ablation within 1‑6 months.
* **PVC‑induced:** Frequent PVCs (>20,000/24h) cause LV dysfunction/dilatation; ablation leads to recovery (47‑100%).
* **Takotsubo (apical ballooning):** Transient mid‑apical hypokinesis with basal hyperkinesis, triggered by emotional/physical stress; older women; mimics ACS. Reversible. Secondary forms have higher event rates.
* **Metabolic cardiomyopathies:**
    - GH/IGF‑1 excess (acromegaly): concentric hypertrophy → systolic dysfunction; control reverses.
    - GH deficiency: reduced mass and function; replacement improves.
    - Thyroid: hyperthyroidism → high‑output HF (tachycardia‑mediated); hypothyroidism → low‑output (bradycardia, impaired relaxation); both reversible with treatment.
    - Uremic: common in CKD; LV hypertrophy, HF; dialysis and transplantation may improve/reverse.

### Cardiovascular Oncotoxicity
* **Overview:** Chemotherapy and radiotherapy can cause myocardium (DCM, myocarditis), pericardium (pericarditis/effusion), vascular (atherosclerosis, thrombosis, hypertension, aortic dissection).
* **Types of myocardial injury:**
    - Type 1 (non‑reversible structural damage) – anthracyclines, high‑dose cyclophosphamide.
    - Type 2 (potentially reversible dysfunction without structural abnormalities) – trastuzumab, sunitinib, lapatinib.
* **Cancer therapy‑related cardiac dysfunction (CTRCD):** Defined as decline in LVEF (≥5% to <55% with symptoms, or ≥10% to <55% without symptoms). Risk: anthracyclines up to 26% in observational studies; trastuzumab cumulative 5‑6% at 3 years.
* **Myocarditis:** Rare (cyclophosphamide, haemorrhagic).
* **Pericardial disease:** Effusion/pericarditis common with many agents.
* **Arrhythmias/QTc:** Many drugs prolong QT; grading by CTCAE. Arrhythmias may be silent.
* **Hypertension:** Common with VEGF inhibitors; ACEi may provide protection.
* **Vascular toxicity:** Ischaemic events, thrombosis, spasm, aortic dissection (reported with sunitinib, gemcitabine, sorafenib, bevacizumab).
* **Clinical relevance:** Patients with genetic DCM may develop cancer; CTRCD can confound diagnosis. Cardiologists must be involved in multidisciplinary care.

### Prognosis
* **Overall improvement:** Over past 3 decades, prognosis has improved due to ACEi, ARB, β‑blockers, aldosterone antagonists, CRT, ICD. Annual major event rates dropped to <2 per 100 patient‑years; 8‑year transplant‑free survival ~87%.
* **Reverse remodelling:** Up to 50% of CRT patients show significant reverse remodelling over 24 months.
* **Arrhythmic risk:** Even super‑responders remain at risk for VT/VF. Myocardial fibrosis on CMR predicts mortality and SCD. Low LVEF has limited sensitivity/specificity.
* **Genetics in risk stratification:** LMNA mutations guide ICD decisions (ESC 2015 guidelines incorporate genetics). Future: cause‑specific risk stratification based on genotype.

### Conclusion
DCM is a heterogeneous end‑phenotype with many genetic and acquired causes. Precise etiological diagnosis is essential for targeted therapy and personalised monitoring. Genetic testing, advanced imaging, and biomarkers are moving DCM from descriptive classification to mechanism‑based management. Separating DCM by cause enables better care and research.
...
## CLINICAL PRESENTATION AND DIAGNOSTIC WORKUP IN INDEX PATIENTS</summary><div class="details-content">

DCM typically manifests with systolic heart failure. The spectrum of symptoms is wide and nonspecific; it includes fatigue, breathlessness, palpitations, and signs of congestion/fluid retention in the presence of structural cardiac abnormalities corresponding to the diagnostic definition. The clinical diagnosis is made in the presence of LV systolic dysfunction (impaired LV ejection fraction measured using two‑dimensional echocardiography) and LV dilatation (as defined by Z‑score > 2 standard deviations) for LV end‑diastolic volumes or diameters (according to nomograms corrected for body surface area, height, and age). Coronary angiography is routinely used to exclude coronary atherosclerosis. Coronary computed tomography (CT) angiography may be considered as an alternative anatomic assessment for the evaluation of obstructive coronary artery disease. The presence of flow‑limiting luminal stenosis in one or more epicardial coronary arteries is considered sufficient to assign the cause of DCM to coronary artery disease. However, coronary and/or systemic atherosclerosis and DCM can exist concurrently and be demonstrated in genetic DCM. Individualized decision making and testing are often necessary to clarify the extent of the contribution made by coronary artery disease in the pathogenesis of DCM. Functional testing, as with myocardial perfusion imaging, may determine presence and/or extent of ischemia and may be useful in this regard.

<details class="med-details"><summary>

#### Advanced Imaging and Phenotyping</summary><div class="details-content">

In the past decade, the clinical use of cardiac magnetic resonance (CMR) has entered routine evaluation, both helping to confirm the diagnosis and adding information on the type and extent of myocardial fibrosis. CMR may further reveal hypertrabeculation or LV noncompaction (LVNC) patterns that can be associated with DCM (see Chap. 60). Three‑dimensional echocardiography may add information on valvular anatomy and remodeling morphology, particularly in patients with limited views on two‑dimensional echocardiography. Contrast echocardiography enhances endocardial border definition, increases accuracy to two‑dimensional and three‑dimensional volume assessment, and highlights trabecular anatomy; it is not needed in routine evaluation but may help in cases of suboptimal image quality. Myocardial deformation imaging techniques and myocardial tagging by CMR are promising contributors to the diagnosis of "early" phenotypes.

</div></details>

<span id="fig-58-1"></span>![](ch10-02_page_1_Figure_2.jpeg)

**FIGURE 58–1.** Phenotypically similar dilated cardiomyopathy (DCM) caused by defects in different genes: precise description by MOGE(S) nosology system. The figure shows three different examples of DCM; although the clinical diagnosis is the same, the diseases are different. In the MOGE(S) notation, **M** describes the morphofunctional phenotype (hypertrophic cardiomyopathy, DCM, restrictive cardiomyopathy, arrhythmogenic right ventricular cardiomyopathy) as defined in current guidelines, eventually adding key markers such as atrioventricular block; **O** describes the organs affected in the given patient (eg, Heart, Skeletal muscle, Auditory, ocular systems); **G** defines whether a cardiomyopathy is genetic or not and includes information on the pattern of inheritance (autosomal dominant, autosomal recessive, X‑linked, matrilineal); **E** is the precision diagnostic descriptor and specifies the cause and, in case of genetic diseases, the disease gene(s) and the mutation(s); and **S** includes New York Heart Association functional class and American Heart Association stage. The practical use is supported by a free app at [http://moges.biomeris.com/moges.html](http://moges.biomeris.com/moges.html) (see Chap. 57).
...
## DIAGNOSIS OF FAMILIAL DILATED CARDIOMYOPATHY: THE ROLE OF FAMILY SCREENING</summary><div class="details-content">

In more than 60% of cases of DCM, the disease is familial, as proven by clinical family screening demonstrating that more than one member is affected or showing traits that predict the development of the disease. The diagnosis of FDCM is formulated when at least two members of the same family are affected. The clinical workup is a three‑step investigation:
...
2. The next step is genetic counseling with pedigree construction and information provided to patients about why family studies are necessary when a genetic disease is suspected. The collection of the clinical history of relatives and tracing of clinical reports of deceased relatives are uniquely useful for correct interpretation of fatal events in families.

3. The third step is family screening, which is independent of genetic testing. Clinical family screening is based on physical examination, electrocardiography (ECG), transthoracic echocardiography, and biochemical testing, followed by regular monitoring of relatives. Once completed, information gleaned from the clinical family screening may modify the original pedigree. Determination of the type of inheritance of the DCM results from integration of pedigree and family data and is essential for guiding and interpreting data generated by genetic testing.

<details class="med-details"><summary>

#### Findings in Relatives and Clinical Implications</summary><div class="details-content">
...
- Demonstrate electrocardiographic abnormalities such as conduction disease, short PR interval/Wolff‑Parkinson‑White pattern, prolonged QT interval, T‑wave abnormalities, early repolarization, or abnormal high or low voltages of the QRS
...
Family screening may by itself offer added value for family health. Monitoring of family members helps generate reliable data on the natural history of the disease. DCM is often characterized by subtle onset and slow progression; it shows a typical age dependency of the phenotype. Overall, clinical family screening is integral and indispensable for the diagnosis of FDCM.
...
- Nuclear envelop genes (*LMNA, EMD, SYNE1, TMPO*) in about 7% to 10% of cases, with *LMNA* mutations accounting for the majority of DCM in this subgroup
- Z‑disc genes (*ACTN2, ANKRD1, BAG3, CRYAB, CSRP3, FHL2, LDB3, MYPN, MURC, NEXN, PGM1, VCL*), all together accounting for less than 10% of DCM
...
- Dystrophin defects in 6% to 7% of DCM in consecutive male series and dystrophin‑associated glycoprotein complex (ie, *SGCA, SGCB, SGCD*) in less than 1% of DCM cases
- Ion channels (*SCN5A*) or genes such as *ABCC9* or *CHRM2*, in less than 1% of cases
...
3. Confirmed by in vivo or in vitro functional and pathologic studies: either endomyocardial biopsy with immunohistochemical study of the protein coded by the mutated gene or in vitro studies on fibroblasts or induced pluripotent stem cell‑derived myocytes obtained from circulating cells or fibroblasts from patients who carry the putative mutation.

4. Integrated into a clinical context, based on segregation studies in families: mutated family members are affected and nonmutated members are not affected. Healthy mutation carriers are usually younger than affected mutated family members.
...
#### TABLE 58-1: Genes Associated With DCM</summary><div class="details-content">

| Nuclear Genes | MIM Gene | Protein | Other Cardiomyopathy | Phenotypes, Diseases, and Traits | Inheritance |
|---------------|----------|---------|----------------------|----------------------------------|-------------|
| ABCC9 | 601439 | ATP-binding cassette, subfamily C, member 9, sulphanylurea receptor2 | | Cantu syndrome, hypertrichosis, familial atrial fibrillation | AD |
...
| ANO5 | 608662 | Anoctamin 5 | | Limb girdle muscular dystrophy, gnathodiaphyseal dysplasia, Miyoshi muscular dystrophy 3; dysphagia | AR |
| ANKRD1 | 609599 | Ankyrin repeat domain-containing protein 1 | H | | AD |
| BAG3 | 603883 | BCL2-associated athanogene | H | BAG3-related myofibrillar myopathy, CRYAB-related myofibrillar myopathy, fatal infantile hypertrophy | AD |
| CALR3 | 611414 | Calreticulin 3 | H | | AD |
| CASQ2 | 114251 | Calsequestrin 2 | NC | | AD |
| CAV3 | 601253 | Caveolin 3 | H | sCPK elevated; long QT syndrome-9; muscular dystrophy, Limb-Girdle myopathy, distal, Tateyama type; Rippling muscle disease | AD |
...
| DES | 125660 | Desmin | H/R/A | DES-related myofibrillar myopathy, neurogenic scapuloperoneal syndrome, Kaeser type; AVB, sCPK | AD |
...
| DOLK | 610746 | Dolichol kinase | | Congenital disorder of glycosylation, type Im; myopathy, possible ichthyosiform dermatitis | AR |
...
| DSP | 125647 | Desmoplakin | A | Lethal acantholytic epidermolysis bullosa, keratosis palmoplantaris striata II, skin fragility-woolly hair syndrome | AD |
...
| FHL1 | 300163 | Four and a half LIM domains 1 | H | EMDM6, X-linked myopathy, reducing body, childhood-onset, and severe early-onset myopathy with postural muscle atrophy, scapuloperoneal myopathy, XLD | XLR, XLD |
| FHL2 | 602633 | Four and a half LIM domains 2 | | | AD |
| FKTN | 607440 | Fukutin | | Muscular dystrophy-dystroglycanopathy (with brain and eye anomalies), type A,4; (without mental retardation), type B,4; (Limb-Girdle), type C,4 | AR |
...
| LMNA | 150330 | Lamin AC | A/NC | DCM with conduction disease plus 11 additional phenotypes; AVB; possible sCPK | AD |
| LAMA2 | 156225 | Laminin alpha, 2 | | Congenital merosin-deficient muscular dystrophy type 1A | AR |
| LAMA4 | 600133 | Laminin alpha, 4 | | | AD |
| LDB3 | 605906 | LIM domain-binding 3 | H/NC | ZASP-related myofibrillar myopathy; LVNC, possible > sCPK; Hypertrabeculation | AD |
...
| MYH7 | 160760 | Beta-myosin heavy chain 7 | H/R/NC | Laing distal myopathy; myosin storage myopathy; scapuloperoneal syndrome, myopathic type; possible sCPK | AD |
...
| NKX2-5 | 600584 | NK2 homeobox 5; cardiac specific homeobox 1 | | Possible conduction system disease; congenital heart diseases; hypothyroidism; congenital nongoitrous | AD |
| OBSCN | 608616 | Obscurin | NC | | AD, AR |
| PDLIM3 | 605889 | PDZ and LIM domain protein 3 | | | AD |
| PLN | 172405 | Phospholamban | A | | AR |
| PLEKHM2 | 609613 | Pleckstrin homology domain containing protein, family M, member | NC | | AR |
| PKP2 | 602861 | Plakophilin 2 | A | | AD |
| PRDM16 | 605557 | PR domain containing 16 | NC | LVNC | AD |
| PSEN1 | 104311 | Presenilin 1 | | Familial acne inversa, 3; Alzheimer disease, 3; frontotemporal dementia; Pick disease | AD |
...
| SCN5A | 600163 | Sodium channel, voltage gated, type V, alpha subunit | | LQT3, Brugada, atrial fibrillation, sick sinus syndrome, familial VF | AD |
...
| TPM1 | 191010 | Tropomyosin 1 | H/R/NC | Limb-girdle muscular dystrophy, early-onset myopathy with fatal CMP, proximal myopathy with early respiratory muscle involvement, tardive tibial muscular dystrophy | AD |
| TTN | 188840 | Titin | H/A | | AD |
| VCL | 193065 | Vinculin | H | | AD |
| AGK | 610345 | Acylglycerol kinase | H/NC | Cataract, myopathy, Senger syndrome | AR |
| ANT1 (PEOA2) | 103220 | Adenin nucleotide translocator 1 | H | Mitochondrial DNA depletion syndrome 12 (cardiomyopathic type), AD-PEO with multiple mtDNA deletions | AD, AR |
...
| POLG (PEOA1) | 174763 | DNA polymerase | H | Alpers-type syndrome, MNGIE type, AD-PEO and AR-PEO, SANDO syndrome, SCAE | AD, AR |
...
| SDHA | 600857 | Succinate dehydrogenase complex subunit A | H | Leigh syndrome, mitochondrial respiratory chain complex II deficiency, paragangliomas | AR |
| TMEM70 | 612418 | Mitochondrial complex V (ATP synthase) deficiency, nuclear type 2 | | Neonatal mitochondrial encephalocardiomyopathy with ATP synthase deficiency | AR |
| PTPN11 | 176876 | Protein tyrosin phosphatase, nonreceptor type 11 | H | Noonan syndrome type 1; LEOPARD type 1 | AD |
| KRAS | 190070 | V-KI-RAS2 Kirsten Rat sarcoma viral oncogene homolog | H | Noonan syndrome type 3; cardiofaciocutaneous syndrome type 2 | AD |
| RAF1 | 164760 | V-RAF-1 murine leukemia viral oncogene homolog 1 | H | Noonan syndrome type 5, LEOPARD syndrome type 2 | AD |
...
#### TABLE 58-2: Clinical and Instrumental Markers to Be Annotated and Potentially Useful for Formulating Pretest Clinical Hypotheses of Specific Genetic DCMs or Syndromes</summary><div class="details-content">
...
| M or F | Low QRS voltage | PLN* | AR |
| M or F | High QRS voltage | Sarcomere genes | AD |
...
| M or F | Left ventricular hypertrabeculation | LDB3 | AD |
| M or F | | MIB1 | AD |
| M or F | | DTNA | AD |
...
| M | > sCPK | Muscle dystrophies/myopathies | XLR |
| M | > Lactacidemia | Mitochondrial diseases | AD, AR, matrilineal |
...
| M or F | Palpebral ptosis | POLG1 and other nuclear genes coding mitochondrial proteins | AD |
| M or F | | ANT1 | AD |
| M or F | | MtDNA genes | Matrilineal |
| M; M or F | Myopathy/dystrophy | Multiple genes | AD, AR, XLR |
| M or F | Cataract | CRYAB | AD |
| M or F | | AGK | AR |
| M or F | Palpebral ptosis | POLG | AD |
| M or F | Diabetes | MtDNA | Matrilineal |
...
| M or F | Learning disability | MtDNA | Matrilineal |
| M | | LAMP2 | XLR |
...
| F | | NDUFB11 | XLD |
| M or F | | AARS2 | AR |
| M or F | Loss of endothelial cell loss | LAMA4 | AD |
| M or F | Loss/irregular expression of nuclear Lamina | LMNA | AD |
| M | Loss of expression of dystrophin, sarcolemma | DMD | XLR |
| M | Loss of expression of emerin, nuclear membrane | EMD | XLR |
| M or F | Severely reduced activity of complex II | SDHA | AR |
| M or F | Decreased desmosomes, intercalate disc "paleness" | DSG2 | AD |
| M or F | Desmin positive granulophilamentous material | DES | AD, AR |
...
<span id="fig-58-4"></span>![](ch10-02_page_10_Figure_2.jpeg)
...
#### Dilated Cardiotitinopathies</summary><div class="details-content">

The titin (*TTN*) gene encodes the largest human protein and the third most abundant striated muscle protein. Of the different titin isoforms, the N2B and N2BA isoforms are predominantly expressed at the cardiac level; the cardiac isoform Novex-3 titin (5600 amino acids) is less represented in cardiac tissue than full-length titin. Truncation-predicting mutations have been identified in 25% of FDCMs and in 18% of sporadic DCMs. The penetrance of *TTN* truncating mutations was more than 95% for patients who were older than 40 years of age. Clinical manifestations, morbidity, and mortality were similar to those observed in DCM patients who were noncarriers of *TTN* mutations. DCM was not accompanied by conduction system or skeletal muscle disease. A further study in women with peripartum cardiomyopathy showed a distribution of truncating variants remarkably similar to that found in patients with DCM. Missense variants have been further investigated in DCM distinguishing "bioinformatically severe" *TTN* versus nonsevere variants; carriers of "severe *TTN* variants" showed a clinical course similar to that of noncarriers. *TTN* mutations have been involved in HCM (MIM#613765); muscular dystrophy of the Limb-Girdle, type 2J (MIM#608807); autosomal recessive early-onset myopathy with fatal cardiomyopathy (MIM#611705); tardive tibial muscular dystrophy (MIM#600334); and proximal myopathy, with early respiratory muscle involvement (MIM#603689). Because 1 in 500 individuals in the general population carries a truncation variant in the *TTN* A-band, the interpretation of such mutations in DCM should be cautious. The relevance of defining the precise role of *TTN* in DCM is now supported by the possibility that antisense-mediated exon skipping can be explored as a therapeutic strategy.

</div></details>

<details class="med-details"><summary>

#### Dilated Phospholambanopathies</summary><div class="details-content">

Dilated phospholambanopathies are a distinct group of DCM caused by mutations in the *Phospholamban* (*PLN*) gene that encodes a protein expressed in the sarcoplasmic reticulum membrane. Phospholamban inhibits cardiac muscle sarcoplasmic reticulum Ca<sup>2+</sup>-ATPase (SERCA2a) in the unphosphorylated state. Mutations in *PLN* impair sarcoplasmic reticulum calcium homeostasis and cause DCM. Less commonly, mutations in *PLN* cause HCM. p.(Arg14del) is the most frequently identified mutation in Dutch cardiomyopathy patients (10%-15%), both DCM and arrhythmogenic phenotypes. Patients with p.(Arg14del) diagnosed with DCM demonstrate high arrhythmogenic risk and SCD as first disease presentation. A common ECG pattern in *PLN* mutation carriers is a low-voltage QRS complex and inverted T waves in leads V<sub>4</sub> to V<sub>6</sub>. In non-Dutch patients, *PLN* mutations are less common but equally malignant. Therefore, although rare, *PLN* mutations can be clinically suspected in patients with DCM, high arrhythmogenic risk, and low voltage on ECG.

</div></details>

<details class="med-details"><summary>

#### Future Developments in Genetic Dilated Cardiomyopathy</summary><div class="details-content">
...
## NONGENETIC DILATED CARDIOMYOPATHY</summary><div class="details-content">
...
## AUTOIMMUNE/IMMUNE-MEDIATED DILATED CARDIOMYOPATHY (SEE ALSO CHAP. 100)</summary><div class="details-content">
...
#### TABLE 58-3: The Spectrum of Cardiac Phenotypes in Autoimmune Diseases</summary><div class="details-content">

| Disease | Heart Involvement May Include |
|---------|-------------------------------|
| Systemic sclerosis* | HF/DCM, MVR, CD, pericarditis |
| Rheumatoid arthritis (RA)* | HF/DCM, MVR, CD, pericarditis |
| Systemic lupus erythematosus (SLE)* | Accelerated atherosclerosis, DCM/myocardial fibrosis/HF |
| Rhupus: overlapping features of both SLE and RA | HF and pericarditis |
| Mixed connective tissue disease | Pericarditis, MVR, CD, accelerated atherosclerosis |
...
| Behçet syndrome | Pericarditis, endocarditis, intracardiac thrombosis, MI, endomyocardial fibrosis |
| Dermatomyositis and polymyositis | Subclinical cardiac involvement; CAD |
| Adult Still disease | Rare myocarditis |
| Fibromyalgia† | Heart rate variability |
...
### SYSTEMIC SCLEROSIS (SCLERODERMA)</summary><div class="details-content">
...
#### Causes and Major Pathology Features</summary><div class="details-content">

SS is a sporadic multifactorial disease in the majority of cases. Environmental factors and occupational risk factors have been reported in patients with scleroderma-like phenotypes. Less commonly, SS clusters in families where members may show different autoimmune diseases. These data suggest the contribution of genetic factors that could contribute with a small dose effect of multiple genes whose products are involved in innate and adaptive immunity, autoinflammation, cell signaling, extracellular matrix architecture, DNA or RNA degradation, and apoptosis or autophagy diseases. Replication of genome-wide association studies independently confirmed the candidacy of many susceptibility genetic variants, including selected human leukocyte antigen (HLA) class II molecules. The maternal-fetal microchimerism hypothesis may help explain the higher prevalence of SS in females: according to this hypothesis, fetal and maternal lymphocytes can cross the placenta during pregnancy and trigger a graft-versus-host-like microreaction that may culminate in scleroderma. This hypothesis is further supported by the presence of allogeneic cells in peripheral blood and in skin biopsy samples obtained from patients with scleroderma and by the short interval between pregnancy and onset of the disease, in particular in the first year after delivery.

Interstitial fibrosis is the main pathologic feature observed in hearts affected by scleroderma. Early features are microvascular damage and mononuclear cell infiltrates. In later stages, the main pathology features are dense fibrosis of the dermis, loss of interstitial cells and vasculature, and tissue atrophy. Table 58–4 summarizes pathologic tissue and cellular changes as well as the expression of possible markers in affected tissue and autoantibodies.

<details class="med-details"><summary>

#### TABLE 58-4: Pathologic Features of Systemic Sclerosis</summary><div class="details-content">

| Phase | Vascular Changes: Small Arteriolar Vessels | Fibrosis: Dermal and Interstitial Spaces | Cells Showing Abnormalities | Immunohistochemistry | Autoantibodies Against: |
|-------|--------------------------------------------|------------------------------------------|-----------------------------|----------------------|-------------------------|
| Early phase | • Loss of continuity of the endothelial layer with gaps between endothelial cells, cytoplasmic vacuolization of endothelial cells<br>• Replication of basement lamina<br>• Perivascular mononuclear infiltrates with rare lymphocytes<br>• Hyperplastic small vessel disease | • Early fibrosis of the lower dermis and upper subcutaneous layer in parallel with progressive loss of small vessels<br>• Different collagen types, proteoglycans, and elastic fibers including fibrillins | • ET cells<br>• Pericytes<br>• SMC<br>• Fibroblasts | • Overexpression TGF‑β<br>• PDGF, which is linked to wound healing and fibrosis<br>• Endothelin‑1 | • Topoisomerase I (Scl‑70)<br>• Centromere‑associated proteins<br>• Nucleolar antigens<br>• Cell‑surface antigens |
| Late phase | • Rarefaction of capillaries<br>• Paucity of small blood vessels | Dense fibrosis with prevalence of type I collagen | Cell density decreases | | |
...
### RHEUMATOID ARTHRITIS</summary><div class="details-content">
...
#### Dilated Cardiomyopathy and Heart Failure</summary><div class="details-content">

Congestive HF is a major cause of morbidity and mortality in RA patients. The risk of HF remains high after adjustment for underlying coronary artery disease; in long-term follow-up studies, the burden of HF was significantly higher in RA patients than in a control population. Markers such as rheumatoid factor positivity and erythrocyte sedimentation rate, clinical traits such as extra-articular involvement, and treatments such as steroids are associated with risk of congestive HF after adjusting for coronary artery disease and risk factors, suggesting that RA is an independent risk factor for HF. Diastolic dysfunction adds to systolic dysfunction in RA hearts. The modification of cardiac mass in RA hearts is debated, with transthoracic echocardiography supporting this hypothesis versus CMR studies that did not confirm an increase in cardiac mass but rather showed lower LV volumes compared with age-matched controls. The cause of diastolic dysfunction may be ascribed to the effects of inflammatory cytokines such as TNF-α, IL-1, and IL-6, all of which mediate inflammation and fibrosis; cytokine profiles seem to distinguish patients with moderate to severe diastolic dysfunction from those with normal heart function; higher myocardial levels of citrullinated proteins compared with controls may partly account for myocardial involvement in RA.

</div></details>

<details class="med-details"><summary>

#### Iatrogenic Myocardial Damage Caused by Rheumatoid Arthritis Treatment</summary><div class="details-content">

Disease-modifying drugs used to treat RA (and other connective tissue diseases) may lead to iatrogenic myocardial damage. Toxicity may result from long-term use of TNF inhibitors (TNF-I) and antimalarial agents such as hydroxychloroquine. Hydroxychloroquine toxicity manifests with either hypertrophic-restrictive cardiomyopathy or DCM and is diagnosed with endomyocardial biopsy demonstrating myelin figures and curvilinear bodies (Fig. 58–8) (see Chaps. 61 and 100). The role of TNF-I in causing HF is debated. Etanercept and infliximab trials concordantly showed unfavorable outcomes. However, other studies/registries reported that the prevalence of congestive HF is lower or comparable in treated patients versus nontreated patients; a meta-analysis of data from these registries concluded that the incidence of congestive HF is lower in treated than in nontreated patients. In the last guidelines (2015) for treatment of RA, the Voting Panel of the American College of Rheumatology reported that recommendations are conditional because the evidence is of very low quality and noted that "there are no reports of exacerbation of HF using non-TNF biologics and the US Food and Drug Administration (FDA) warns against using TNF-I in this population based on worsening of congestive HF with TNF-I in the Adverse Event Reporting System database. A TNF-inhibitors should only be used if there are no other reasonable options, and then, perhaps, only in compensated heart failure" (see Chap. 100).
...
#### Reactive Amyloidosis</summary><div class="details-content">
...
### SYSTEMIC LUPUS ERYTHEMATOSUS</summary><div class="details-content">

<details class="med-details"><summary>

#### Dilated Cardiomyopathy in Systemic Lupus Erythematosus</summary><div class="details-content">

SLE is a multiorgan autoimmune disease demonstrating higher prevalence in African Americans than in whites and typically affects women of childbearing age. The clinical course is characterized by cyclic evolution, with periods of quiescence alternating with periods of disease activity. The heart is commonly involved: DCM is one of the most serious forms of organ involvement in SLE, and LV systolic dysfunction is associated with poor outcome. In 2012, a consensus group of experts on SLE (the Systemic Lupus International Collaborating Clinics) revised the prior American College of Rheumatology criteria for SLE and established the diagnostic criteria (Table 58–5). Myocardial involvement is not included in diagnostic criteria; pericarditis is listed in the context of serositis and occurs in 10% to 30% of patients. Although myocardial involvement does not provide a diagnostic contribution, it is common in early and late phases of the disease; diastolic dysfunction is detected in 45% of patients without evidence of cardiac disease; it also accounts for the majority of deaths.

<details class="med-details"><summary>

#### TABLE 58-5: Clinical and Immunologic Criteria Used in the SLICC Classification Criteria</summary><div class="details-content">

| CLINICAL CRITERIA | IMMUNOLOGIC CRITERIA |
|-------------------|----------------------|
| 1. Acute cutaneous lupus | 1. ANA above laboratory reference range |
| 2. Chronic cutaneous lupus | 2. Anti-dsDNA above laboratory reference range, except ELISA: twice above laboratory reference range |
| 3. Oral ulcers | 3. Anti-Sm |
| 4. Nonscarring alopecia (diffuse thinning or hair fragility with visible broken hairs) | 4. Antiphospholipid antibodies: lupus coagulant; false-positive RPR; medium or high titer anticardiolipin (IgA, IgG, IgM); anti-β2 glycoprotein I (IgA, IgG, IgM) |
| 5. Synovitis involving 2 or more joints, characterized by swelling or effusion OR tenderness in 2 or more joints and 30 minutes or more of morning stiffness | 5. Low complement: • Low C3 • C4 • CH50 |
| 6. Renal | 6. Direct Coombs test in the *absence of hemolytic anemia* |
| 7. Neurologic | |
| 8. Serositis | |
| 9. Hemolytic anemia | |
...
###### → Serositis includes typical pericardial pain (pain with recumbency improved by sitting forward) for more than 1 day, or pericardial effusion, or pericardial rub, or pericarditis by ECG, *in the absence of other causes, such as infection, uremia, and Dressler pericarditis*.
...
Myocardial fibrosis represents a significant independent predictor of adverse cardiac outcomes in both ischemic and nonischemic cardiomyopathies. Recent CMR studies confirmed that mid-wall myocardial fibrosis is frequent in SLE and is associated with age but not with disease duration or severity; in addition, late gadolinium enhancement comprising > 15% of LV mass may be associated with diastolic dysfunction and impaired exercise capacity.
...
## PERIPARTUM CARDIOMYOPATHY (SEE ALSO CHAP. 103)</summary><div class="details-content">
...
PPCM is estimated to occur in 0.1% of all pregnancies. The prevalence of PPCM ranges between 1:4000 and 1:1000 live births in the Western world. Approximately 75% of cases are diagnosed within the first month after delivery, and 45% occur in the first week. Regional variation is wide: 1 case per 20,000 live births in Japan; 1 case per 1000 live births in South Africa; 1 case per 40,322 in China; and 1 case per 300 live births in Haiti. A high prevalence in Nigeria is likely caused by the tradition of ingesting kunun kanwa (dried lake salt) while lying on heated mud beds twice a day for 40 days postpartum to stimulate breast milk production. This variable prevalence suggests that regional and cultural factors influence the risk of PPCM.

</div></details>

<details class="med-details"><summary>

### Risk Factors</summary><div class="details-content">

Risk factors for PPCM include age (> 30 years), multiparity, African American race, obesity, substance use, pre‑eclampsia, and chronic hypertension. It is unclear whether race is an independent risk factor or whether the increased risk of PPCM results from the interaction of race with hypertension. Factors such as poor nutrition and lack of prenatal care are included in the list of risk factors but are unconfirmed. Climate may also contribute: PPCM seems to be more common in tropical regions with increased heat and humidity.

</div></details>

<details class="med-details"><summary>

### Etiologic Hypotheses</summary><div class="details-content">

Etiologic hypotheses include familial/genetic predisposition, maladaptive response to hemodynamic stresses of pregnancy, viral myocarditis, stress‑activated cytokines, malnutrition and selenium deficiency, fetal micro‑chimerism, prolactin, and prolonged tocolysis.
...
#### Genetic Hypothesis</summary><div class="details-content">
...
#### Abnormal Hemodynamic Response</summary><div class="details-content">
...
#### Viral Myocarditis and Systemic Inflammation</summary><div class="details-content">
...
#### Malnutrition and Selenium Deficiency</summary><div class="details-content">
...
#### Fetal Micro‑Chimerism</summary><div class="details-content">
...
#### Prolactin</summary><div class="details-content">

Prolactin is one of the key candidates in the pathophysiology of PPCM. Increased levels of prolactin in pregnancy are associated with increased blood volume and levels of circulating erythropoietin and hematocrit and decreased blood pressure, angiotensin responsiveness, and levels of water, sodium, and potassium. In the last trimester of pregnancy, oxidative stress is enhanced; under defective antioxidative mechanisms, prolactin is increasingly cleaved into a 16‑kDa fragment (16‑kDa prolactin). This fragment may induce microvascular damage, leading to cardiac injury and dysfunction. The dopamine D<sub>2</sub> receptor agonist bromocriptine inhibits prolactin release and may represent a therapeutic option. This hypothesis was tested in a murine model that develops a PPCM‑like phenotype; in this mouse model, the administration of bromocriptine prevented the development of the phenotype. After successful testing in pilot series and single cases, a large clinical trial was planned and is ongoing, aimed at investigating the safety of the dopamine D<sub>2</sub> receptor agonist bromocriptine and its effects on LV function in women with PPCM.

</div></details>

<details class="med-details"><summary>

#### Prolonged Tocolysis</summary><div class="details-content">
...
### Diagnostic Workup and Management</summary><div class="details-content">
...
### Diagnosis and Imaging</summary><div class="details-content">
...
#### TABLE 58-7: Morphofunctional Imaging‑Based, Electrophysiologic, Electromechanical, and Biochemical Criteria for Cirrhotic Cardiomyopathy</summary><div class="details-content">

| Imaging | Cardiac Morphofunctional Criteria | Other Criteria |
|---------|-----------------------------------|----------------|
| | Echocardiographic criteria | Electrophysiologic criteria |
| Systolic | Systolic dysfunction unmasked during pharmacologic or physiologic stress | QT interval prolongation |
| | Rest EF < 55% | Abnormal chronotropic response |
| Diastolic | E/A ratio < 1.0 (corrected by age) | Electromechanical criteria |
| | Prolonged deceleration time (> 200 ms) | Ventricular dyssynchrony |
| | Prolonged isovolumetric relaxation time (> 80 ms) | Biomarkers |
| | Tricuspid valve regurgitation | Increased natriuretic peptides (pro‑BNP, pro‑ANP) |
| Others | LA dilation | Increased high‑sensitivity troponin T |
| | Increased cardiac mass | Soluble urokinase‑type plasminogen activator receptor |
...
## TRANSIENT AND REVERSIBLE DILATED CARDIOMYOPATHY</summary><div class="details-content">
...
## CARDIOVASCULAR ONCOTOXICITY (ALSO SEE CHAP. 101)</summary><div class="details-content">

<details class="med-details"><summary>

### Introduction</summary><div class="details-content">

Cardiovascular toxicity during and after chemotherapy and radiotherapy for cancer has been and remains a potential limitation to leveraging the full benefits of most advanced treatments of malignancies in childhood and adulthood. Progression in cancer treatments has significantly increased the number of long‑term survivors but has also increased the possibility of toxicity manifesting to the cardiovascular system over time. Cardiovascular toxicity includes a range of complications, including involvement of the myocardium (eg, DCM, myocarditis), pericardium (eg, pericarditis, pericardial effusion), and vascular system (eg, coronary atherosclerosis, peripheral arterial disease, acute aortic syndromes, coagulopathy, hypertension, and hypotension) (Table 58–8). Although these possible complications are known, the individual risk of occurrence remains largely unpredictable. Whereas greater risk would be expected in older patients and those with a preponderance of traditional risk factors, clinical evidence across a range of ages indicates that underlying risk does not necessarily correlate with expression of phenotype. Pretreatment risk stratification requires meticulous consideration to prevent or limit the effects of potentially harmful treatments in patients at high risk while not excluding patients from receiving effective treatments. New cardiovascular imaging tools (ie, strain imaging) and biomarkers (eg, troponin, B‑type natriuretic peptide) are now contributing to early detection, better risk stratification, and monitoring of the cardiovascular toxic effects of chemotherapy. None of these markers has been specifically generated for detection or monitoring of cardiovascular toxicity per se; rather, their use represents the extension of standards in cardiovascular diagnosis generally to chemotherapy‑induced cardiovascular abnormalities specifically.
...
#### TABLE 58-8: Examples of Patients Diagnosed With Genetically Proven DCM Who Developed Cancer Before or After the Diagnosis of Cardiomyopathy</summary><div class="details-content">

| Sex | DCM Age | Cancer Age | MOGE(S) Baseline | MOGE(S) Last | Event/Age (years) |
|-----|---------|------------|------------------|--------------|-------------------|
| M | 53 | 71 | MD(AVB) OH GAD EG‑LMNA[p. Glu317Lys] SC‑II | MD(AVB) OH GAD EG‑LMNA[p. Glu317Lys] + Lung Cancer + RX therapy SC‑IV | Death HF 76 |
| F | 40 | 51 | MD(AVB) OH GAD EG‑DMPK[E2,500‑1000 CTG] SC‑II | MD(AVB) OH GAD EG‑DMPK[E2,500‑1000 CTG] + T Doxo in Breast Ca SC‑IIb | Alive 56 |
| M | 50 | 55 | MD(E) OH GAD EG‑MYBPC3[p.Q969X] SB‑I | MD(E) OH GAD EG‑MYBPC3[p.Q969X] + T Doxo in Colon Ca SC‑IV | Death HF 58 |
| F | 66 | 49 | MD(AVB) OH GAD EG‑LMNA[p. Arg335Gln] SC‑IIb | MD(AVB) OH GAD EG‑LMNA[p. Arg335Gln] + T Doxo in Breast Ca SC‑III | Alive 69 |
...
Myocarditis is a rare complication described in patients treated for cancer (ie, cyclophosphamide and hemorrhagic myocarditis). It may present as fulminant myocarditis.

</div></details>

<details class="med-details"><summary>

#### Pericardial Involvement</summary><div class="details-content">
...
#### TABLE 58-9: Major Cardiovascular Toxicity Effects and Phenotypes in Cancer Patients Treated With Different Chemotherapeutic Agents</summary><div class="details-content">

| Class | Drugs and Dose‑Dependent Effects | Cardiovascular toxicity (ranges, %) | LV Dysfunction‑DCM | (Endo)myocardial Fibrosis | Myocarditis | Pericarditis/Pericardial Effusion | Arrhythmias | Conduction Defects (not‑otherwise described) | QT Interval Prolongation | Bradycardia and AV Block | Sudden Death/cardiac arrest | Ventricular Tachycardia/Fibrillation | Vasospasm/Arterial Constriction | Acute Coronary Syndromes | Arterial Thrombosis | Venous Thromboembolism | Aortic Dissection | Blood Pressure |
|-------|----------------------------------|-------------------------------------|--------------------|---------------------------|-------------|-----------------------------------|-------------|----------------------------------------------|--------------------------|--------------------------|-----------------------------|--------------------------------------|---------------------------------|--------------------------|---------------------|------------------------|-------------------|----------------|
...
| | Capecitabine | | | | | | • | | • | • | • | | • | • | • | • | | |
| | Cytarabine | | | | | • | | | | | | | | • | | | | |
| Tyrosine Kinase I Mab‑Based | Bevacizumab | | • | | | | | | • | | | | | • | • | • | • | ↑↑ |
| | Trastuzumab | | • | | | | | | | | | | | | • | | | ↑ or ↓ |
| | Pertuzumab | | | | | | | | | | | | | | | | | |
| | Alemtuzumab | | • | | | | • | | | | | | | | | | | ↑ or ↓ |
| | Rituximab† | | | | | | • | | | | | | | | | | | ↓ |
| Small molecule tyrosine Kinase I | Dasatinib | | • | | | • | • | | • | | | • | | | | | | ↑ |
| | Imatinib mesylate | 0.5‑2 | • | | | • | • | | | | | | • | | | | | ↑ |
| | Lapatinib | 1.5‑16 | • | | | | • | | • | | | • | • | • | | | | ↑ |
| | Sunitinib | 2.7‑11 | • | | | | • | | • | | | | | • | • | • | • | ↓ |
| | Sorafenib | | | | | | | | • | | | | | • | • | | • | ↑ |
| | Pazopanib | | | | | | | | • | | | | | • | • | | | ↑ |
...
| | Carfilzomib | | • | | | | | | | | | | | | | | | |
| Antimicrotubule | Paclitaxel | < 1‑31 | • | | | | • | | • | • | | | | • | | | | |
| | Docetaxel | < 2‑8 | • | | | | • | | • | • | | | | • | | | | |
| Angiogenesis Inhibitors | Lenalidomide | 3‑75 | | | | | • | | | • | | | | | | • | | ↑ |
| | Thalidomide | 1‑58 | | | | | • | | | • | | | | | | • | | ↑ |
| Platinum Agents | Cisplatin | 8.5 | | | | | • | | | • | | • | • | • | | • | • | ↑ or ↓ |
| Antimicrotubule Agents | Vincristine | 25 | | | | | • | | | | | | | • | | | | ↑ or ↓ |
| Miscellaneous | Interferon‑α2b | 25 | • | | | | • | | | • | • | | | • | • | | | ↓ |
| | Aflibercept | 1‑7 | | | | | | | | | | | | • | • | | | ↓ |
| | Pentostatin | 3‑10 | • | | | | • | | | • | • | | | • | • | | | ↓ |
...
## PROGNOSIS IN DILATED CARDIOMYOPATHY</summary><div class="details-content">
...
In the overall population of DCM patients, the prognosis has progressively and significantly improved over the past three decades. The optimized use of ACE inhibitors, angiotensin receptor blockers, β‑blockers, antialdosterone therapy, and resynchronization therapy has substantially modified the natural history of DCM (see Chaps. 68 and 70). Annual incidence of major cardiac events (death and cardiac transplantation) declined, and transplant‑free survival improved. HF‑related deaths have decreased by 40% in the past 20 years. Reasons for better survival and low event rate include early diagnosis, earlier medical treatment, resynchronization therapy, and primary prevention of sudden death with ICD implantation (see Chaps. 72 and 73).
