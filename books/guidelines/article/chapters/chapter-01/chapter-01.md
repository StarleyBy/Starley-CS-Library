...
### Principles of Mechanical Circulatory Support in Cardiogenic Shock
* **Refractory cardiogenic shock:** Defined as cardiac and circulatory failure resulting in organ hypoperfusion, carries unacceptably high mortality despite maximal medical therapy. Primary cardiac pathology is the leading cause, though acute cardiomyopathies secondary to sepsis and toxic ingestion are also common.
* **MCS as a bridge strategy:** Temporary MCS can serve as bridge to decision, to recovery, to long-term support devices (VADs or total artificial hearts), or to heart transplantation. The choice of initial rescue strategy significantly impacts both acute iatrogenic harm and long-term planning.
* **Institutional pathways:** Developing predetermined institutional pathways is critical to success. MCS programs require steep learning curves, careful planning of perfusion strategies, and multidisciplinary coordination.
* **Resource considerations:** These therapies are resource-intensive but risk/benefit profiles and costs are becoming more favorable with technological advancements, appropriate patient selection, and better clinical use.

### Case Vignette: A 28-Year-Old with Fulminant Myocarditis
* **Clinical presentation:** Previously fit male with cardiogenic shock of uncertain origin, elevated troponin I (21 ng/mL), ventricular arrhythmias requiring CPR and cardioversion, LVEF of 5% with akinetic ventricular wall on echocardiography.
* **Escalation pathway:** Initial support with IABP and inotropes failed; patient developed worsening arrhythmias, hepatic and renal dysfunction. Peripheral VA-ECMO was instituted with IABP left in situ.
* **Complication on VA-ECMO:** Loss of aortic valve opening with LV distension, early thrombus in LV and aortic root identified. Less invasive options (atrial septostomy) considered but excluded; percutaneous VADs (Impella, TandemHeart) unavailable.
* **Conversion to BiVAD:** Configuration changed to temporary biventricular assist device using two ECMO circuits with centrifugal pumps (CentriMag). Transfemoral RA drainage to PA return; LV apex drainage to aorta return. This allowed awakening, mobilization, and exercise in bed.
* **Diagnosis and transplant pathway:** Tissue biopsy demonstrated fulminant giant cell myocarditis — recovery unlikely. Patient listed urgently for transplant. After 2 weeks without organ availability, temporary LVAD converted to long-term implantable HVAD with continued temporary RVAD support.
* **Outcome:** After RVAD removal, discharge from ICU on LVAD support, relisted for transplant, received heart transplant 3 months later, discharged home after rehabilitation.

### Intra-Aortic Balloon Pump
* **Role in MCS bridge:** IABP remains a useful first-line MCS option bridging conventional medical therapy to advanced MCS. More widely available, lower risk, less invasive, and easier to institute than other systems.
* **Hemodynamic effects:** Improves native cardiac performance by reducing afterload and myocardial oxygen demand. However, cannot partially or completely replace cardiopulmonary function.
* **Evidence limitations:** Efficacy in cardiogenic shock remains controversial. Current data suggest IABP may assist aortic valve opening in patients requiring peripheral VA-ECMO.
* **Referral trigger:** Early referral to MCS center should be considered in young patients with presumed reversible acute cardiomyopathy or those without contraindications for heart transplantation.

### Venoarterial ECMO
* **Uptake since 2009 H1N1:** Pandemic significantly increased ECMO centers and awareness. Success with VV-ECMO encouraged application to cardiorespiratory support in various clinical settings.
* **ELSO indications for cardiac failure:** Include cardiac arrest, cardiogenic shock, failure to wean from CPB, and severe cardiac allograft dysfunction. Use in CPR (ECPR) expanding with favorable outcomes in experienced centers.
* **Contraindications:** SOFA score >15 considered contraindication to VV-ECMO; similar criteria may apply for VA-ECMO or temporary VAD.
* **Central vs. peripheral VA-ECMO:** Central VA-ECMO traditionally used for failure to wean from CPB after cardiac surgery. Femoral VA-ECMO is more common for urgent support as it can be initiated rapidly without sternotomy.
* **Major limitation of peripheral VA-ECMO:** LV afterload mismatch and inadequate LV decompression. Patients with very low native cardiac output and severe mitral regurgitation are at greater risk for hydrostatic pulmonary edema and reduced myocardial oxygenation from LV distension compressing coronary circulation.
* **Management strategies:** Use of IABP to reduce LV afterload and pulmonary congestion (no definitive data). Smaller arterial return cannulae minimize need for backflow cannula; early insertion of distal limb perfusion cannulae should be considered.
* **Thrombotic complications:** LV and aortic root stasis from lack of cardiac ejection may result in catastrophic intracardiac and aortic root thrombosis. Increased anticoagulation may precipitate bleeding.
* **LV decompression options:** Percutaneous trans-septal left atrial decompression, subxiphoid surgical approaches, and pVADs have been described to reduce LV distension.

### Other Temporary MCS Configurations
* **ECMO circuit-based configurations:** Peripheral VA-ECMO limitations have prompted use of ECMO devices to facilitate ventricular unloading by converting to temporary LVAD, RVAD, or BiVAD configuration.
* **BiVAD with oxygenator:** Provides biventricular support and gas exchange through double or single pump configuration. Requires sternotomy and cannulation of LV (or LA), aorta, and/or pulmonary arteries. Reoperation required for explantation or long-term device implantation.
* **Isolated RV support:** Can be provided with CentriMag ECMO system through percutaneous femoral venous access to RA and return to PA via exteriorized Dacron graft. Includes oxygenator for gas exchange and temperature regulation while facilitating protective ventilation. Upon recovery, PA graft can be ligated and buried without re-sternotomy.
* **Percutaneous VADs:** TandemHeart and Impella are viable options to vent the distending LV during peripheral VA-ECMO. Provide some LV support but lack respiratory support capability. Case reports of successful use as RVAD or BiVAD.
* **TandemHeart:** Uses centrifugal pump to drain left atrial blood from catheter placed trans-septally via femoral vein, returns to femoral artery.
* **Impella:** Uses axial pump inserted retrogradely across aortic valve via femoral artery. Impella RP system developed for RV support.
* **Implantable rotary VADs:** New generation devices represent viable bridge to destination or heart transplant. Shortage of donor organs and expanding heart failure population drive growing interest in longer-term MCS.

### Long-Term Implantable VADs
* **Patient selection:** Eligible patients with progressive, non-reversible, chronic heart failure may receive devices as bridge to destination or transplant. Meticulous selection and timely insertion are key to positive outcomes.
* **Risk factors:** INTERMACS data identify older age, ascites, increased bilirubin, and cardiogenic shock (INTERMACS level 1) as highly associated with post-implant mortality. Patients receiving emergent LVADs have lower survival rates than less-ill patients.
* **Device evolution:** Continuous-flow pumps (non-pulsatile) have largely replaced pulsatile LVADs. In 2013, 2420 of 2506 INTERMACS-recorded implants were continuous-flow devices.
* **HeartMate II:** Most widely implanted rotary blood pump (over 20,000 devices). Second-generation design with pivot bearing. FDA approved for bridge to transplant (2008) and destination therapy (2010). Support duration exceeding 8 years.
* **HeartMate 3:** Third-generation centrifugal flow design with magnetically levitated impeller to increase blood flow gaps and reduce blood trauma. Includes small artificial pulse to enhance pump washout and textured surfaces for tissue integration.
* **HeartWare HVAD:** Centrifugal third-generation device with passive magnetic and hydrodynamic levitation. Used for RV support (not FDA/CE approved for this purpose). MVAD (miniaturized axial flow pump) in clinical trials.
* **Early postoperative complications:** RV failure is a major issue. Controversy remains around pre-emptive mechanical RV support; reoperation for RV support once failure sets in increases mortality and morbidity. Vigilance and prompt escalation of pharmacological and mechanical RV support are key.

### Total Artificial Hearts
* **Current clinical use:** SynCardia total artificial heart is the only device with substantial clinical experience. Pulsatile first-generation device with two pneumatically operated chambers providing total systemic and pulmonary flow.
* **Device specifications:** Portable pneumatic driver (6.1 kg) delivers compressed air through percutaneous leads; ~70 mL/beat, flow rates up to 9.5 L/min. Four tilting valves (never failed); pumping diaphragms failure rate <1%.
* **Regulatory status:** CE and FDA approval for bridge to transplant (1999 and 2004); FDA investigational device exemption for destination therapy (2015). Over 1440 implants to date.
* **Support duration:** Longest support 1374 days; typical support 15–90 days. Smaller version with 50 mL chambers has FDA investigational device exemption.
* **Slow uptake:** Lack of long-term, low-wear device with small wearable components; "safety net" of VAD (remnant ventricular contractility) may explain why total artificial hearts used only when absolutely necessary.
* **Alternative approaches:** Dual LVAD configuration for total artificial heart support reported with HeartMate II or HVAD; clinical experience limited. Carmat total artificial heart in early clinical use.

### Quality Assurance, Governance, and Benchmarking
* **Multidisciplinary teamwork:** Substantial team required. Smooth decision-making paradigm including all relevant players, timely action to prevent physiological deterioration.
* **Protocols and guidelines:** Clearly defined work unit guidelines and protocols needed to minimize risks associated with currently imperfect technology.
* **Hub-and-spoke model:** Centers proficient in full array of MCS options serve as hubs for peripheral centers initiating timely temporary MCS (typically peripheral VA-ECMO).
* **Case volume-outcome relationships:** Likely exist in specialized areas. Staff training and individual/institutional accreditation must be considered. Patient referral patterns create pressure on transfer capabilities, ICU, and hospital resources.
* **Data registries:** ELSO, INTERMACS, and other registries allow audit and improvement. Governance and organizational issues at multiple levels require health economists and policy makers.

### Resource and Ethical Issues
* **Resource intensity:** Major barrier for global uptake. Developing, validating, and testing MCS is resource-intensive. Industry, clinicians, researchers, and policy makers must work together.
* **Individual-centric nature:** One size doesn't fit all. Learning curve requires offering extraordinary therapies outside comfort zone of compelling RCT evidence.
* **Emotional challenges:** Staff may find it challenging when patients do not achieve positive outcomes despite prolonged ICU/hospital stays on various bridging options.
* **Ethical considerations:** Significant ethical issues in socially, culturally, and financially diverse world. Should not deter delivery of temporary and longer-term MCS devices.

### Research Priorities
* **Temporary MCS:** Improvement in cannula design; technological solutions to minimize afterload increases and timed afterload reduction to promote aortic valve opening and minimize LV distension. Development of minimally invasive LV venting strategies.
* **Understanding ECMO biology:** Biological burden of extracorporeal circuit poorly understood. Basic science research needed for pathophysiology to optimize hematological, inflammatory, infectious, and pharmacokinetic issues.
* **Clinical research:** Establishing best practice guidelines for ECMO in cardiogenic shock or severe cardiorespiratory failure.
* **Long-term MCS:** Focus on developing system around pump to reduce postoperative complications. Two most frequent adverse events: bleeding (partly due to anticoagulation and acquired von Willebrand syndrome) and infection (driveline infections).
* **Pulsatility:** Relative lack of pulsatility contributes to GI bleeding, arteriovenous malformations, hemolysis, and pump thrombosis. Interest in speed modulation (pulsing rotary blood pumps) increased — potential benefits of increased aortic valve opening, coronary perfusion, baroreflex sensitivity, and ventricular washout.
* **Driveline infections:** Early infections are catastrophic; late-onset driveline infections equal highest cause of death after 4 years of support. Improved driveline development and transcutaneous energy transfer systems required.
* **RV failure:** Frequent and potentially fatal complication after LVAD implantation. Research on dual LVAD biventricular support, RVAD-specific devices, and rotary total artificial heart technology.
* **Physiological control systems:** Active pump speed changes based on hemodynamic feedback; require reliable implantable sensor for clinical acceptance.
* **Global databases:** Establishment of broader acute MCS registry collecting ECMO and pVAD data. ELSO registry modifications needed to include advanced temporary MCS strategies.
* **Trial networks:** ELSO regional representations, International ECMO Network (ECMONet), International Society for Rotary Blood Pumps provide platforms for high-quality trials.

### Key Clinical Takeaway
* **No patient should die without MCS being considered:** In appropriately resourced setting, no eligible patient should die on maximal medical therapy without MCS considered. MCS configurations allow individualized approach driven by ultimate goal of organ recovery or bridging to long-term options.
...
Maximal medical therapy can no longer be seen as a justifiable endpoint for refractory circulatory shock, at least in well-resourced health settings. Despite improvements in almost all other areas of cardiac and intensive care medicine, refractory cardiogenic shock, defined as cardiac and circulatory failure resulting in organ hypoperfusion, continues to have unacceptably high mortality and morbidity from the resultant multiple organ failure. Whilst primary cardiac pathology remains the leading cause of cardiogenic shock, acute cardiomyopathies secondary to conditions such as sepsis and toxic ingestion are not uncommon. The conventional approach to supporting patients with circulatory shock includes reversal of underlying causes when feasible, mechanical ventilation, pharmacological hemodynamic support with or without intra-aortic balloon counterpulsation, renal replacement and other supportive therapy. Whilst mechanical circulatory support (MCS) has always been an attractive option when conventional approaches fail, technological limitations, suboptimal clinical application of available technology and resource limitations have all conspired against its more widespread use.

Recently, there is increasing application of extracorporeal membrane oxygenation (ECMO) technology to provide MCS in an incremental fashion either as peripheral or central venoarterial (VA)-ECMO or as univentricular or biventricular assist devices. The use of ECMO in cardiopulmonary resuscitation (CPR) is also expanding with experienced centers reporting favorable outcomes. Other minimally invasive percutaneous ventricular assist devices (pVADs) have also been used in acute settings. Similarly, the implantable, durable, rotary blood pump-driven VADs have revolutionized the care of patients with chronic heart failure or those with acute heart failure who initially need to be stabilized on temporary MCS, and in whom cardiac recovery does not occur. Although total artificial hearts have been used only sparsely, it is expected that their use will increase with the increasing heart failure population and rapid improvements in technology that are currently occurring.
...
## Mechanical circulatory support strategies</summary><div class="details-content">

<details class="med-details"><summary>

### Intra-aortic balloon pumps</summary><div class="details-content">

Despite the controversies around their efficacy in the setting of cardiogenic shock, IABPs can be seen as a bridge between conventional medical therapy and MCS. IABPs are more widely available than other MCS systems, lower risk, less invasive, easy to institute and may be a useful first-line MCS option while we await definitive evidence for their use in various clinical settings that may lead to cardiogenic shock. More detailed reviews of IABPs and a summary of evidence can be found elsewhere. However, the IABP remains a useful adjunct and it should be noted that while it may improve native cardiac performance by reducing afterload and myocardial oxygen demand, it cannot partially or completely replace cardiopulmonary function. More advanced MCS options need to be considered and an early referral to a MCS center should be considered in a young patient with presumed reversible acute cardiomyopathy or in whom there are no overt contraindications for heart transplantation in the absence of cardiac recovery. Current data suggest that IABPs may assist aortic valve opening in patients requiring peripheral VA-ECMO and they should not necessarily be removed prior to VA-ECMO support.

</div></details>

<details class="med-details"><summary>

### Venoarterial ECMO</summary><div class="details-content">
...
**FIGURE 1** Cannulation sites for venoarterial extracorporeal membrane oxygenation (VA-ECMO). VA-ECMO can be instituted (a) centrally by cannulating the right atrium/inferior vena cava and the aorta, or peripherally using (b) femoral vein and femoral artery (dark blue arrow arterial return cannula, light blue arrow back flow cannula for distal limb perfusion), or (c) axillary/subclavian artery. The choice is often guided by the clinical setting, expected duration of support and pulmonary function. 

</div></details>

<details class="med-details"><summary>

### Other temporary mechanical circulatory support configurations</summary><div class="details-content">

<details class="med-details"><summary>

#### Configurations based on the ECMO circuit</summary><div class="details-content">

The limitations of peripheral VA-ECMO have prompted the use of ECMO devices to facilitate ventricular unloading by changing to a temporary left or right VAD or a BiVAD configuration. Any perfusion strategy that creates a right-to-left shunt requires an oxygenator in the circuit. Oxygenators may additionally facilitate temperature management. This strategy effectively provides biventricular support and gas exchange through a double ([Fig. 2a](#fig-2a)) or single ([Fig. 2b](#fig-2b)) pump configuration with the ability to cease RV support when not required and thereafter to discontinue the oxygenator. However, this configuration requires a sternotomy and cannulation of the left ventricle (or left atrium), aorta and/or pulmonary arteries. A reoperation (sternotomy or thoracotomy) is then required for explantation of the cannula from the left ventricle or left atrium upon cardiac recovery or for implantation of a long-term mechanical assist device.

RV support for up to several months can be provided with a CentriMag ECMO system through percutaneous femoral venous access to the right atrium and return to the pulmonary artery via a cannulated exteriorized Dacron graft. Alternatively, venous drainage can also be achieved through a centrally placed right atrial cannula. This strategy is described for temporary support of the right ventricle with insertion of a long term LVAD but is applicable to other causes of severe isolated RV dysfunction, such as post-massive pulmonary embolism. Inclusion of an oxygenator into the circuit at this stage ensures adequate oxygenation, CO<sub>2</sub> removal and temperature regulation whilst facilitating protective ventilation. Upon RV recovery, the pulmonary artery graft can be ligated and buried upon decannulation without re-sternotomy.

<span id="fig-2a"></span>![](_picture_02.jpeg)

**FIGURE 2** Temporary biventricular support strategies. (a) Biventricular assist and oxygenation support using two centrifugal pumps. Cannulation details: transfemoral right atrium (RA) drainage to allograft to pulmonary artery (PA) for returning oxygenated blood; and left ventricle (LV) apex drainage to aorta return. An oxygenator was included in the right ventricular assist device circuit. (b) Biventricular and oxygenation support provided using a single centrifugal pump. Dual drainage cannulas positioned in the LV apically and right atrium transfemorally. Oxygenated blood was returned to the ascending aorta through central cannulation. Insert demonstrates how the two drainage tubes were merged using a Y-connector to enable usage of a single pump. 

</div></details>

<details class="med-details"><summary>

#### Percutaneous ventricular assist devices</summary><div class="details-content">

The TandemHeart and Impella devices ([Fig. 3](#fig-3)) are viable options to vent the distending left ventricle during peripheral VA-ECMO support. These devices in many ways are likely to form a significant part of our armamentarium whilst providing individualized MCS to a patient with acute cardiac failure.

The TandemHeart uses a centrifugal pump to drain the left atrial blood from a catheter placed trans-septally via the femoral vein and returns it to the femoral artery. The Impella uses an axial pump that is inserted retrogradely across the aortic valve via the femoral artery. These devices provide some LV support but lack the ability to provide extracorporeal respiratory support if required. However, there are case reports pertaining to their successful use as RV assist and or biventricular assist devices. Similarly, minimally invasive percutaneous right VADs have been developed (Impella RP system, Abiomed and TandemHeart, CardiacAssist) and may be significant additions to the spectrum of available MCS therapies in the future.

There has been a radical shift in VAD technology and new generation implantable rotary blood pumps are now a viable bridge to destination or heart transplant. The shortage of appropriate donor organs and the expanding pool of patients waiting for heart transplantation have led to growing interest in alternative strategies, particularly in longer term MCS.

<span id="fig-3"></span>![](_picture_03.jpeg)

**FIGURE 3** Schematic representation of two commercially available percutaneous ventricular assist devices. (a) the TandemHeart pVAD (Cardiac Assist Inc., Pittsburgh, PA, USA), (b) the Impella pVAD (AbioMed Europe, Aachen, Germany). 
...
### Long-term implantable VADs</summary><div class="details-content">

<details class="med-details"><summary>

#### Indications for support</summary><div class="details-content">
...
Improved results and the increased applicability and durability of LVADs have enhanced this treatment option for end-stage heart failure patients. Results using non-pulsatile continuous flow pumps as a bridge to transplant or destination subsequent to the landmark Randomized Evaluation of Mechanical Assistance for the Treatment of Congestive Heart Failure (REMATCH) Trial are very promising and significantly better when compared with pulsatile LVADs. In 2006, 78 of the 98 implanted devices recorded on the INTERMACS registry were pulsatile, intracorporeal devices, whereas in 2013, 2420 of the 2506 implanted devices recorded on the INTERMACS registry were continuous flow intracorporeal devices. Therefore, this section focuses solely on the continuous flow VADs which are commonly used in the clinical setting and does not report on devices no longer clinically available or those under development. A summary of the technical aspects of the devices in this review is provided in Table 2. We briefly discuss the two commonly used rotary blood pump-based VADs in this article.

The HeartMate II (Thoratec Corporation, Pleasanton, CA) is the most widely implanted rotary blood pump ([Fig. 4a](#fig-4a)), with a second-generation design that relies on a pivot bearing; however minimal wear is reported. To date, over 20,000 HeartMate II devices have been implanted with support duration exceeding 8 years.

The HeartMate II received Food and Drug Administration (FDA) approval for bridge to transplant in 2008 and for destination therapy in 2010. In 2014, Thoratec started clinical trials for the HeartMate 3, a third-generation centrifugal flow design with a magnetically levitated impeller to increase blood flow gaps and reduce blood trauma. The HeartMate 3 includes a small artificial pulse to enhance pump washout and textured blood-contacting surfaces to encourage tissue integration. The HeartWare HVAD ([Fig. 4b](#fig-4b)) is a centrifugal, third generation device with passive magnetic and hydrodynamic forces levitating the impeller and two axial flux motors for redundancy in case one fails. The HVAD has also been used for RV support, although CE or FDA approval for this purpose has not been obtained. In 2015, HeartWare started clinical trials of the miniaturized MVAD, an axial flow pump approximately one-third the size of the HVAD with similar impeller levitation principles and capable of less-invasive implantation due to its smaller size.

Apart from early postoperative hemostatic complications, a major issue in the early postoperative course is that of RV failure. While controversy remains around pre-emptive mechanical RV support using a temporary RVAD based on ECMO circuitry or an implantable LVAD on the right (there is no customized, long-term rotary RVAD at this stage), it should be noted that re-operation to institute mechanical RV support once RV failure sets in adds to mortality and morbidity in these patients. A high index of suspicion preoperatively and vigilance and prompt escalation of pharmacological and mechanical RV support intra- and postoperatively is the key. I refer the readers elsewhere for a more detailed summary of outcomes and complications.

<span id="fig-4a"></span>![](_picture_04.jpeg)

**FIGURE 4** Two commonly used rotary ventricular assist devices (VADs). (a) Thoratec HeartMate II, (b) HeartWare HVAD. 
...
### Total artificial hearts</summary><div class="details-content">

Compared to the dramatic increase in continuous intracorporeal pump implants over the last decade, clinical use of total artificial hearts has been much slower. In 2007, the INTERMACS database reported 22 pulsatile intracorporeal total artificial heart implants, which had increased only to 66 by 2013. The lack of a longterm, low-wear device with small wearable components, as seen in the latest generation of VADs, may have contributed to the slow uptake of total artificial hearts. Meanwhile, the 'safety net' provided with a VAD, where remnant ventricular contractility may sustain life until emergency intervention, could also explain why total artificial hearts are only used when absolutely necessary.

Although several total artificial hearts, such as the Liotta-Cooley, Akutsu III and the AbioCor devices, have been used to support patients, these devices are no longer used clinically. The Carmat (Velizy Villacoublay, France) total artificial heart is currently in clinical use, however very few patients have been supported since the first implant in December 2013. Meanwhile, the use of a dual LVAD configuration for total artificial heart support has been reported using dual HeartMate II or HeartWare HVAD devices; however clinical experience with this technique is limited. The only total artificial heart currently available to fully support the circulation for which there is substantial clinical experience is the SynCardia total artificial heart (SynCardia, Tucson, AZ).

Initially developed as the Jarvik 7 and renamed as the Symbion, Cardiowest and now SynCardia total artificial heart, this pulsatile first generation device consists of two pneumatically operated chambers which provide total systemic and pulmonary flow. A pneumatic driver, for which a 6.1 kg portable version now exists, supplies pulses of compressed air through percutaneous leads to the left and right chambers to deliver almost 70 mL/beat. The beat rate can be changed to deliver flow rates up to 9.5 L/min from the device, which weighs 160 g. Unidirectional flow is achieved with four tilting valves, which have reportedly never failed, while the pumping diaphragms have a failure rate of less than 1%. Although the SynCardia total artificial heart has been in clinical use for several decades with CE and FDA approval for bridge-to-transplant (1999 and 2004 respectively) and FDA investigational device exemption for destination therapy (2015), widespread clinical use has been slow with over 1440 implants to date. The longest duration of support with the SynCardia total artificial heart currently stands at 1374 days; however typical support duration is closer to 15–90 days at different centers. Meanwhile, SynCardia have recently had FDA investigational device exemption approval for a smaller total artificial heart version with 50 mL pneumatic chambers.

The quest for a durable, safe, practical and affordable total artificial heart continues and rotary blood pump technology has the potential to deliver the same. In the meantime, the temporary and long term MCS options discussed thus far will have to be used in an individualized, tailored fashion so that positive patient outcomes may be achieved whilst making the most of available technology.
...
## Quality assurance, governance and benchmarking</summary><div class="details-content">
...
### Global trial networks</summary><div class="details-content">
