...
### Coronary Anatomy and Target Vessels
- **Epicardial coronary arteries:** Located deep to epicardial fat, superficial to myocardium. Left‑sided vessels may be intramyocardial (suggested by a straighter course on angiography).
- **Left anterior descending (LAD):** Courses in interventricular groove, supplies diagonal branches to anterior wall.
- **Ramus intermedius (RI):** Arises between LAD and left circumflex (LCx), often near left atrial appendage base.
- **Left circumflex (LCx):** Originates from left main bifurcation, runs in atrioventricular groove, gives obtuse marginal branches to lateral/inferolateral myocardium.
- **Right coronary artery (RCA):** Arises anteriorly from aortic root, crosses acute margin, bifurcates into posterior descending artery (PDA) and posterolateral ventricular branch (PLVB). Coronary dominance defined by origin of PDA.

### Conduits for CABG
- **Left internal mammary artery (LIMA):** Originates from proximal left subclavian artery, ~1.5 cm lateral to sternocostal junction. Proximal harvest risks phrenic nerve injury. Below sixth rib covered by transversus thoracis; bifurcates into musculophrenic and superior epigastric arteries.
- **Radial artery:** Originates from brachial artery, runs under brachioradialis. Harvest from nondominant arm; care to avoid superficial radial and lateral antebrachial cutaneous nerves.
- **Great saphenous vein (GSV):** Medial lower extremity, superficial at medial malleolus, drains into common femoral vein at saphenofemoral junction.

### Preoperative Evaluation
- **History:** Comorbidities (stroke, GI bleeding, diabetes, COPD, renal failure, PAD); prior chest surgery; conduit‑affecting procedures (radial artery catheterization, varicose vein stripping).
- **Physical exam:** Bilateral arm pressures (subclavian stenosis); skin over harvest sites; carotid bruit; Allen test before radial harvest; AV fistula may steal from ipsilateral IMA; distal pulses for alternative cannulation; leg inspection for venous stasis/varicosities.
- **Tests:** CBC, coagulation, chemistry, ECG, transthoracic echocardiography (EF, valves). Left heart catheterization defines coronary anatomy, LV function, aortic/mitral pathology. Chest x‑ray for aortic calcification; noncontrast CT for porcelain aorta. Carotid duplex if symptomatic or left main stenosis. Duplex of radial/saphenous vein if concern.

### Intraoperative Preparation
- **Positioning:** Supine, arms padded parallel to torso; for radial harvest, ipsilateral arm abducted 45–60°.
- **Monitoring:** Noninvasive BP cuff, radial arterial line (opposite harvest side), CVC (IJ). Pulmonary artery catheter for high‑risk patients. TEE after induction; NIRS if cerebrovascular risk.
- **Other:** Hair removal with electric razor; leads/pads away from incisions; scapular roll for sternotomy; knee bolsters for GSV harvest. Antibiotics (cephalosporin ± vancomycin for MRSA) within 30 min. Skin prep from chin to toes with iodophor or chlorhexidine.

### Operative Steps – Conduit Harvest
- **IMA harvest:** Median sternotomy; self‑retaining retractor elevates sternal edge. Pedicled technique (1.5–2 cm pedicle with endothoracic fascia and veins) or skeletonized (preferred for bilateral IMA to avoid sternal devascularization). Hemoclips on intercostal branches; avoid thermal injury. Proximal 3 cm most risky for phrenic nerve. Right IMA: mammary vein crosses medially earlier, phrenic nerve intersection more proximal.
- **GSV harvest:** Concurrent with IMA. Open, semi‑open (bridged), or endoscopic (most common). Ligate ends, remove, cannulate distal end for gentle pressurization. Clip or oversew side branches. Longitudinal mark prevents torsion during proximal anastomosis.
- **Radial artery harvest:** Nondominant arm. Longitudinal incision from 2 cm proximal to radial styloid to 2 cm proximal to antecubital fossa, extending medially toward biceps tendon. Between flexor carpi radialis and brachioradialis. After exposing deep fascia, transiently occlude distal end to check collateral flow (pulse oximetry). Divide branches with clips/electrocautery/harmonic scalpel. Avoid lateral antebrachial cutaneous and superficial radial nerves. After heparinization, ligate ends, store in heparinized solution with nitroglycerin/CCB to prevent spasm.

### Operative Steps – Bypass Construction
- **Pericardial well:** After conduit harvest, place sternal retractor, open pericardium in inverted T, secure edges.
- **Aortic cannulation:** Palpate for calcium. Two concentric diamond‑shaped pursestring sutures in distal ascending aorta. After heparin, lower BP to 100–110 mmHg systolic, insert cannula.
- **Venous drainage:** Circumferential pursestring on right atrial appendage, transect tip, cannulate.
- **Cardioplegia:** Antegrade catheter in ascending aorta proximal to cross‑clamp site. Optional retrograde catheter via right atrium into coronary sinus (confirm by TEE, palpation, dark blood return, pressure tracing <40 mmHg).
- **CPB initiation:** Confirm anticoagulation, start CPB, discontinue ventilation. Surgeon‑directed systemic cooling.
- **Cross‑clamping:** Atraumatic clamp just proximal to arterial cannula and distal to cardioplegia catheter. Lower CPB flow to decompress aorta. Administer cardioplegia (palpate aortic root for antegrade pressure; coronary sinus pressure ≤40 mmHg for retrograde). Topical cooling with iced saline slush, wet pads, or cold irrigation.
- **Distal anastomoses sequence (author’s standard):** Right‑sided targets → LCx → RI → diagonal → LAD.
- **Arteriotomy technique:** Clear epicardial fat, temporarily clamp vents to distend vessel. #15 blade incise midline avoiding back wall; Pott’s scissors extend proximally and distally. Arteriotomy length ≥1.5 × vessel diameter, matched to conduit. Bevel conduit 30°, create small notch at heel. Running 7‑0 polypropylene (8‑0 for IMA). After completion, inject cardioplegia or heparinized saline to test flow and leaks.
- **IMA pedicled anastomosis:** Interrupt flow with soft bulldog clamp. Create pericardial window (avoid phrenic nerve). Trim graft to appropriate length. Before finalizing, transiently release clamp to confirm flow. Secure lateral edges of pedicle to epicardial fat with polypropylene sutures to prevent torsion.
- **Sequential grafting:** Single conduit with two distal anastomoses. Ideal when distal targets small or conduit limited. Most distal target should be largest with best outflow. Perform distalmost anastomosis first, then fill graft to position proximal‑distal anastomosis. Side‑to‑side diamond‑shaped (conduit perpendicular) or parallel (avoid gull wing deformity).
- **Y/T grafting:** End‑to‑side anastomosis on a bypass graft for proximal inflow when aorta is unfavorable or conduit‑aorta mismatch.
- **Proximal anastomoses:** Can be done after each distal or after all distals, with cross‑clamp still on or with partial occlusion clamp. Measure graft length to avoid redundancy or stretching. #11 blade incise aorta, then 4–5 mm aortic punch. Running polypropylene 5‑0 to 7‑0. De‑air with 25‑G needle if needed.
- **Reperfusion and weaning:** Optimize metabolic parameters and hemodynamics. Inspect all anastomoses and grafts for hemostasis/kinking (lateral/inferior walls may be hidden). Review ECG, hemodynamics, TEE. During weaning, monitor graft position as lungs inflate and ventricles fill. After separation, administer protamine, decannulate. Re‑inspect IMA harvest sites with sternal edge retraction. Close sternum carefully – graft positioning may change.

### Postoperative Care
- **ICU management:** Early neurologic evaluation. Hemodynamically stable patients without bleeding – early extubation. Goal‑directed weaning of inotropes/vasopressors. Monitor chest tube output.
- **Medications:** Aspirin within 6 hours; beta‑blocker if hemodynamics permit; insulin infusion for glucose control; statins early unless contraindicated; nitrates/CCB if radial artery used (reduce spasm risk).
- **Mobilization:** Early, transfer from ICU by POD 1–2. Chest tubes removed POD 2–3 depending on output. Diuresis starting POD 1 until normal fluid balance.

### Pearls and Pitfalls
- Preoperative check: target suitability, conduit quality, absence of severe aortic calcification.
- Excessive sternal retraction during IMA harvest → sternal/rib fracture or brachial plexus injury.
- Avoid excess IMA manipulation (dissection, thrombosis, intimal injury → late graft failure).
- Excessive pressurization or thermal injury of saphenous vein → intimal injury → graft failure.
- Plan aortic cannula, cross‑clamp, and cardioplegia sites with heart full.
- Epicardial targets may need extensive fat/myocardial dissection; ensure meticulous hemostasis to avoid post‑cross‑clamp bleeding.
- If proximal/mid target vessel not visible, pass a coronary probe retrograde from the distal vessel.
...
- Right or left coronary dominance refers to the artery from which the PDA originates.
...
### 1. Preoperative Preparation</summary><div class="details-content">
...
### 2. Intraoperative Preparation</summary><div class="details-content">
...
### Harvesting of Conduits</summary><div class="details-content">
...
### Cannulation and Cardiopulmonary Bypass</summary><div class="details-content">

After harvesting of the conduit, a sternal retractor is placed, and the pericardium is opened in an inverted T fashion. The edges of the pericardium are secured to the retractor or subcutaneous tissue to create the pericardial well.
...
### Sequential and Y‑Grafting Techniques</summary><div class="details-content">

On occasion, when distal targets are small, the conduit is limited, or proximal anastomotic sites are limited, sequential anastomotic techniques should be considered. Sequential grafting uses a single conduit with multiple distal anastomoses (usually two) and one proximal anastomosis—the source of inflow. Although offering the aforementioned advantages, sequential grafting does rely on a single inflow source of blood to supply multiple targets and may result in competitive flow imbalance if the proximal outflow is greater than the distal outflow, and it can be subject to kinking or graft torsion if the targets are not aligned properly. Sequential grafting can be performed with a free conduit such as a radial artery graft, GSV graft, or a pedicled IMA. Ideally, the most distal target should be the largest of the targets with the best outflow, and the targets should lie in an anatomic position to minimize the risk of kinking, as can occur with sequential grafting of obtuse marginal targets or diagonal-LAD artery target combinations. When performing sequential grafting using a free graft, we perform the distalmost target anastomosis first, using the technique described previously. The graft and heart are then filled to identify the optimal position of the more proximal distal anastomosis. Both the conduit and target are then incised longitudinally, taking into consideration the size of the prior anastomosis. Depending on the location of the target vessel, an eight-stitch, side-to-side anastomosis can be fashioned with the conduit perpendicular to the target, creating a diamond-shaped anastomosis. Alternatively, a larger side-to-side anastomosis, with the vessels parallel to one another, can be fashioned to avoid a gull wing deformity.
