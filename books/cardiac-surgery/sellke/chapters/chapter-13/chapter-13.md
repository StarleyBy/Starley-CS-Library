...
- **Aortic root components:** Aortic annulus (AA), aortic cusps, aortic sinuses, sinotubular junction (STJ). AA is scalloped, attaches cusps to root and LV. 45% of AA attached to muscular septum, 55% to fibrous tissue (membranous septum and fibrous body connecting anterior mitral leaflet) ([Fig. 13.1](#fig-13-1)).
- **Geometric relationships:** Base of cusp = 1.5 × free margin (FM) length ([Fig. 13.2](#fig-13-2)). AA evolves along three separate horizontal planes ([Fig. 13.3](#fig-13-3)). STJ lies above commissures.
- **Ascending aortic aneurysm:** Causes STJ dilation → AI due to lack of coaptation ([Fig. 13.4](#fig-13-4)). AA normal. Patients 6th‑7th decade. Replace ascending aorta, correct STJ, replace sinuses if needed, repair cusp prolapse.
- **Aortic root aneurysm:** Starts with sinus dilation, extends to AA and STJ. Associated with genetic syndromes (Marfan, Loeys‑Dietz). Flattening of subcommissural triangles decreases coaptation ([Fig. 13.5](#fig-13-5)). Surgery when sinus diameter ≥50 mm (lower if family history of dissection).

### Preoperative Considerations
- Echocardiography diagnoses aneurysm and AI. CT/MRI for extent (arch often involved in older patients with ascending aneurysm). TEE best for AI mechanism, AA/STJ diameters, cusp height, number, thickness, FM appearance, excursion. Thin, mobile cusps with smooth FMs → high feasibility of repair (including bicuspid).

### Operative Steps

#### Ascending Aortic Aneurysm with AI
- Transect aorta 5‑6 mm above STJ. AI usually due to STJ dilation. Reduce STJ by suturing appropriate graft. Determine graft size: approximate commissures until cusps coapt centrally (Freestyle sizer). When in doubt, take larger size (can reduce later by plication). Avoid small grafts (increase LV afterload) ([Fig. 13.6](#fig-13-6)).
- If noncoronary sinus dilated/dissected: replace it. Divide graft into thirds, fashion neoaortic sinus (height ≈ graft diameter). Secure commissures of noncoronary cusp, suture neoaortic sinus to remnant aortic wall and AA ([Fig. 13.7](#fig-13-7)).
- If noncoronary and right sinuses dilated: replace both, reimplant right coronary artery into neoaortic sinus ([Fig. 13.8](#fig-13-8)).
- If all three sinuses dilated: excise sinuses leaving 5 mm wall attached to AA. Detach coronaries with 5 mm buttons. Suspend commissures equally. Estimate commissural circle diameter with sizers. Tailor three neoaortic sinuses in graft (width proportional to cusp size). Suture neoaortic sinuses to remnants and AA. Reimplant coronary buttons (openings ≤2× coronary diameter) ([Fig. 13.9](#fig-13-9)).
- After remodeling, cusps should coapt well above AA nadir. If cusp coapts lower, shorten FM by plication along nodule of Arantius with 5‑0/6‑0 polypropylene ([Fig. 13.10](#fig-13-10)).
- Stress fenestration along commissural edge: reinforce FM with double layer of 6‑0/7‑0 PTFE ([Fig. 13.11](#fig-13-11)).
- Test valve competence: inject cardioplegia into graft under pressure – no ventricular distention means no/trace AI.

#### Aortic Root Aneurysm – Reimplantation of the Aortic Valve
- Preferred for young adults with root aneurysm (more durable than remodeling, especially in genetic syndromes). Also valuable for incompetent bicuspid AV with dilated AA, and acute type A dissection with dilated root.
- Excise three aortic sinuses (same as remodeling, [Fig. 13.9A,B](#fig-13-9)), leave 5‑6 mm wall attached to AA. Stay sutures above commissures.
- Dissect aortic root free from PA and RV down to below AA. Pass multiple horizontal mattress 2‑0/3‑0 polyester sutures from inside to outside LVOT immediately below AA nadir, through a single horizontal plane along fibrous portion and scalloped shape in septum ([Fig. 13.12A](#fig-13-12)). For membranous septum, place sutures slightly higher to avoid bundle of His. Use Teflon pledgets if tissue thin/soft.
- Average cusp heights → graft diameter = 2 × average height. Alternatively estimate from remodeling technique or height of left‑noncoronary commissure.
- Place three equidistant marks on graft end. Cut 5 mm triangular segment at mark for left and right subcommissural triangles ([Fig. 13.12A](#fig-13-12)). Pass LVOT sutures through graft. Space symmetrically if AA not dilated; if AA dilated, space closer beneath noncoronary subcommissural triangles (where dilation occurs) ([Fig. 13.12B](#fig-13-12)).
- Tie sutures on outside of graft (avoid purse‑string). Cut graft to ~5 cm, pull up gently. Pull commissures vertically, temporarily secure with transfixing 4‑0 polypropylene (not tied) ([Fig. 13.12C](#fig-13-12)). Inspect alignment.
- Tie sutures to secure AA into graft. Pass suture sequentially inside→outside at annulus, outside→inside at remnant arterial wall. Start at commissure, stop at nadir, tie on outside. Reimplant coronary arteries.
- Inspect coaptation level – should be well above nadir. If low, shorten FM ([Fig. 13.10](#fig-13-10) and [13.12D](#fig-13-12)). Reinforce fenestrations with PTFE ([Fig. 13.11](#fig-13-11)). Test competence with cardioplegia.
- Suture graft to distal ascending aorta ([Fig. 13.12E](#fig-13-12)). Author recommends straight tubular Dacron graft (most durable). If neoaortic sinuses desired, use graft 2‑4 mm larger and plicate at nadir and between commissures. Typical graft sizes: 28‑30 mm straight, 30‑32 mm with sinuses.

### Postoperative Care
- Elective mortality <2%. More extensive surgery (arch, mitral, revascularization) has higher complication rates but >90% have no serious complications.
- Postop bleeding: ~50% require blood products. New heart block <1%. Atrial fibrillation ~20% (pharmacologic management). Beta‑blocker for genetic syndrome or dissection if tolerated. No oral anticoagulation unless AF >24 hours or mitral annuloplasty ring (heparin then warfarin 3 months).
- Annual echocardiography. For extensive vascular disease or dissection, periodic CT/MRI.

### Pearls and Pitfalls
- Complex procedures requiring deep knowledge of functional anatomy and technical expertise. Do not perform if cusps grossly abnormal.
- Graft sizing is difficult for beginners; easier for remodeling than reimplantation. Use average cusp height ×2 for reimplantation graft diameter – reduces annulus radius to height minus aortoventricular junction thickness, allowing coaptation well above nadir.
- Coaptation level ≥8 mm above AA nadir critical for durability.
- AA evolves along horizontal planes; straight tubular graft (cylinder) best stabilizes dilated AA. Avoid spherical grafts with neoaortic sinuses (deform AA).
- Meticulous hemostatic anastomoses; coagulopathy common after long bypass – avoid mechanical bleeding.

</div></details>

<details class="med-details"><summary>

## Step 1. Surgical Anatomy of the Aortic Root</summary><div class="details-content">

- ◆ The aortic root is the anatomic segment between the left ventricle and ascending aorta. From the surgical viewpoint, it consists of the aortic annulus (AA), aortic cusps, aortic sinuses, and sinotubular junction (STJ). Although the term *aortic annulus* may be anatomically incorrect, it is often used in surgical anatomy and pathology to describe the aortoventricular junction. Approximately 45% of the circumference of the AA is attached to muscular interventricular septum, and 55% is attached to fibrous tissue, as shown in ([Fig. 13.1](#fig-13-1)). This fibrous tissue is the membranous interventricular septum and the fibrous body that connects the anterior leaflet of the mitral valve to the aortic root.
- ◆ The AA is scalloped and attaches the aortic cusps to the aortic root and left ventricle. The portion of the AA corresponding to the noncoronary cusp is attached entirely to fibrous tissue, whereas the portions corresponding to the left and right coronary cusps are partially attached to fibrous tissue and partially to cardiac muscle. The highest point of the AA, where two cusps meet, is the commissure. The anatomic arrangement of the AA creates a triangular space beneath the cusps, termed the *subcommissural triangle.* There are three commissures and three subcommissural triangles. The STJ lies immediately above the commissures and separates the aortic root from the ascending aorta. The arterial wall contained between the AA and STJ creates the aortic sinuses, or sinuses of Valsalva. The three aortic cusps have a crescent shape and often are of different sizes, but the length of the base of a cusp is always 1.5 times longer than the length of its free margin (FM), as illustrated in ([Fig. 13.2](#fig-13-2)). Thus, a large cusp will have a proportionally longer base (AA), longer FM, longer intercommissural distance along the STJ, and larger aortic sinus. The noncoronary and right cusps and sinuses are often larger than the left cusp and left aortic sinus.
- ◆ The AA is a three-dimensional structure that evolves along three separate planes, as illustrated in ([Fig. 13.3A–C](#fig-13-3)). Each aortic cusp is inserted in the annulus along a horizontal plane (see [Fig. 13.3D](#fig-13-3)). For practical purposes, we usually refer to its diameter as the maximal distance at the level of its nadir.
- ◆ The relationship of the diameters of the AA at this level and at higher levels until reaching the commissures (STJ) varies with age. In children and young adults, the diameter of the AA is 15% to 20% larger than its diameter at the level of the commissures (STJ). As the elastic fibers of the arterial wall decrease with age, the STJ dilates and tends to become equal to the diameter of the lower AA in adults. However, the AA of each cusp evolves along a single horizontal plane (see [Fig. 13.3](#fig-13-3)).
- ◆ Ascending aortic aneurysms can cause aortic dissection or rupture when their transverse diameter exceeds 55 mm. Aneurysms of the ascending aorta can also cause dilation of the STJ, with consequent aortic insufficiency due to lack of coaptation of the cusps, as illustrated in ([Fig. 13.4](#fig-13-4)). One or more aortic sinuses may also become secondarily dilated, but the AA often remains normal. Patients with ascending aortic aneurysms and aortic insufficiency are usually in their sixth or seventh decade of life. If the aortic cusps are normal or minimally elongated along their FMs, it is possible to replace the ascending aorta with correction of the diameter of the STJ, replace one or more sinuses if necessary, repair the cusps if there is prolapse, and reestablish aortic valve competence.
- ◆ Aortic root aneurysms usually start with dilation of the aortic sinuses and, with time, the dilation extends proximally into the AA and distally into the STJ. Patients with an aortic root aneurysm are usually in the second to fourth decade of life when they need surgery, and the aneurysm is often associated with genetic syndromes, such as Marfan syndrome, Loeys-Dietz syndrome, and others. The two subcommissural triangles of the noncoronary cusp flatten as the AA dilates, which decreases the coaptation area of the cusps and may cause aortic insufficiency ([Fig. 13.5](#fig-13-5)). The indication for surgery is usually based on the diameter of the aortic sinuses and family history of aortic dissection. In most cases, surgery is recommended when the diameter reaches 50 mm and less if there is a family history of aortic dissection.
...
**Figure 13.3** The aortic annulus evolves along a cylinder.
...
**Figure 13.5** Flattening of subcommissural triangles decreases cusp coaptation.
...
### 1. Ascending Aortic Aneurysms With Aortic Insufficiency</summary><div class="details-content">
...
**Figure 13.11** Cusps with large fenestration can be reinforced with a double layer of fine expanded polytetrafluoroethylene suture above and below the defect.

</div></details>

<details class="med-details"><summary>

### 2. Aortic Root Aneurysm</summary><div class="details-content">
