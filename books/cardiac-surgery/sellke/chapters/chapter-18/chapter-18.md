...
##### Degenerative mitral valve disease, also called *mitral valve prolapse* or *floppy mitral valve syndrome*, is caused by myxomatous degeneration of the mitral valve tissue, whereby elastin and collagen bundles are disrupted, and proteoglycan deposition in the spongiosa results in leaflet thickening and redundancy. This, in turn, can cause impaired leaflet coaptation, chordal elongation or rupture, and annular dilation, resulting in mitral regurgitation. In the United States and other western countries, degenerative mitral valve disease is the most common cause of mitral regurgitation, with between 2% and 3% of adults suffering from at least moderate mitral regurgitation. Of these, approximately 10% develop significant mitral regurgitation requiring surgical intervention. Mitral valve repair is the recommended treatment for degenerative mitral valve disease. Mitral valve repair, when compared to replacement, reproducibly improves survival, left ventricular function, and freedom from reoperation. Despite the superiority of mitral valve repair over replacement, a large proportion of patients with degenerative mitral valve disease still undergo replacement. With experience, nearly any myxomatous mitral valve can be repaired, importantly with near 0% mortality rates. In this chapter, various techniques for repairing degenerative mitral valve disease are presented. The goal is to provide surgeons with an expanded armamentarium for repairing the mitral valve.
...
* **Degenerative mitral valve disease:** Myxomatous degeneration → leaflet thickening/redundancy → impaired coaptation, chordal elongation/rupture, annular dilation → MR.
* **Prevalence:** 2-3% of adults have at least moderate MR; ~10% develop severe MR requiring surgery.
* **Repair vs. replacement:** Repair improves survival, LV function, freedom from reoperation. With experience, near 0% mortality for repair.

### Surgical Anatomy
* **Atriovalvular junction (hinge):** Visible demarcation between pink atrial myocardium and pale leaflets. Annulus is 1-2 mm deep and external to hinge.
* **Annular shape:** Hyperbolic paraboloid (saddle) — midanterior and midposterior segments highest, commissures lowest.
* **Aortomitral curtain:** Connects mitral and aortic annuli at 120°, flanked by fibrous trigones. Anterior leaflet attaches to dense portion (40% of circumference). Posterior annulus (60%) is discontinuous and thinner → prone to dilation.
* **Leaflet segments:** Anterior (A1, A2, A3), posterior (P1, P2, P3). Commissures: anterolateral (AC) and posteromedial (PC).
* **Chordae tendineae:** Primary (marginal) — prevent prolapse; secondary (intermediary) — support leaflet tissue; tertiary (basal) — only on posterior/commissural leaflets.
* **Papillary muscles:** Anterolateral (solitary, dual blood supply LAD + circumflex), posteromedial (multiple heads, solitary blood supply) — more sensitive to ischemia.

### Preoperative Considerations
* **Fibroelastic deficiency:** Older patients, recent diagnosis, thin leaflets, single segment prolapse (ruptured chords).
* **Barlow syndrome:** Younger patients, long history of murmur, family history, marfanoid features, thickened/billowing leaflets, multiple prolapsing segments, possible calcification.
* **Echocardiography essential:** Valve anatomy, lesions, cause, 3D adjunct, other valves, biventricular function, atrial size, PAP.

### Operative Approach
* **Median sternotomy:** For multiple valves or concomitant procedures.
* **Partial sternotomy (upper/lower):** Permits access, but xiphisternal fascia incision prone to infection.
* **Right anterolateral minithoracotomy (preferred minimally invasive):** 3-4 cm incision (inframammary crease in females, above nipple in males), enter through 3rd or 4th interspace. Peripheral cannulation (femoral artery/vein + internal jugular vein). Transthoracic Chitwood clamp for aortic occlusion.

### Cardiopulmonary Bypass Management
* **Myocardial protection:** Cold blood high-K cardioplegia (intermittent antegrade or combined antegrade-retrograde). Moderate systemic + topical hypothermia.
* **Sequence with concomitant procedures:** CABG distal anastomoses first (lifting heart after prosthesis risks rupture). Aortic valve excision/debridement before mitral repair (prevents cutting sutures). Mitral repair before aortic replacement (prosthesis distorts annulus). Tricuspid repair after left-sided procedures (may be after cross-clamp removal).

### Exposing the Mitral Valve
* **Sondergaard's groove (most common):** Separate right and left atrial surfaces anterior to right pulmonary veins. Start on left atrial body (avoid pulmonary vein injury).
* **Right atrial transseptal approach:** Right atriotomy, incise interatrial septum through fossa ovalis. Useful for prior AVR (AC exposure challenging) or concomitant tricuspid surgery.
* **Left atrial dome approach:** Incise roof between aorta and SVC (small working room, difficult hemostasis). Combine with transseptal for expanded exposure.
* **Transventricular approach:** For LV aneurysm repair (use off-pump stabilizer).
* **Transaortic approach:** For aortomitral endocarditis.

### Remodeling Ring Annuloplasty
* **Indication:** Nearly all chronic MR patients (prevents further dilation, improves durability). Complete saddle-shaped rings preferred.
* **Sequence:** Place annuloplasty sutures first (retracts valve, improves visualization) → repair defects → place ring → additional repair if regurgitation persists.
* **Suture placement:** Circumferential, entering/exiting just outside atriovalvular junction. Bites ~10 mm following needle curve, 2 mm spacing.
* **Avoid injury:** Anterior annulus — noncoronary cusp of aortic valve. Near AC and posterior annulus — circumflex artery.
* **Sizing:** Based on intercommissural distance and anterior leaflet surface area. If anterior leaflet free edge extends 2-4 mm beyond ring sizer → choose one size larger (prevents SAM).
* **Suture distribution:** Equal distances on anterior aspect (no dilation). Less travel on posterior aspect (corrects dilation). Use commissural markings on ring.

### Correcting Posterior Leaflet Prolapse
* **Triangular resection (limited tissue):** Stay sutures flank prolapsed segment. Two diagonal incisions toward annulus → triangular excision. Reapproximate free edges with polypropylene.
* **Quadrangular resection (extensive tissue):** Two perpendicular incisions from free margin to annulus. Annular plication stitch (2-0) spanning gap, then reapproximate free edges.
* **Sliding leaflet plasty (large resection or height reduction):** After quadrangular resection, detach P1 and P3 from annulus. Reapproximate to annulus with more annular travel than leaflet tissue (medial translocation).
* **Leaflet height reduction:** Partially detach leaflet, excise curvilinear crescent-shaped portion, reattach with running monofilament. Also used on anterior leaflet (prevents/treats SAM).
* **Butterfly technique:** Two mirror-image triangular resections, reapproximate free edges. Avoids annular plication, allows larger ring.
* **Haircut technique (nonresectional):** Trim prolapsed P2 to height of adjacent segments. Close P1-P2 and P2-P3 clefts. Reattach salvaged chords or place neochords. Useful for annular calcification or diminutive P1/P3.
* **Simplified nonresectional leaflet remodeling (modified McGoon):** Invert free edge of prolapsed segment into LV (triangular imbrication), approximate leaflet folds on each side. Preserves annular continuity.
* **Posterior ventricular anchoring neochordoplasty (PVAN):** Modification of nonresectional remodeling. Anchor inverted segment to ventricular wall with PTFE suture (3-4 mm deep, loose tie). Same suture reapproximates leaflet folds. Reduces SAM risk.

### Correcting Anterior Leaflet Prolapse
* **Incidence:** <15% of degenerative MR cases. Often only posterior leaflet intervention needed even in bileaflet prolapse.
* **Limited triangular resection:** ≤10% of leaflet surface area (more extensive resection reduces coaptation area and durability).
* **Chordal transposition:** Resect 2-3 mm wide strip of adjacent normal posterior leaflet with attached intact chordae. Secure to anterior leaflet, repair posterior defect. Advantage: no neochord measurements.
* **Neochordae placement (challenging):**
  * **Loop technique:** Measure distance from normal apposition plane to papillary muscle head with calipers. Create PTFE loop over calipers, tie knot over pledget, pass needles through pledget twice (locks distance). Pass through papillary muscle, tie over pledget. Second PTFE suture attaches loop to leaflet (knot toward ventricle).
  * **Freehand technique:** Pass PTFE suture through papillary muscle and prolapsed leaflet edge. Clamp and set aside. Implant annuloplasty ring. Pressurize LV with saline, tie PTFE suture at level of optimal coaptation. Faster but requires accurate length judgment.
* **Alfieri stitch (double-orifice edge-to-edge):** Figure-of-eight polypropylene stitch tying prolapsing segment to opposite leaflet. Deeper stitch for redundant tissue. Reinforce with pericardium or pledgets if thin/frail. Require ≥2.5 cm² total valve area (measure with Hegar dilators).

### Correcting Commissural Prolapse
* **Simple obliteration:** Running polypropylene suture inverting prolapsed segment.
* **Triangular resection:** For limited prolapse (≤5 mm of commissural edge).
* **Quadrangular resection + sliding plasty:** For larger prolapse. Restore neocommissure coaptation with inverting sutures.
* **Papillary muscle rupture:** Excise necrotic tissue (leave fibrous head). Retract head caudally to restore leaflet height, mark point. 8-10 mm incision in ventricular wall (≤5 mm depth, avoid coronaries). Anchor head with buried horizontal mattress 4-0 monofilament sutures.
* **Papillary muscle elongation:** Longitudinal incision, slide elongated segment downward, secure with interrupted monofilament sutures (distance slid = prolapse distance). Or wedge resection of papillary muscle. Or anchor elongated muscle to adjacent normal papillary muscle.

### Addressing Annular Calcification
* **Débridement:** Calcified tissue usually encased in fibrotic capsule → en bloc resection. May selectively débride with pituitary rongeurs to provide leaflet mobility without reconstruction.
* **David technique (bovine pericardium):** 2-cm wide semicircular patch for posterior reconstruction. Running 3-0 polypropylene sutures LV endocardium to one side, other side to LA wall. Suture detached leaflet to patch at annulus level.
* **Carpentier technique (figure-of-eight mattress sutures):** Minimizes foreign material. Braided 2-0 suture passes: atrial edge → ventricular edge (1/3 ventricular thickness) → after ~1 cm travel, again through ventricular edge → back through atrial edge (free ends on atrial side). Assistant pulls atrial edge downward when tightening. Same sutures used for annuloplasty ring. 4-0 polyester running suture reinforces neoatrioventricular junction. Leaflets reattached to neoannulus with running 4-0 polypropylene. Push ring downward when tying (don't pull sutures upward).

### Evaluating the Repair
* **Timing:** After leaflet repair/neochord placement (before ring), after ring placement (before tying), after completion (before weaning).
* **Saline test:** Fill LV with saline (aortic root vent unclamped), clamp vent, inject pressurized saline. Valve should prevent retrograde leak. Symmetric coaptation line parallel to posterior ring, safe distance from LVOT.
* **Ink test:** Trace coaptation line with marking pen during saline test. Ideal coaptation depth 4-10 mm. <4 mm → further correction (resect restrictive chordae, downsize ring, cleft closure). >10 mm → increased SAM risk → reduce posterior leaflet height.
* **TEE:** Final test after separation from CPB (prior to decannulation).

### Postoperative Care
* **Atrial fibrillation:** Common (prophylaxis important).
* **SAM management:** Occurs in up to 10% of repairs. Caused by redundant posterior leaflet (shifts coaptation anteriorly), inadequate height reduction, or undersized ring. Most mild/moderate cases resolve spontaneously (weeks to months). Conservative management: maintain preload (volume resuscitation), increase afterload (alpha agonists), reduce heart rate (beta blockade or lower pacemaker rate), minimize inotropes. If conservative fails → re-repair (replacement rarely indicated).

### Pearls and Pitfalls
* **Most important step:** Careful valve evaluation to determine precise lesion (guides all decisions).
* **Exposure maneuvers:** After pericardiotomy, suture pericardium to right side of skin incision (rotates heart, optimizes exposure). Leftward traction on caval snares also rotates heart.
* **Annuloplasty sutures:** Start with 6 o'clock suture (use for traction).
* **Proper ring sizing** critical (overly restrictive → SAM or iatrogenic MS).
* **De-airing:** Turn off LV vent early during left heart closure while perfusionist adds blood to circulation.
...
The mitral valve is naturally bicuspid, with a larger, semicircular anterior (aortic) leaflet and a smaller, quadrangular posterior (mural) leaflet (see [Fig. 18.1C](#fig-18-1)).
...
## Step 3. Operative Conduct</summary><div class="details-content">

<details class="med-details"><summary>

### 1. Surgical Approach</summary><div class="details-content">

The mitral valve is conventionally accessed through a median sternotomy ([Fig. 18.2A](#fig-18-2)). The median sternotomy provides excellent exposure to all structures of the heart and is favored for patients in whom multiple valves or concomitant surgeries (e.g., coronary bypass, aortic valve replacement) are planned with mitral valve repair. In this approach, standard central aortic and bicaval cannulation are preferred. Exposure of the mitral valve can be accomplished through several alternative approaches, as discussed in detail in the following.

![](_page_7_Picture_2.jpeg)

<span id="fig-18-2"></span>**Figure 18.2** (A) Median sternotomy. (B) Partial upper sternotomy. (C) Partial lower sternotomy. (D) Right anterolateral minithoracotomy. (E) Intraoperative photograph of minimally invasive approach via right anterolateral minithoracotomy; note the use of smaller skin incisions for the placement of an endoscope, suction ports, cross-clamp, and retraction sutures. (E from Goldstone AB, Woo YJ. Minimally invasive surgical treatment of valvular heart disease. *Semin Thorac Cardiovasc Surg*. 2014;26:37.)

A partial upper or lower sternotomy, or hemisternotomy, also permits access to the mitral valve ([Fig. 18.2B, C](#fig-18-2)). Whereas the lower hemisternotomy reduces the size of the skin incision and extent of sternal separation, the xiphisternal fascia must still be incised and is the area most prone to wound infection.

Our preferred minimally invasive approach is via a right anterolateral minithoracotomy (see [Fig. 18.2D, E](#fig-18-2)). This approach provides an excellent en face view of the mitral valve and spares dissection of the xiphisternal fascia. In patients who have undergone prior cardiac surgery, particularly aortic valve replacement, this minimally invasive approach can be particularly useful in not only avoiding a redo sternotomy, but also in visualizing the mitral valve when a previously placed aortic valve prosthesis prevents excessive manipulation of tissue.
...
### 2. Initiating Cardiopulmonary Bypass</summary><div class="details-content">
...
### 3. Exposing and Examining the Mitral Valve</summary><div class="details-content">
...
The most common approach to the mitral valve is the interatrial approach through Sondergaard's groove, also known as *rolling the groove* ([Fig. 18.3A](#fig-18-3)). In this approach, the right and left atrial surfaces are carefully separated by dissecting through the fatty tissue anterior to the right superior and inferior pulmonary veins. It is important to start this incision on the left atrial body to avoid accidental injury to the pulmonary venous ostia. Carrying this incision too medially may result in an inadvertent right atriotomy. If encountered, caval tapes or vacuum-assisted venous return can help manage this issue.

The right atrial transseptal approach is another common method to expose the mitral valve (see [Fig. 18.3B](#fig-18-3)). Bicaval cannulation with caval snaring helps obtain a bloodless field. A right atriotomy is made and extended posteriorly toward the left atrium. Atrial retractors or silk stay sutures can facilitate exposure of the septum. The fossa ovalis is identified, and an incision is made posteriorly to the patient's right, being careful to leave enough septal tissue to close the incision at the conclusion of the case. This incision is carried inferiorly to the end of the fossa ovalis and superiorly to the muscular tissue, near the superior vena cava inlet. The interatrial septum is then retracted anteriorly to provide optimal visualization of the mitral valve. This approach is useful in patients who have previously undergone aortic valve replacement because exposure of the AC can otherwise be challenging. It also minimizes external suture lines and speeds de-airing when concomitant tricuspid valve interventions are planned.

Several less conventional approaches to exposing the mitral valve exist, although these are used uncommonly and typically only in specific clinical scenarios. The left atrial dome approach, wherein the roof of the left atrium between the aorta and superior vena cava is incised, provides an excellent direct view of the mitral valve; however, the incision itself is quite small and leaves limited working room (see [Fig. 18.3C](#fig-18-3)). Additionally, extreme care must be taken in closing this incision because controlling bleeding in this area is quite challenging after the patient has been weaned from cardiopulmonary bypass. This approach can be combined with the transseptal approach in an expanded transseptal/left atrial dome approach to maximize mitral valve exposure if necessary. In the case of a left ventricular aneurysm repair, the mitral valve can be approached in a transventricular manner; an off-pump coronary stabilizer is helpful in adequately exposing the mitral valve in this situation (see [Fig. 18.3D](#fig-18-3)). A transaortic approach can also be used in cases of aortomitral endocarditis (see [Fig. 18.3D](#fig-18-3)).
...
<span id="fig-18-3"></span>**Figure 18.3** (A) Exposure through Sondergaard's groove. (B) Transseptal approach for mitral valve exposure. (C) Exposure of the mitral valve through the dome of the left atrium. (D) Transaortic approach in the case of infective endocarditis.
...
### 4. Remodeling Ring Annuloplasty</summary><div class="details-content">
...
Annuloplasty sutures are placed circumferentially around the annulus. The needle should enter and exit the tissue just outside the atriovalvular junction, passing through the annulus. The curve of the needle should be followed, which will generate appropriately sized bites of approximately 10 mm ([Fig. 18.4A](#fig-18-4)). The space between separate sutures should be approximately 2 mm. Care must be taken not to injure surrounding tissue inadvertently. When placing annuloplasty sutures in the anterior annulus, one must be careful to avoid catching the noncoronary cusp of the aortic valve. The circumflex coronary artery can be injured if sutures are placed too deeply near the AC and toward the posterior annulus (see [Fig. 18.4B](#fig-18-4)).
...
Ring sizing is based on intercommissural distance and the surface area of the anterior mitral leaflet (see [Fig. 18.4C](#fig-18-4)). With this in mind, if the free edge of the anterior leaflet extends 2 to 4 mm beyond the inferior aspect of the annuloplasty ring sizer, the surgeon should choose a ring that is one size larger to prevent the risk of SAM of the mitral valve.

When passing sutures through the annuloplasty ring, equal suture distances should be taken along the anterior aspect of the ring because the anterior annulus seldom dilates. However, less travel on the posterior aspect of the annuloplasty ring should be taken to correct posterior annular dilation (see [Fig. 18.4D](#fig-18-4)). Take note of the markings on the annuloplasty ring; the commissures are typically marked to assist you in spacing sutures properly. Count the number of sutures that must be placed through the anterior and posterior portions of the ring and space them accordingly. When placing sutures through the annuloplasty ring, only pass the needle through the designated sewing band and not through the metal skeleton.

![](_page_16_Picture_2.jpeg)

<span id="fig-18-4"></span>**Figure 18.4** (A) Placement of annuloplasty sutures. (B) Pertinent surgical anatomy. Note proximity of aortic valve leaflets and circumflex coronary artery. (C) Appropriate sizing of annuloplasty ring. (D) More travel is required posteriorly to correct posterior annular dilation.

</div></details>

<details class="med-details"><summary>

### 5. Correcting Posterior Leaflet Prolapse</summary><div class="details-content">
...
<span id="fig-18-11"></span>**Figure 18.11** Posterior ventricular anchoring neochordoplasty (PVAN) technique.

</div></details>

<details class="med-details"><summary>

### 6. Correcting Anterior Leaflet Prolapse</summary><div class="details-content">

In degenerative mitral valve disease, pathology of the anterior mitral leaflet is far less common than that of the posterior leaflet, accounting for fewer than 15% of cases. Even in cases of bileaflet prolapse, often only posterior leaflet intervention is required for a satisfactory repair. Despite this, there are circumstances that require repair of the anterior mitral leaflet, and the following sections describe techniques commonly used in this setting. We prefer to preserve as much leaflet tissue as possible by using chordal techniques on the anterior leaflet. Of note, most of the following techniques can also be used on the posterior leaflet and can be especially helpful in cases with insufficient leaflet tissue.

In the rare case of a billowing and redundant anterior leaflet, a very limited triangular resection can be considered, as described earlier. We prefer to limit resections of the anterior leaflet to no greater than 10% of the total leaflet surface area. More extensive resections reduce the area of coaptation and decrease the durability of valve repair.

If anterior leaflet prolapse is present, and an area of adjacent, normal posterior leaflet tissue with intact chordae of appropriate length is available, a chordal transposition can be performed ([Fig. 18.12](#fig-18-12)). A 2- to 3-mm-wide strip of adjacent normal posterior leaflet with the attached chordae is resected free from the posterior leaflet, careful to keep the attached chordae intact. With polypropylene sutures, the segment of posterior leaflet is secured to the anterior leaflet, thereby transferring functional chordae to the anterior leaflet. The posterior leaflet defect is repaired with polypropylene sutures. There is no need for neochord measurements and adjustments, which is the primary advantage of chordal transposition. However, this technique requires that a normal segment of posterior leaflet be sacrificed.
...
<span id="fig-18-12"></span>**Figure 18.12** Chordal transposition.

![](_page_38_Picture_4.jpeg)

<span id="fig-18-13"></span>**Figure 18.13** Neochord placement.

The double orifice edge-to-edge repair, also known as the *Alfieri stitch*, is a technique that can be used to repair anterior, posterior, or bileaflet prolapse ([Fig. 18.14](#fig-18-14)). In this technique, using a figure-of-eight polypropylene stitch, the prolapsing segment of leaflet is tied to its opposite leaflet segment. This creates a double-orifice mitral valve. The position of this stitch varies, depending on the amount of redundant leaflet tissue; a valve with an excess of tissue will require a deeper stitch to prevent SAM. If leaflet tissue is thin and frail, reinforcing the stitch with autologous pericardium or pledgets may be required. To prevent iatrogenic mitral stenosis, at least 2.5 cm² of total valve area is required, which can be measured with Hegar dilators.

![](_page_41_Picture_2.jpeg)

<span id="fig-18-14"></span>**Figure 18.14** Alfieri stitch—double orifice edge-to-edge repair.

</div></details>

<details class="med-details"><summary>

### 7. Correcting Commissural Prolapse</summary><div class="details-content">

Commissural prolapse can be repaired with or without resection. The simplest method to correct commissural prolapse is to obliterate the commissure with a running polypropylene suture, inverting the prolapsed segment of leaflet ([Fig. 18.15A](#fig-18-15)). Alternatively, triangular resection can be performed if the amount of prolapse is limited, involving 5 mm or less of the commissural edge (see [Fig. 18.15B](#fig-18-15)). If a more substantial area of prolapse exists, a quadrangular resection with sliding plasty of the adjacent paracommissural segments is performed (see [Fig. 18.15C](#fig-18-15)). It is helpful to restore the neocommissure's area of coaptation with inverting sutures.
...
<span id="fig-18-17"></span>**Figure 18.17** (A) Saline test. (B) Ink test.
...
Careful attention should be paid to the possibility of the patient developing SAM of the mitral valve, which is a complication of mitral valve repair occurring in up to 10% of patients. SAM is most often caused when a redundant posterior leaflet shifts the plane of leaflet coaptation anteriorly, which then displaces the anterior leaflet into the left ventricular outflow tract, resulting in obstruction and late systolic mitral regurgitation.
...
Most cases of postrepair SAM, when mild or moderate, can be managed conservatively. They generally resolve in the weeks to months following repair when ventriculoaortic gradients normalize, and left ventricular outflow tract remodeling occurs.
