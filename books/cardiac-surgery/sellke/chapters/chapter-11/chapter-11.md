...
### Definition and Importance of Patient‑Prosthesis Mismatch (PPM)
- **PPM definition (Rahimtoola):** Effective prosthetic valve area after insertion is less than that of a normal human valve.
- **Indexed EOA <0.85 cm²/m² (Pibarot/Dumesnil):** Associated with worse hemodynamics, reduced LV mass regression, lower survival.
- **Options when PPM anticipated:** Choose prosthesis with larger EOA (stentless bioprosthesis, new‑generation mechanical, homograft) OR surgically enlarge aortic root to accommodate larger prosthesis.

### Preoperative Considerations
- Evaluate coronary anatomy (anomalous origins, first septal branch if Ross‑Konno planned). Measure aortic annulus on echo to identify need for enlargement. Assess LV hypertrophy, function, subaortic stenosis, concomitant aortic dilation, mitral valve structure, pulmonary valve (for Ross). Adult congenital patients may need CT/MRI for arch anomalies.

### Surgical Anatomy
- Aortic root: annulus, cusps, sinuses, sinotubular junction. Interleaflet triangles are flexible – used for posterior enlargement.
- Commissure right‑left coronary: across from pulmonary artery. Right‑noncoronary commissure: anterior, near conduction system. Left‑noncoronary commissure: opposite middle of anterior mitral leaflet.
- True aortoventricular junction lies between commissure tops (above annulus) and leaflet coaptation (below annulus).
- First septal branch of LAD lies behind posterior pulmonary leaflet – preserve during Ross‑Konno.

### Operative Techniques

#### Left Ventricular Outflow Tract Exposure
- Complete aortic transection 1 cm above sinotubular junction, or spiraling incision into noncoronary sinus.

#### Posterior Enlargement
- **Nicks‑Nunez:** Vertical incision through left‑noncoronary commissure into interleaflet triangle (enlarges 2‑3 mm). Can extend into anterior mitral leaflet and left atrial roof.
- **Rittenhouse‑Manouguian:** Vertical incision through mid noncoronary sinus, across annulus into anterior mitral leaflet and left atrial roof. Can extend almost to free edge of leaflet.
- **Patch reconstruction (both):** Diamond‑shaped patch (autologous pericardium, Dacron, PTFE). Interrupted pledgeted sutures at annulus (interleaflet triangle lacks strength); interrupted non‑pledgeted sutures in mitral leaflet. Second patch may close left atrial defect. Patch incorporated into aortotomy closure ([Fig. 11.7](#fig-11-7)–[Fig. 11.12](#fig-11-12)).

#### Anterior Enlargement (Konno‑Rastan Aortoventriculoplasty)
- Incision into right coronary sinus left of RCA, through annulus near right‑left commissure, into ventricular septum (avoid deep injury to first septal branch). Matching incision on RV free wall ([Fig. 11.13](#fig-11-13)).
- Diamond patch in septum (continuous sutures) ([Fig. 11.14](#fig-11-14)). Second triangular patch for RVOT; base attached at annulus with pledgeted sutures passed through prosthetic valve ([Fig. 11.15](#fig-11-15)). RV patch folded over defect ([Fig. 11.16](#fig-11-16)).

#### Aortic Allograft – Full Root with Anterior Mitral Leaflet
- Allograft includes intact anterior mitral leaflet and rim of left atrium. Remove chordae. Enlarge posteriorly with Nicks or Manouguian incision into patient’s anterior leaflet ([Fig. 11.17](#fig-11-17)).
- Insert allograft leaflet into defect with interrupted sutures ([Fig. 11.18](#fig-11-18), [Fig. 11.19](#fig-11-19)). Attach allograft to LVOT with interrupted sutures + biologic glue. Reconstruct left atrial defect if needed ([Fig. 11.20](#fig-11-20)). Reimplant coronaries, anastomose allograft to ascending aorta.

#### Ross‑Konno Reconstruction (young patients with severe LVOT hypoplasia)
- Excise aortic valve, mobilize coronaries on buttons. Harvest pulmonary autograft with generous RV free wall, protecting first septal branch.
- Vertical incision through aortic annulus near right‑left commissure into septum ([Fig. 11.21](#fig-11-21)). Insert RV muscle portion of autograft deep into LVOT, suture to septal defect ([Fig. 11.22](#fig-11-22)). Attach autograft to aortic annulus.
- Reimplant coronaries, anastomose autograft to ascending aorta. Reconstruct RVOT with pulmonary homograft; augment with pericardium if needed.

### Other Considerations

#### Two‑Directional Enlargement
- Combine posterior (Nicks/Manouguian) then anterior enlargement to left‑right commissure. Annulus enlarged by ~68%. Use bifurcated Dacron patch ([Fig. 11.23](#fig-11-23)).

#### Myectomy/Myotomy for Subaortic Stenosis
- Exposure via aortotomy or complete transection. Incision from midventricle to within 8‑10 mm of right coronary nadir ([Fig. 11.24](#fig-11-24)). Second incision parallel to left‑right commissure. Resect wedge of septum. Avoid membranous septum and conduction tissue (more rightward than nadir of right cusp).

#### Bentall‑Type Upsizing for Small Annulus with Root Replacement
- Consider modified Bentall techniques.

### Postoperative Care
- LV hypertrophy → sensitive to preload; small fluid changes alter filling pressures. Avoid hypertension (strain on suture lines). IABP preferable to high inotropes/aggressive fluids.
- High suspicion for coronary insufficiency: inability to wean from CPB, TEE evidence. For simple AVR – remove and re‑implant prosthesis. For root replacement – bypass affected coronary.

### Pearls and Pitfalls
- Keep indexed EOA >1.0 to avoid PPM. Biologic glue seals needle holes but not gaps – helps identify bleeding sites. Preserve first septal branch (LAD) during autograft harvest. Avoid conduction system injury (area below right‑noncoronary commissure). Do not force rigid valve into small annulus (heart block). Plan for future reoperation – choose prosthesis wisely. Address all aortic pathology at initial operation.

</div></details>

<details class="med-details"><summary>

## Step 1. Preoperative Considerations</summary><div class="details-content">
...
## Step 2. Surgical Anatomy</summary><div class="details-content">
...
**Figure 11.1** Fibrous continuity between aortic valve and anterior mitral leaflet.

<span id="fig-11-2"></span>![](_page_3_Picture_4.jpeg)

**Figure 11.2** Interleaflet triangles.

<span id="fig-11-3"></span>![](_page_3_Picture_4.jpeg)

**Figure 11.3** Relationship of commissures and leaflet coaptation to true aortic annulus.

<span id="fig-11-4"></span>![](_page_3_Picture_4.jpeg)

**Figure 11.4** First septal branch of LAD behind posterior pulmonary leaflet.
...
### 1. Left Ventricular Outflow Tract Exposure</summary><div class="details-content">
...
### 2. Root Enlargement</summary><div class="details-content">
...
**Figure 11.5** Posterior enlargement incisions (Nicks and Manouguian).

<span id="fig-11-6"></span>![](_page_5_Picture_4.jpeg)

**Figure 11.6** Konno-Rastan aortoventriculoplasty.

</div></details>

<details class="med-details"><summary>

### 3. Root Reconstruction</summary><div class="details-content">

<details class="med-details"><summary>

#### Nicks-Nunez Technique, Patch Reconstruction</summary><div class="details-content">
...
- ◆ The patch is then tailored for closure of the aortotomy if a spiraled incision has been used, or it is transected flat at the level of the transverse aortotomy and incorporated as part of the reanastomosis of the aortic root to the ascending aorta ([Fig. 11.8](#fig-11-8)).

<span id="fig-11-7"></span>![](_page_7_Picture_2.jpeg)

**Figure 11.7** Patch reconstruction in Nicks procedure – pledgeted sutures at annulus.

<span id="fig-11-8"></span>![](_page_7_Picture_2.jpeg)

**Figure 11.8** Patch incorporated into aortotomy closure.
...
**Figure 11.9** Repair of anterior mitral leaflet defect with patch, interrupted non‑pledgeted sutures.

<span id="fig-11-10"></span>![](_page_9_Picture_4.jpeg)

**Figure 11.10** Second patch for left atrial defect.

</div></details>

<details class="med-details"><summary>

#### Rittenhouse-Manouguian Technique, Patch Reconstruction</summary><div class="details-content">
...
**Figure 11.11** Patch in anterior mitral leaflet (Manouguian).

- ◆ At the level of the aortic annulus, interrupted sutures with pledgets are placed and passed, first through the patch and then through the prosthetic valve ([Fig. 11.12A](#fig-11-12)). The remainder of the valve sutures are placed through the aortic annulus in standard fashion (see [Fig. 11.12B](#fig-11-12)). If the left atrial wall is flexible, and the defect is small, it can be approximated directly to the patch. Otherwise, a second patch is fashioned to reconstruct the left atrial defect (see [Fig. 11.12C](#fig-11-12)).
...
**Figure 11.12** (A) Pledgeted sutures through patch and valve ring. (B) Standard annular sutures. (C) Second patch for left atrial defect.

</div></details>

<details class="med-details"><summary>

#### Konno-Rastan Aortoventriculoplasty</summary><div class="details-content">
...
- ◆ A diamond-shaped patch of prosthetic material is fashioned and placed deep into the interventricular septal incision. Continuous sutures are used to attach the patch to the ventricular muscle, up to the level of the aortic annulus ([Fig. 11.14](#fig-11-14)).

<span id="fig-11-13"></span>![](_page_11_Picture_4.jpeg)

**Figure 11.13** Konno-Rastan incisions: aortic annulus into septum and RV free wall.

<span id="fig-11-14"></span>![](_page_11_Picture_6.jpeg)

**Figure 11.14** Diamond patch in septum (continuous sutures).
...
**Figure 11.15** Triangular RVOT patch attached at annulus, sutures passed through valve ring.

<span id="fig-11-16"></span>![](_page_13_Picture_3.jpeg)

**Figure 11.16** Completed Konno-Rastan reconstruction.

</div></details>

<details class="med-details"><summary>

#### Aortic Allograft—Full Root Technique With Anterior Leaflet of the Mitral Valve</summary><div class="details-content">
...
**Figure 11.18** Insertion of allograft anterior leaflet into patient’s leaflet defect.

<span id="fig-11-19"></span>![](_page_15_Picture_3.jpeg)

**Figure 11.19** Allograft leaflet sutured in place.

<span id="fig-11-20"></span>![](_page_15_Picture_4.jpeg)

**Figure 11.20** Reconstruction of left atrial defect.

</div></details>

<details class="med-details"><summary>

#### Ross-Konno Reconstruction</summary><div class="details-content">
...
**Figure 11.21** Incision into ventricular septum (Ross-Konno).

<span id="fig-11-22"></span>![](_page_17_Picture_5.jpeg)

**Figure 11.22** (A) Autograft RV muscle inserted into LVOT. (B) Sutured to septal defect.
...
## Step 4. Other Considerations</summary><div class="details-content">

<details class="med-details"><summary>

### 1. Two-Directional Enlargement</summary><div class="details-content">

- ◆ In patients for whom the conventional posterior root enlargement technique is not wide enough to implant a prosthetic valve of desired size, two-directional enlargement involving a combination of both posterior and anterior enlargement techniques could be used ([Fig. 11.23](#fig-11-23)). For this technique, the posterior enlargement is performed first, and then an additional aortotomy is made anteriorly and extended to the ventricular septum. The aortic annulus could be enlarged by 68% after this two-directional enlargement technique.
...
**Figure 11.23** Two-directional enlargement. (Otaki M, Oku H, Nakamoto S, et al. Two-directional aortic annular enlargement for aortic valve replacement in the small aortic annulus. *Ann Thorac Surg*. 1997;63:261–263.)

</div></details>

<details class="med-details"><summary>

### 2. Myectomy or Myotomy</summary><div class="details-content">
...
**Figure 11.24** Septal myectomy incisions. (Messmer BJ. Extended myectomy for hypertrophic obstructive cardiomyopathy. *Ann Thorac Surg*. 1994 Aug;58(2):575-7.)

</div></details>

<details class="med-details"><summary>

### 3. Bentall-Type Aortic Upsizing Procedures</summary><div class="details-content">
