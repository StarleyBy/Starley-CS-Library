...
*See Videos 5.1 to 5.10 on [ExpertConsult.com](http://expertconsult.com/).*
...
* **MICS CABG:** Minimally invasive cardiac surgery–coronary artery bypass grafting. Enables revascularization with similar configuration as sternotomy using LITA harvesting and hand-sewn anastomoses under direct visualization through small left thoracotomy. Complete revascularization in 95% of cases, accessing anterior, lateral, and inferior walls with or without pump assistance.

### Indications and Contraindications
* **Indications:** Follow current guidelines for coronary revascularization.
* **Contraindications:** Hemodynamic instability/acute ischemia; chest wall deformities/significant pleural adhesions; obesity; intolerance to single-lung ventilation; significant ascending aorta calcification (if proximal anastomoses planned); poor femoral vessels for peripheral CPB cannulation; inadequate distal target size/quality (RCA, proximal PIV, PL, proximal OM not easily accessible).

### Anesthesia and Positioning
* **Anesthesia:** Paravertebral block optional (facilitates immediate extubation). Single-lung ventilation via double-lumen tube or bronchial blocker. TEE guides wire/cannula placement if peripheral CPB used.
* **Positioning:** Semi–right lateral decubitus ([Fig. 5.1A](#fig-5-1)). Left arm in sling above head. Hips nearly supine for groin access and saphenous harvest. External defibrillator pads (right anterior chest, left back) – internal defibrillators do not fit. Sterile draping allowing easy sternotomy conversion ([Fig. 5.1B](#fig-5-1)).

### Incision and LITA Harvest
* **Incision:** 5 cm in 5th ICS at left midclavicular line (below nipple). Apex should be ~2 cm caudal to opening – tailoring based on procedure: too caudal helps distal anastomosis but restricts proximal aortic access and proximal LITA mobilization.
* **LITA harvest:** Full length from bifurcation to subclavian vein using ThoraTrak and Rultract retractors ([Fig. 5.2](#fig-5-2)). Headlights, long fine instruments, long cautery blades. Skeletonized or pedicled. Heparin: ACT 250–300 sec for OPCAB, 480 sec for CPB.

### Cardiopulmonary Bypass (Optional)
* Beating heart CPB-assisted MICS CABG to decompress heart or maintain stability. Peripheral cannulation via femoral vessels.

### Grafting Sequence
* **Preferred sequence:** All proximal anastomoses first, then distal grafting.

#### Proximal Anastomoses
* Expose aorta and bring toward surgical window ([Fig. 5.3A,B](#fig-5-3)):
  - Pericardial stitches, sponge to right of aorta (push left), CPAP on right lung, Octopus on PA to retract/depress it, patient on CPB if needed.
  - Target systolic BP 80–90 mm Hg.
  - Mobilize aorta-PA junction, place side-biting clamp ([Fig. 5.3C](#fig-5-3)).
  - Hand-sewn anastomosis similar to sternotomy but deep field and limited assistant help.
  - If aortic anastomosis not feasible: T-graft to LITA or left subclavian artery.
  - Ensure meticulous hemostasis – difficult to re-access later.

#### Distal Anastomoses
* **Sequence:** Posterior vessels first → lateral → anterior (individualize).
* **Heart positioning:** Starfish nonsternotomy positioner used armless – tape suspends suction tip, clipped to outside structures. Suspend toward left shoulder for posterior vessels, toward right hip for lateral vessels ([Fig. 5.4](#fig-5-4); Video 5.1).
* **Stabilization:** Octopus nonsternotomy stabilizer placed through small incision (6th or 7th ICS left anterior axillary line) using Seldinger technique with red rubber catheter to avoid cardiac injury. Place parallel to target vessel, rod anchored to OR table.
* **Hemodynamics:** Raise systolic BP to 140 mm Hg before manipulating heart; observe for stability after positioning.
* **Bleeding control:** Silastic proximal to planned arteriotomy. If ischemia, place coronary shunt and remove Silastic.
* **Anastomosis:** Similar to sternotomy ([Fig. 5.5](#fig-5-5)). Blow mister and occasional shunt facilitate exposure.
* **Patency check:** Transit time flow probe routinely.

### Closure
* Protamine for heparin reversal.
* Thoracic drain in Octopus incision, low suction.
* Optional intercostal bupivacaine and muscle blockade before closing ICS.
* Thoracotomy closure: one heavy suture, routine fascia and skin.

### Postoperative Considerations
* **Mortality:** Low, 1.3%.
* **Advantages:** Decreased blood transfusion, lower surgical site infection, earlier return to full physical function.
* **Pain:** Initial but transient, rapidly abates by POD3; improved overall pain and pulmonary function.
* **Patency:** Very good at short- and intermediate-term follow-up.
* **Conversion to sternotomy:** 3%.
* **Pleural effusion:** Left-sided common; maintain thoracic drain for 3 days.

### Pearls
* Communication between surgeon and anesthesiologist is key.
* First become facile with sternotomy OPCAB before MICS CABG.
...
### Abstract</summary><div class="details-content">
...
### Keywords</summary><div class="details-content">
...
### 2. Contraindications</summary><div class="details-content">
...
## Step 3. Operative Technique</summary><div class="details-content">

<details class="med-details"><summary>

### 1. Anesthesia</summary><div class="details-content">
...
### 2. Positioning</summary><div class="details-content">

- ◆ The patient is placed in a semi–right lateral decubitus position ([Fig. 5.1A](#fig-5-1)). The right arm may be tucked at the patient's side or extended to enable harvest of the right radial artery. The left arm is placed in a sling held above the patient's head.
...
- ◆ Prepare the skin and place the sterile drapes in such a way that the sternum is easily accessible in case sternotomy conversion is needed ([Fig. 5.1B](#fig-5-1)).
...
### 3. Incision</summary><div class="details-content">
...
- ◆ The LITA is harvested throughout its full length, from the bifurcation to the level of the subclavian vein. This is facilitated using ThoraTrak (Medtronic, Minneapolis) and Rultract (Rultract, Independence, OH) retractors ([Fig. 5.2](#fig-5-2)). Other necessary accessories are headlights, long fine instruments, and long cautery blades. The LITA may be harvested in a skeletonized or nonskeletonized fashion. Adequate hemostasis is ensured at all times.
...
**Figure 5.2** LITA harvest setup. (A, B) Cephalad traction on the retractor to harvest the midproximal LITA. (C) Caudal retraction on the retractor to harvest the distal LITA (patient's head is toward the right).

</div></details>

<details class="med-details"><summary>

### 4. Cardiopulmonary Bypass</summary><div class="details-content">
...
### 5. Grafting</summary><div class="details-content">
...
- ◆ The aorta is exposed and brought toward the surgical window ([Fig. 5.3A and B](#fig-5-3)):
...
- ◆ Mobilize the aorta-PA junction and place a side-biting clamp (see [Fig. 5.3C](#fig-5-3)).
...
**Figure 5.4** Distal anastomosis setup (with video). (A) Exposure of anterior wall vessels. (B) Left anterior descending (LAD) artery arteriotomy, with proximal Silastic control (patient's head is toward the right). (C) Exposure of lateral wall vessels. (D) Exposure of posterior wall vessels.
...
- ◆ Distal anastomoses are performed similar to what is done in routine sternotomy cases ([Fig. 5.5](#fig-5-5)). Exposure is facilitated by using a blow mister device and occasionally by the coronary shunt.
...
### 6. Closure</summary><div class="details-content">
...
## Step 4. Postoperative Considerations</summary><div class="details-content">

- ◆ Perioperative mortality is low, at 1.3%.
- ◆ Other advantages include decreased need for blood transfusion, lower surgical site infection rates, and earlier return to full physical function.
- ◆ Postoperative pain can be an issue initially after the procedure but it is transient and controllable. It rapidly abates by the third postoperative day and is associated with an overall improved postoperative pain picture, with improved pulmonary function.
- ◆ The anastomotic patency results have been validated to be very good up to short- and intermediate-term follow-up.
...
## Step 5. Pearls</summary><div class="details-content">
