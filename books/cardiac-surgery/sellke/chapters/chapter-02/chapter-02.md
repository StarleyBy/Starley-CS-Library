...
* **Ascending aorta:** Cannulate as high as safely possible, using pericardial reflection just below innominate vein as landmark (exposes ~1 cm area). Insert cannula with flow direction away from arch vessels. Use two 2-0 braided purse-strings (8-10 mm diameter). Incision techniques: transmural with finger control, oblique flap, or partial-thickness (adventitia/media only, intima punctured by cannula).
* **Femoral artery:** Vertical incision over femoral pulse (slightly medial). Identify superficial femoral and profunda femoris arteries. Transverse arteriotomy. Control proximal and distal vessels. Secure cannula with proximal snare.
* **Axillary artery:** 5-8 cm transverse incision 2 cm below clavicle over deltopectoral groove. Identify cephalic vein, incise clavipectoral fascia, retract pectoralis minor. Axillary vein encircled and retracted cephalad. Use partial occluding clamp, anastomose 8 mm tube graft, insert cannula into graft (not into artery). Close stump with hemoclips and oversew.
* **Transapical cannulation:** For porcelain aorta or type A dissection. First obtain venous cannulation (right atrium) and vent (right superior pulmonary vein or pulmonary artery). Insert 14 F needle into apex, pass guidewire across aortic valve under TEE. Place wire-reinforced cannula over guidewire. Place pledgeted purse-strings after heart decompressed on bypass. Tie cannula to tourniquets and fix to skin.

### Venous Cannulation
* **Femoral vein:** Long double-stage cannula. Two 4-0 polypropylene purse-strings. Insert needle 3 mm from caudal apex, guidewire to SVC. Advance cannula over wire with TEE guidance to SVC.
* **Right atrial appendage:** Double-stage cannula directed posteriorly into IVC. For two single-stage cannulae: IVC through appendage, SVC purse string 1.5 cm posterior/caudal (crossing orientation). For bicaval cannulation in transplantation: place purse strings posterior without crossover.
* **Direct SVC cannulation:** Diamond purse string on anterior SVC above sinoatrial node, include azygos flow. Vertical venotomy, insert right-angled cannula twisted cephalad.

### Cardioplegia and Venting
* **Retrograde coronary sinus cannulation:** 4-0 purse string on right atrial wall caudal to IVC cannulation, 1 cm from AV junction at acute margin of RV. Rotate cannula tip to abut atrial septum medial to IVC, curl toward left shoulder. Confirm by palpation, pressure tracing, or TEE.
* **Right superior pulmonary vein venting:** 4-0 purse string on vein with medial suture into left atrium. Create "question mark" curve on cannula. Advance through mitral valve into left ventricle (guide by hand behind heart in oblique sinus).

### Percutaneous ECMO Cannulation
* **VV ECMO (femoral-jugular):** Puncture femoral vein, guidewire to RA-IVC junction. Dilate, place cannula. For double-lumen catheter (right jugular): guidewire to IVC, position upper and lower drainage holes in SVC and IVC, return port in mid-RA directed at tricuspid valve. Requires TEE and fluoroscopy.
* **VA ECMO (femoral-femoral):** Venous cannulation as above. Arterial cannulation via Seldinger technique in common femoral artery (15 F or 17 F). Place antegrade catheter in superficial femoral artery or retrograde catheter in posterior tibial artery for distal limb perfusion.

### Pearls and Pitfalls
* Choose cannulation sites that allow repair of complications (e.g., ascending aortic site amenable to partial occluding clamp).
* Always direct IVC cannula posteriorly and advance slowly – anterior misplacement may perforate coronary sinus (lethal).
* When encircling SVC, divide tissue overlying right pulmonary artery between aorta and SVC. Avoid damage to azygos vein.
* Place retrograde cannula after restricting venous return to fill right atrium – facilitates palpation or TEE guidance.
* Use epiaortic scanning liberally for aortic plaque detection; mobile plaque is most concerning – consider "no-touch aorta" off-pump approach.
...
### 1. Arterial Cannulation</summary><div class="details-content">
...
### 2. Venous Cannulation</summary><div class="details-content">

<details class="med-details"><summary>

#### Femoral Vein Cannulation</summary><div class="details-content">
...
#### Right Atrial Cannulation</summary><div class="details-content">
...
If necessary, snares can be placed around the SVC and IVC after gentle circumferential dissection. We do not routinely snare for mitral valve surgery.
...
### 3. Cardioplegia Cannulation and Venting</summary><div class="details-content">
...
### 4. Percutaneous Cannula Placement</summary><div class="details-content">

<details class="med-details"><summary>

#### Venous-Venous Extracorporeal Membrane Oxygenation</summary><div class="details-content">
...
#### Venous-Arterial Extracorporeal Membrane Oxygenation</summary><div class="details-content">
