...
* **OPCAB definition:** Coronary revascularization without cardiopulmonary bypass. Requires steep learning curve but offers benefits: reduced blood transfusion, lower postoperative bleeding, less renal and respiratory failure, and lower stroke risk with aorta no-touch technique. (2012: only 17% of CABG performed off-pump)
* **Key pitfalls:** Higher incomplete revascularization and lower graft patency in early trials – surgeon must not compromise quality. Conversion to on-pump should be elective, not emergency.

### Indications and Contraindications
* **Favor OPCAB:** Aortic calcification (porcelain aorta), patients declining transfusions (Jehovah's Witnesses), borderline kidney/respiratory dysfunction.
* **Favor on-pump:** Severe LV dysfunction, ongoing ischemia, pulmonary hypertension, valvular heart disease.

### Conduit Selection for OPCAB
* **LITA to LAD:** Standard of care. Skeletonized harvest reduces pleural effusions and sternal devascularization (especially for BITA).
* **Arterial grafts (radial, gastroepiploic):** Require high-grade stenosis (>80%) due to competitive flow. Internal thoracic arteries tolerate 60-80% stenosis.
* **Composite grafts (Y/T):** LITA with radial artery provides similar benefits to BITA, preferable in diabetics (lower sternal wound risk). Allows aortic no-touch and multiple anastomoses.

### Tools and Teamwork
* **Positioning devices:** Suction-based (silicone cup, 100-250 mm Hg) to enucleate heart without avulsion – never pull under suction.
* **Stabilization devices:** Suction-based forks with silicone cups. Prongs bent convex for anterior/lateral walls, straight for inferior wall and distal RCA.
* **Blower/Mister:** CO₂ + pH-balanced saline mist clears blood from anastomosis, CO₂ rapidly resorbed – no air embolism.
* **Pacing wires (atrial/ventricular):** Manage heart block or bradycardia during positioning.

### Pericardial Preparation and Heart Positioning
* **Inverted-T pericardiotomy:** Extend to cardiac apex left side, to pericardial reflection right side ([Fig. 4.1](#fig-4-1)).
* **ITA pericardial trench:** Incision at left appendage base (LITA) or transverse sinus (RITA), directed posteriorly, 1 cm anterior to phrenic nerve, then 2 cm superior/inferior (T-inverted).
* **Lima stitches (3):** (1) anterior to LSPV below phrenic nerve, (2) anterior to LIPV inferior to phrenic nerve, (3) medial IVC. Rummel tourniquets – sequential tension lifts heart without hemodynamic compromise ([Fig. 4.3](#fig-4-3)).
* **Deep stitch–sling technique:** Single suture in oblique sinus medial to right inferior pulmonary vein. 4×8 inch gauze passed through loop, Rummel tourniquet. Pulling inferiorly creates pericardial ridge; gauze arms rotate/lift heart ([Fig. 4.4](#fig-4-4)).
* **Anterior wall exposure:** Traction on Lima stitches 1 and 2 – brings LAD and diagonals anterior/superior. Lap pads posteriorly also work.
* **Lateral wall exposure:** Release pericardial retention sutures, open right pleura if needed. Sling method: right gauze arm traction at midline, left arm toward assistant – exposes lateral wall ([Fig. 4.5](#fig-4-5)). Then suction positioner on right side cephalad, Trendelenburg, table rotation toward surgeon.
* **Inferior wall – distal RCA:** Trendelenburg, suction device on right side retractor cranially, rotate RV free wall.
* **Inferior wall – PDA/PLB:** Trendelenburg, sling arms traction toward patient's left, positioner adjacent to apex (three fingers on anterolateral surface, none on inferior wall), low suction ≤200 mm Hg ([Fig. 4.6](#fig-4-6)).

### Coronary Stabilization by Territory
* **Anterior/lateral wall stabilizer:** Right side retractor, midway. Prongs slightly bent inferiorly (convex) for optimal epicardial adherence ([Figs. 4.7](#fig-4-7), [4.8](#fig-4-8)).
* **Inferior wall (PDA/PLB):** Either side retractor, prongs straight facing down ([Fig. 4.9](#fig-4-9)).
* **Distal RCA:** Left side retractor, arm curves superiorly, prongs straight facing leftward ([Fig. 4.10](#fig-4-10)).

### Revascularization Sequence and Ischemia Prevention
* **Recommended sequence (most patients):** LAD first (least manipulation, largest myocardial protection), then inferior wall (PDA/PLB), then lateral wall (OMs). Exception: LAD feeds occluded collaterals – graft occluded vessels first.
* **Composite graft sequence:** LAD first, then RI, OMs, PLB, finally PDA – avoids intermittent graft clamping.
* **Intracoronary shunts:** Use for every anastomosis. Silicone-based, 1-3 mm. Long arm inserted proximally first, pinch shunt, bend, insert short arm distally ([Fig. 4.12](#fig-4-12)). Oversizing damages endothelium and impairs visualization.
* **Proximal control:** Silicone tape looped around artery, each arm through pledget – tension occludes with minimal trauma ([Fig. 4.11](#fig-4-11)). Release after shunt inserted.
* **Distal RCA shunting mandatory:** Prevents AV node ischemia and bradycardia – have ventricular pacing ready.

### Aortic Management and Inflow
* **Side-biting clamp safe if:** Aortic wall thickness <3 mm throughout clamp length and anastomotic site. Plaques >3 mm increase stroke risk ([Table 4.1](#table-4-1)). Use epiaortic scanning.
* **Heartstring device:** Minimal aortic manipulation for severely diseased aorta.
* **Aortic no-touch technique:** Composite grafting only.
* **Composite graft Y vs. T:** For high proximal branches (high diagonal, ramus, high marginal) – T approach (diamond shape anastomosis). For distal circumflex/RCA branches – Y or T depending on conduit length ([Fig. 4.2](#fig-4-2)).

### Postoperative Care
* Early extubation (some in OR). Less fluid and pressor requirements. Transfer to step-down by POD1.

### Pearls and Pitfalls
* Keep operating room warm (malignant arrhythmias if hypothermia).
* If hemodynamics deteriorate during positioning – return heart to pericardium, consult anesthesia, allow recovery.
* Never pull suction cup off epicardium under negative pressure – causes avulsion and bleeding.
* Common mistakes: insufficient pericardial opening, taut pericardium (take down lateral stay sutures), impaired RV filling (use sling + positioner + Trendelenburg), compressing heart with stabilizer (optimize filling first, do not push down).
* Emergency conversion to on-pump increases morbidity/mortality – avoid at all costs.

</div></details>

<details class="med-details"><summary>

## Step 1. Preoperative Assessment and Planning</summary><div class="details-content">
...
## Step 2. Conduit Assessment</summary><div class="details-content">
...
### 1. General Strategies, Tools, and Tactics</summary><div class="details-content">
...
### 2. Incision, Conduit Harvesting, and Pericardium Preparation</summary><div class="details-content">

- ◆ Most OPCAB procedures are performed through the standard median sternotomy.
- ◆ An extensive inverted-T pericardial incision is usually required. The opening should reach the cardiac apex on the left side and reach the pericardial reflection on the right side ([Fig. 4.1](#fig-4-1)). This allows heart positioning without any compressions or deformity.
...
### 3. Inflow Preparation</summary><div class="details-content">
...
#### Table 4.1 Katz classification (grading) of aortic atheroma</summary><div class="details-content">
...
### 4. Heart Positioning</summary><div class="details-content">
...
**Figure 4.3** Location of the three Lima stitches. (1) Anterior to the LSPV; (2) anterior to the LIPV; and (3) halfway between the IVC and LIPV.
...
#### Anterior Wall</summary><div class="details-content">
...
#### Lateral Wall</summary><div class="details-content">
...
#### Inferior Wall</summary><div class="details-content">
...
### 5. Coronary Stabilization</summary><div class="details-content">
...
- ◆ All coronary stabilizers have flexible prongs in a fork-shaped configuration. Each prong has four small silicone cups, connected to suction, that can be adjusted as necessary. This suctionbased stabilization allows OPCAB to be performed with less aggressive fluid administration, which decreases volume overload and reduces the need to open the right pleural cavity. Moreover, the malleable prong allows for different shapes to mold the irregularities of the heart wall.
...
#### Anterior and Lateral Wall Stabilization</summary><div class="details-content">

- ◆ The stabilizer is positioned on the right side of the chest retractor, usually midway on the retractor arm. The prongs are slightly bent inferiorly to create a convex shape. This allows for optimal adherence of the stabilizer to the epicardium ([Figs. 4.7](#fig-4-7) and [4.8](#fig-4-8)).
...
#### Inferior Wall Exposure (Posterior Descending Artery and Posterolateral Branches)</summary><div class="details-content">

- ◆ The stabilizer is placed on either side of the chest retractor, per surgeon preference. The prongs are left straight and facing down to optimize inferior wall coronary stabilization ([Fig. 4.9](#fig-4-9)).
...
#### Distal Right Coronary Artery</summary><div class="details-content">

- ◆ The stabilizer is usually placed on the left side. The arm makes a curve superiorly, and the prongs are kept straight and placed facing leftward ([Fig. 4.10](#fig-4-10)).

<span id="fig-4-10"></span>![](_page_23_Picture_2.jpeg)

**Figure 4.10** Coronary stabilizer positioning for the distal RCA. Note the use of positioning device to rotate the right ventricular (RV) free wall.
...
### 6. Prevention of Ischemia and Shunting</summary><div class="details-content">

- ◆ During OPCAB, the surgical team must pay extra attention to hemodynamics and myocardial ischemia. Maneuvers to avoid hemodynamic instability have been described previously. Prevention of myocardial ischemia requires careful planning of the sequence of target vessels to be revascularized and the use of ischemia prevention strategies, such as shunts.

<details class="med-details"><summary>

#### Sequence of Revascularization</summary><div class="details-content">
...
- ◆ It should be noted, however, that grafting the LAD territory first is not always the best approach; for example, when the LAD feeds occluded vessels through collaterals. In this situation, the choice to graft the LAD first may cause extensive ischemia during the coronary arteriotomy, and it is preferable to graft the occluded vessels before addressing the LAD.
...
#### Ischemia Prevention Strategies</summary><div class="details-content">
...
- ◆ There are different methods to occlude the coronary artery intermittently before the arteriotomy. We use silicone (Silastic) tapes looped around the coronary artery for blood flow control before opening and shunting the artery. Each arm of the silicone tape is passed through one pledget, which works as an outside occluder. Once the tape is put under tension, the pledget is pushed against and occludes the coronary artery, with minimal trauma ([Fig. 4.11](#fig-4-11)).
...
- ◆ Shunt insertion follows several principles. It is performed using two forceps, with the long arm inserted first, which allows more shunt mobilization during shunt bending. The long arm should be inserted proximally in most cases, which decreases the amount of blood in the anatomic field. After insertion of the long arm proximally, blood control is achieved by pinching the shunt with one forceps. Then the other forceps bend the shunt, and the short arm is inserted distally. Final adjustments may be required ([Fig. 4.12](#fig-4-12); Video 4.3)
...
- ◆ Patients who have an uneventful OPCAB are extubated shortly after arrival to the intensive care unit. Some centers even extubate patients in the operating room. Because of less inflammatory response and less blood loss, patients have a smoother postoperative course, with less fluid and pressor requirements.
...
- ◆ Common mistakes during heart positioning and coronary stabilization include the following:
  - ◆ *Not enough opening of the pericardium*. The inverted-T pericardiotomy should extend past the apex of the heart.
  - ◆ *Taut pericardium*. The lateral pericardial stay sutures that create the initial pericardial cradle should be taken down before manipulating the heart.
  - ◆ *Impaired right ventricular filling during lateral wall exposure*. Suction devices and deep pericardial sutures should be used to avoid distortion of the inflow of blood to the heart. Do not bend or squeeze the heart. To this effect, the Trendelenburg position and right lateral rotation are helpful maneuvers.
  - ◆ *Compressing the heart with the stabilizer*. This is more common when the heart is underfilled and may paradoxically increase the heart's mobility. Before applying any compression with a stabilization device, optimization of heart filling pressures should be achieved. Do not push down on the stabilizer; this will avoid impaired filling of the heart and hemodynamic collapse.
