...
* **Aortopulmonary Window (APW):** Congenital communication between the ascending aorta and pulmonary trunk with separate aortic and pulmonary valves. Also termed aortic septal defect, aortopulmonary fistula, or aorticopulmonary fenestration.
* **Classification (STS Congenital Heart Surgery Database):** Type I (proximal defect) — located just above sinutubular junction, little inferior rim. Type II (distal defect) — in uppermost ascending aorta, overlies RPA, well-formed inferior rim but little superior rim. Type III (total defect) — involves nearly entire ascending aorta. Type IV (intermediate defect) — adequate superior and inferior rims, most suitable for device closure.
* **Proximal Type (Type I):** Most common (~90%). Window in left lateral wall of ascending aorta close to left coronary ostium, and in contiguous right wall of pulmonary trunk inferior to RPA origin.

### Morphology and Associated Anomalies
* **Isolated APW:** Occurs in ~50% of cases. Defect usually large, single orifice (may be fenestrated). Pulmonary arteries normally related to pulmonary trunk.
* **Associated Anomalies (50% of cases):** Interrupted aortic arch (IAA) is most common major associated lesion. Other associations: VSD, tetralogy of Fallot, double outlet RV, TGA, anomalous coronary origin, aortic isthmic hypoplasia, subaortic stenosis.
* **Berry Syndrome:** Complex association of APW (usually distal), aortic origin of RPA, intact ventricular septum, PDA, and IAA or severe coarctation. Particularly lethal combination.

### Clinical Features
* **Presentation:** Early infancy with heart failure (tachypnea, poor feeding, failure to thrive, recurrent respiratory infections). Similar to large VSD.
* **Physical Exam:** Prominent left precordium (marked cardiomegaly), accentuated S2. Murmur usually systolic (variable intensity); continuous in ~15% (smaller APW, less pulmonary hypertension). Jerky/collapsing peripheral pulses (rapid aortic runoff) mimicking large PDA or AI when shunt large.
* **CXR/ECG:** Biventricular enlargement, increased pulmonary blood flow, prominent left atrial enlargement.
* **Echocardiography:** Diagnostic modality of choice since early 1990s. 2D echo with color Doppler definitive.
* **CT/MRI:** Useful for complex lesions, 3D reconstruction for surgical planning.

### Natural History
* **Rarity:** ~0.2% of congenital heart disease. No spontaneous closure.
* **Mortality without Surgery:** ~40% in first year of life. Large APWs rarely seen in childhood/adult life; survivors have important pulmonary vascular disease. Natural history similar to large VSD.

### Surgical Technique
* **Approach:** Median sternotomy, cardiopulmonary bypass (CPB). Hypothermic circulatory arrest for infants <2.5 kg.
* **Key Technical Points:** Aortic cannulation as far downstream as possible. Limited dissection between aorta and pulmonary trunk to avoid bleeding. Identify and protect RPA, coronary ostia.
* **Sandwich Technique (Current Preferred):** Vertical incision through anterior wall of APW. Patch (PTFE or glutaraldehyde-treated pericardium) sutured to posterior, superior, and inferior walls. Closure incorporates front edge of patch through aortic wall, patch, and pulmonary trunk wall. Provides secure partitioning and visualization of coronary ostia and RPA.
* **Type I Repair:** Through transverse or vertical aortotomy. Patch closure (direct suture only for small defects). Ensure both coronary ostia on aortic side.
* **Type II Repair:** Through aortotomy, patch extends out along RPA to avoid stenosis.
* **Special Situations:** Coronary artery arising from pulmonary trunk — flap reconstruction or reimplantation. IAA with APW — combined antegrade cerebral perfusion and lower body perfusion. Berry syndrome — RPA division and reattachment, aortic cuff technique, or intra-aortic baffle.

### Results
* **Hospital Mortality (Simple APW):** Very low in current era. Pooled data (182 patients): 2.2% (0.8-2.4% CL).
* **Hospital Mortality (APW with Associated Lesions):** Higher. Pooled data (137 patients): 13.1% (2.4-9.6% CL).
* **Time-Related Survival:** Excellent for infant repair. IAA+APW: 1-year survival 91%, 10-year survival 84% (CHSS data).
* **Reinterventions:** Low for isolated APW (freedom from reintervention 100% at 5-8 years in recent series). Higher for complex APW (freedom from cardiac reoperation at 10 years: 100% simple vs. 73% complex). IAA+APW: 51% require arch reintervention by 5 years.

### Indications for Operation
* **Infants:** Prompt operation when diagnosed. Elective repair advised before age 3 months.
* **Older Children:** Operate unless high pulmonary vascular resistance renders inoperable. Use same criteria as for VSD.
* **Transcatheter Closure:** Limited role; may be considered for small APW in older patients. No device specifically designed for APW.
...
Currently, the most common technique is by vertical incision made at the anterior wall of the APW itself, more or less transecting its anterior half (Fig. 41.4A). After carefully identifying orifices of the RPA and left coronary artery, the patch for closure is sutured to the posterior, superior, and inferior walls of the window (Fig. 41.4B). The incision at the site of the window is then closed by incorporating the front edge of the patch, with each stitch passing through the aortic wall, the patch, and the pulmonary trunk wall (Fig. 41.4C). This technique allows visualization of the left coronary ostium and orifice of the RPA and provides a secure partitioning of the ascending aorta from the pulmonary trunk. Unless there is aneurysmal thinning around the window, this technique seems useful. The most frequently used patches are 0.4 mm polytetrafluoroethylene (PTFE) or glutaraldehyde processed autologous pericardium (20-30 min). PTFE patch has an advantage because it is meant to divide two compartments with very different pressure—the aorta and the pulmonary artery. This technique is often referred to as "sandwich technique" although the authors do not define it as such.

In repair of the type I APW access is directly through the aortic wall. Incision can be transverse at the level of APW or vertical from the aortic valve to the aortic cross-clamp, when additional clarification of the origin of RPA is needed (Fig. 41.5A). The patch for closure of the window must be positioned so that both coronary ostia are on the aortic side of the patch. Small-sized APWs may be closed by direct suture, using one or two rows of continuous 4-0 polypropylene sutures, but a patch is generally advisable even for smaller defects (Fig. 41.5B). The aortotomy incision is then closed with one row of continuous polypropylene sutures. The remainder of the operation, including the de-airing procedure, is carried out as usual (see "De-airing the Heart" in Section III of Chapter 2).

If the APW involves the front wall of the proximal RPA (type II), approach is made through a vertical or transverse aortotomy (Fig. 41.6A) and the defect closed with a patch that extends out along the RPA (Fig. 41.6B).

A modification is required when the right coronary artery arises from the pulmonary trunk just to the left of the anterior wall of the APW. Then the anterior incision into the window curves to the left into the pulmonary trunk to create a flap of anterior pulmonary trunk wall that includes the origin of the right coronary artery. The flap should be large enough to cover the entire window. It is sewn into position over the window with a continuous polypropylene stitch. Repair is completed by closing the defect in the pulmonary trunk with a pericardial patch.
...
Because of the special planning required when certain anomalies coexist, some specific comments are useful. In APW combined with complex anomalies of the aortic arch such as IAA or transposition of the great arteries (TGA), a combined technique of whole-body perfusion consisting of combined antegrade cerebral perfusion and lower body perfusion can be applied. In instances of the rare association of APW with aortic origin of RPA, described as Berry syndrome, the RPA can be divided from the aorta and reattached to the main pulmonary artery through the APW after separation of the aorta from the pulmonary artery. Alternatively, an aortic cuff that is made by transecting above and below the level of RPA constitutes the posterior wall of RPA. The RPA is then closed with direct suture and the ascending aorta is repaired by end-to-end anastomosis. Finally, it is also possible to place an intra-aortic baffle to redirect the flow from main pulmonary artery (MPA) to the RPA.

![](_page_4_Figure_2.jpeg)

**Figure 41.4** Repair of aortopulmonary window using the "sandwich technique." (A) An incision is made on the window itself. (B) A patch material is sutured onto the posterior, superior and inferior borders of the window. (C) Closing sutures anteriorly that incorporate the patch.

![](_page_5_Picture_2.jpeg)

**Figure 41.5** Repair of type I aortopulmonary window (APW). (A) Operation is performed on cardiopulmonary bypass with aorta occluded. APW is exposed through a transverse aortotomy. It is located just above sinutubular junction. Origin of left coronary artery is identified because it may have a close relationship with inferior margin of APW. (B) APW is closed with a polyester, polytetrafluoroethylene, or pericardial patch to create a partition between aorta and pulmonary trunk. Left coronary artery is protected from inclusion in suture line.

![](_page_5_Picture_4.jpeg)

**Figure 41.6** Repair of type II aortopulmonary window (APW). (A) Operation is performed on cardiopulmonary bypass. Aortic perfusion cannula is placed in aortic arch to allow occlusion of aorta near origin of brachiocephalic artery. APW is exposed through a transverse aortotomy. It is located on posterior aspect of aorta and involves the pulmonary trunk at origin of right pulmonary artery. (B) Partition between aorta and pulmonary trunk is created using a polyester patch. There must be some contour to the patch to avoid stenosis of proximal right pulmonary artery. Edge of aorta at right side of window must be identified and the patch attached to aortic edge to prevent communication of aorta with right pulmonary artery.
...
Postoperative care is as usual. When repair has been performed in a neonate or infant, care appropriate to this age group is used (see Chapter 54).
...
Table 41.1 summarizes the hospital mortality and late deaths after repair of APW for simple APW and APW with associated lesions, including IAA.

<details class="med-details"><summary>

### Early (Hospital) Death</summary><div class="details-content">

Hospital mortality is low after repair of APW unless unusual circumstances are present. In the current era, early mortality following repair of simple APW is very low.
...
Time-related survival is excellent when the operation is performed in infancy. McElhinney and colleagues followed patients for up to 25 years after operation. Eighteen patients with Richardson type I or II were operated on at age 6 months or less. Eleven were categorized as complex because of presence of associated severe anomalies, most commonly IAA. One patient died 4 months after operation from unspecified respiratory complications. There were no other late deaths. Tkebuchava and colleagues reported similar long-term results. Ten patients with types I and II defects were operated on, 77% with associated anomalies. One patient with associated IAA died. There were no late deaths among patients followed up to 22 years. In the Congenital Heart Surgeons' Society analysis of 19 patients who underwent surgical repair of IAA and APW, 1- and 10-year survival was 91% and 84%, respectively.

In those rare circumstances in which repair of a large APW is done in older children, the late result may be compromised by pulmonary vascular obstructive disease. Although recent reports indicate favorable outcomes with perioperative use of pulmonary vasodilators, pulmonary vascular obstructive disease is a risk factor for mortality. The long-term outcome depends on age at operation and level of pulmonary vascular resistance at the time of operation (see Chapter 33).
...
Reoperation rates are low in isolated APW. Although reported cases are too few for meaningful analysis, simple ligation appears to increase the likelihood of incomplete closure or pulmonary artery distortion severe enough to require reintervention, either with catheter techniques or reoperation. In one study, transpulmonary repair was associated with a greater chance of reintervention.

In a recent series of 120 patients from the isolated APW group, Reddy and associates reported freedom from reintervention at 5 years and 8 years was 100%. In the APW group + other anomalies, freedom from reintervention was 92.4%. In another series of 40 patients by Alsoufi and associates, 10% needed reoperation, and the majority of them were with IAA. The 10-years freedom from cardiac reoperation was 100% for simple APW versus 73% for complex APW. Age, weight, prematurity, extracardiac anomalies, APW size and type, and operative technique were not associated with risk of reoperation.

In the setting of IAA with APW, reinterventions are much more likely. In the Congenital Heart Surgeons' Society multiinstitutional analysis, by 5 years after repair, 51% of patients required arch reintervention (2 of whom had bronchial compression), 6% pulmonary artery reintervention, and 43% were alive without further intervention. Arch reinterventions were more likely in patients with type B IAA. Thus, in IAA with APW, long-term survival is excellent, but late sequelae related to the arch repair of IAA are likely.

</div></details>

<details class="med-details"><summary>

#### TABLE 41.1: Hospital Mortality and Late Deaths after Primary Repair of Aortopulmonary Window</summary><div class="details-content">

| Authors | Year | N | Hospital Deaths | Late Deaths | N | Hospital Deaths | Late Deaths |
|---------|------|---|-----------------|-------------|---|-----------------|-------------|
| | | | SIMPLE APW | | | APW WITH ASS. LESIONS (INCL. IAA) | |
...
| Total | | 182 | 4 (2.2%) | 1 (0.5%) | 137 | 18 (13.1%) | 4 (2.9%) |
...
Symptomatic infants with APW should be operated on promptly when the diagnosis is made. Elective repair is advised before age 3 months.

Older children should be operated on unless high pulmonary vascular resistance renders them inoperable. The criteria of operability described for patients with VSD are applicable to those with large APWs (see "Indications for Operation" in Section I of Chapter 33).

</div></details>

<details class="med-details"><summary>

## Alternative Procedures and Controversies</summary><div class="details-content">

<details class="med-details"><summary>

### Transcatheter Closure of Aortopulmonary Window</summary><div class="details-content">

Previous experience with transcatheter closure of APW is limited and includes small series or individual case reports. Transcatheter closure of nonrestrictive APW in infants has been reported. Determination of suitability for catheter closure remains challenging. The location and size of APW must be carefully evaluated to avoid causing embolization, impairing the function of the semilunar valves, or affecting the ostia of the coronary arteries. Transcatheter closure may be indicated in older patients with small APW. As there is currently no device specifically designed for APW, the indication for device closure remains limited and imprecise.
