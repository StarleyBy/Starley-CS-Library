...
Angulation of the aorta refers to the orientation of the ventriculoaortic junction and proximal aorta with the long axis of the left ventricle. Aortic angulation increases with older age and in its most extreme form results in an almost horizontal direction of the proximal ascending aorta. Increased aortic angulation may be associated with altered flow in the proximal aorta causing jet impingement on the aortic wall that in turn may cause or accelerate aneurysm formation. The degree of aortic angulation may also complicate transcatheter aortic valve replacement. In patients with hypertrophic cardiomyopathy, increased aortic angulation is associated with dynamic left ventricular outflow tract obstruction (see Chapter 19).
...
The right and left ventricular septal surfaces are asymmetric, related mainly to presence of an infundibulum in the right ventricle only (although Van Praagh and colleagues argue that a small portion of the subsemilunar conus lies just beneath the right aortic valve cusp). In addition, higher pressure in the left ventricle makes the sinus septal surface concave on the left side and convex on the right (see Fig. 1.15), a feature accentuated during ventricular systole. The axes of the right and left ventricular outflow tracts differ. That of the right ventricle is almost vertically oriented, whereas that of the left ventricle angles sharply to the right (Fig. 1.16), a feature profiled cineangiographically in the left anterior oblique (LAO) view and in the parasternal long axis view by two-dimensional (2D) echocardiography.
...
The following description is based on studies of hearts *without* congenital defects. Abnormalities of the conduction system are associated with certain congenital cardiac malformations and determined primarily by the alignment between atrial and ventricular septal structures and the pattern of ventricular architecture (see Chapters 47 and 51).
...
The mitral valve leaflets may be described using a segmental classification. The valve leaflets are segmented into six sections, A1 to A3 for the anterior and P1 to P3 for the posterior (see Fig. 1.25C). Sections A1 and P1 represent the anterolateral sections, A2 and P2 the middle sections, and A3 and P3 the posteromedial sections. This segmental classification has been useful in describing morphology observed at operation, multiplane 2D transesophageal echocardiography, and 3D echocardiography.
...
The left main coronary artery extends from the ostium in the left sinus of Valsalva to its bifurcation into the left anterior descending and left circumflex branches. Its usual length is 10 to 20 mm, with a range of 0 to 40 mm. It normally courses between the pulmonary trunk and the left atrial appendage to reach the left AV groove. Occasionally, additional vessels originate from the left main coronary artery and course parallel to the diagonal branches of the left anterior descending branch. Such an additional artery (formerly called a *ramus intermedius*) is termed the *first diagonal branch* of the left anterior descending artery. Rarely (in 1% of persons), the left main coronary artery is absent, with the left anterior descending and left circumflex coronary arteries originating directly from the aorta via separate ostia.
...
Dimensions have been measured in autopsy specimens and by cineangiography (in which dimensions must be corrected for magnification), echocardiography (M-mode, 2D, 3D), and increasingly by MRI and CT. However, normal values are generally not available in each of these modalities, so dimensions must be related to available normal values, even if from a different modality.

Echocardiography has evolved as the most used modality for measuring these dimensions, in part because the dimensions can be easily followed serially without radiation or sedation. Pathway dimensions have been determined by echocardiography at nearly all ages of life, from fetal to age 90 years. Hornberger and colleagues established dimensions by high-resolution 2D echocardiography for the fetal aortic arch in 92 fetuses aged 16 to 38 weeks gestation to facilitate diagnosis of left heart and aortic abnormalities, particularly coarctation. Skelton and colleagues followed changes in cardiac dimensions of preterm infants during the first month of life, suggesting differences from term infants, with preterm babies showing mild left ventricular dysfunction.

Pathway dimensions for hearts from birth to about 20 years have been determined by M-mode and 2D echocardiography by Daubeney and colleagues, Ziblerman and colleagues, Pettersen and colleagues, and Cantinotti and colleagues. However, the report of the Pediatric Heart Network study of 3215 healthy children from 19 North American centers from 0 to age 18 and balanced by age groups, race, ethnicity, and sex is the largest source of data with allometric equations in its supplement. A number of studies in adults use 2D echocardiography (transthoracic or transesophageal) with pathway dimensions measured directly or derived from Doppler ultrasound measurements and the continuity equation. The age range is often wide, but there are populations studied at mean age 23, 28, 33, 45, and 53 years. Swinne and colleagues call attention to age-associated changes in left ventricular outflow tract geometry observed in normal subjects, mostly after age 70. These changes consist of a more acute septoaortic angle or septal bulge that is not associated with left ventricular outflow tract obstruction. These may represent degenerative changes associated with aging.
...
$$z = \frac{\text{Observed dimension}^{(1)} - \text{Mean normal dimension}^{(2)}}{\text{Standard deviation of the mean normal dimension}^{(3)}}$$
...
The limitation of standardization is that what is normal, and the scatter in the measurements of normal, vary from population to population. This is particularly true of the standard deviation, which forms the denominator of the *z* score equation. Simpson and Chubb have pointed this out graphically in their commentary on the Pediatric Heart Network Study.
...
Normal values for mitral and tricuspid valves based on echocardiographic measurements (Table 1.3) show some differences from autopsy data. An informal comparison between the echocardiographic measurements of the mitral valve by King and colleagues and those obtained at autopsy by Rowlatt and colleagues suggests that in subjects who have less than about 0.5 m² BSA, the echocardiographic dimensions are about 33% larger (Fig. 1.34). A similar comparison between the echocardiographic dimensions obtained by Riggs and colleagues and those obtained in autopsy specimens by the Rowlatt group indicates that dimensions were similar in small subjects, but the echocardiographically determined dimensions were about 20% larger in patients with BSAs greater than 1 m². In the tricuspid valve, a comparison of autopsy data and echocardiographic data supports findings of considerable differences in dimensions obtained using different measurement modalities (Fig. 1.35).
...
**• Figure 1.34** Relation between diameter of mitral valve orifice and body surface area, according to whether measurements were made in fixed autopsy specimens (Rowlatt and colleagues) measuring circumference or by echocardiography (King and colleagues measuring either major and minor axes or area directly (Riggs and colleagues). Solid lines represent continuous point estimates of the relations, and dashed lines enclose 70% confidence interval. *AP*, Anteroposterior.

![](_page_26_Figure_8.jpeg)

**• Figure 1.35** Relation between diameter of tricuspid valve and body surface area, according to whether measurements were made in fixed autopsy specimens (Rowlatt and colleagues), by cineangiography (Alboliras and colleagues, Bull and colleagues); or by echocardiography (King and colleagues). Solid lines represent continuous point estimates of the relations, and *dashed lines* enclose 70% confidence interval.
