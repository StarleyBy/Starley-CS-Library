...
### Historical Foundations and Nomenclature Development
* **Maude Abbott (1936):** *Atlas of Congenital Cardiac Disease* — first formal classification of CHD. Abbott also co-founded the International Association of Medical Museums (1906) with William Osler.
* **Key pioneers of CHD anatomy:** Lodewyk van Mierop, Richard and Stella Van Praagh, Robert H. Anderson.
* **Two independent nomenclature systems (1990s):** EPCC (AEPC, Europe) and International Congenital Heart Surgery Nomenclature and Database Project (STS/EACTS/ECHSA, North America/Europe). Both include Long List (thousands of terms) and Short List (minimum for registries).
* **Problem of two systems:** Competing nomenclatures → risk of duplicate and inaccurate coding.
* **ISNPCHD (2005):** International Society for Nomenclature of Paediatric and Congenital Heart Disease — created for unification.

### IPCCC (International Pediatric and Congenital Cardiac Code)
* **Creation:** NWG (Nomenclature Working Group) over 8 years and 10 meetings on all continents except Antarctica created a bidirectional crossmap between the two Long Lists.
* **Two primary versions:** EACTS-STS-derived (molecular structure) and AEPC-derived (atomic structure). Both versions crossmapped to each other.
* **Volume:** AEPC-derived — 12,168 items; EACTS-STS-derived — 17,176 items (includes all atomic terms + thousands of molecular combinations).
* **Usage:** STS CHSD, ECHSA CHSD, Japan JCCVSD, World Database for Pediatric and Congenital Heart Surgery — all use EACTS-STS-derived version.

### Molecular vs. Atomic Structure
* **Molecular structure:** Each combined diagnosis (e.g., "TGA, VSD, LVOTO") is a single diagnostic unit with one code. Used by EACTS-STS-derived IPCCC.
* **Atomic structure:** Complex diagnosis broken into separate codes for each element (TGA + VSD + LVOTO = three codes). Used by AEPC-derived IPCCC.
* **Exceptions:** A few common combinations grouped in both systems (e.g., "Pulmonary atresia + VSD [Fallot type]").
* **IPCCC ICD-11:** Combination of atomic and molecular approaches.

### ICD-11: Structure and Key Changes
* **History of ICD:** Originated from Bertillon Classification of Causes of Death (1893). Managed by WHO since 1948. ICD-11 officially launched June 2018, effective January 1, 2022.
* **ICD-11 Foundation:** Full ICD-11 content, entire ICD-11 universe (26 sections). Contains 367 pediatric and congenital cardiac terms.
* **ICD-11 MMS (Mortality and Morbidity Statistics):** "Top-sliced" version of Foundation for global mortality/morbidity data collection and billing. Contains 104 of 367 terms.
* **Key achievement:** For the first time, clinical and administrative nomenclature for pediatric and congenital cardiac care are harmonized.

### Growth of CHD Terms Across ICD Versions
| Version | CHD Terms |
|---------|-----------|
| ICD-9 | 29 |
| ICD-10 | 73 |
| ICD-11 (2018, submitted by ISNPCHD) | 318 |
| ICD-11 (after WHO addition) | 367 |

### Problems with Administrative Nomenclature (ICD-9/ICD-10)
* **Wisconsin (373 infants):** Only 52% of cardiac diagnoses had corresponding ICD-9 code.
* **Hennepin County (66 infants):** Only 41% of ICD-9 codes confirmed by physician review.
* **Atlanta (1988–2003):** ICD-9 codes have "substantial misclassification" of CHD.
* **STS CHSD (clinical) vs. PHIS (administrative) comparison:** PPV of administrative data 56.7–88.0%, NPV 98.8–99.9%. Mortality for truncus arteriosus repair: underestimation by 25.7% (7.01% vs. 9.43%, P = .001).
* **Causes:** Accidental miscoding, coding by personnel without clinical experience, contradictory medical record information, insufficient diagnostic specificity, inadequately trained coders.

### Rules for Using "Right" and "Left"
* **For cardiac chambers:** "Left" = morphologically left, "right" = morphologically right. Does not imply position or sidedness.
* **For describing position:** Use "left-sided ventricle" (not "left ventricle").
* **For venae cavae:** "Left" or "right" indicates spatial position.

### Definitions (IPCCC and ICD-11)
* **Functionally univentricular heart:** Spectrum of malformations where the ventricular mass cannot be partitioned into systemic and pulmonary pumps.
* **Hypoplastic left heart syndrome (HLHS):** Spectrum with normally aligned great arteries without common AV junction, characterized by underdevelopment of the left heart with significant LV hypoplasia including atresia/stenosis/hypoplasia of aortic or mitral valve (or both), and hypoplasia of the ascending aorta and arch.
* **Congenitally corrected TGA (discordant AV & VA connections):** RA → LV, LA → RV, RV → aorta, LV → pulmonary trunk.
* **Visceral heterotaxy:** Abnormal arrangement of thoracoabdominal organs along the left-right axis. Does not include situs inversus totalis.
* **Ventricular septal defect (VSD):** Hole or pathway between the ventricular chambers.
* **Perimembranous central VSD:** VSD that (1) occupies the space normally closed by the interventricular part of the membranous septum, (2) is adjacent to fibrous continuity between AV valve and arterial valve leaflets, (3) is adjacent to mitral-tricuspid fibrous continuity, and (4) is located at the center of the base of the ventricular mass.

### Virtual Atlas (IPCCC ICD-11 Congenital Heart Atlas)
* **Purpose:** Illustrate terms from the "Structural developmental anomaly of heart or great vessels" section of ICD-11.
* **Content:** Drawings, photographs of anatomical specimens, images and videos from various imaging modalities, intraoperative photographs and videos.
* **Access:** Free at https://www.IPCCC.net.
...
## Historical Considerations</summary><div class="details-content">
...
- The European Paediatric Cardiac Code (EPCC) of The Association for European Paediatric and Congenital Cardiology (AEPC), published in 2000
...
- The version of the IPCCC derived from the EPCC of AEPC
...
## Principles of Nomenclature</summary><div class="details-content">

<details class="med-details"><summary>

### Clinical Versus Administrative Nomenclature</summary><div class="details-content">
...
- Coding performed by medical records clerks who have never seen the patient (i.e., coding performed by personnel not involved in the care of the patient)
- Contradictory or poorly described information in the medical record
- Lack of diagnostic specificity for congenital cardiac disease in ICD-9
...
### The Meaning of the Words Right and Left</summary><div class="details-content">
...
### Structural Differences Between the Systems of Nomenclature</summary><div class="details-content">

The fundamental structure of systems for nomenclature are of two general types:

- *Molecular* structure, with an incrementally more complex diagnostic or procedural *combination* of terms. Each *combination* is considered a single diagnostic unit, which theoretically could have its own numerical code.
- *Atomic* structure, in which a complex diagnosis would have separate numerical codes for each *element*.
...
## The International Pediatric and Congenital Cardiac Code (IPCCC)</summary><div class="details-content">
...
## Eleventh Revision of the International Classification of Diseases (ICD-11)</summary><div class="details-content">
...
**Figure 27.1** The International Classification of Diseases *(ICD)*. This bar chart documents the time interval between each Revision of the ICD, 1900–2021. The horizontal lower bar indicates the number of terms related to congenital heart disease *(CHD)* listed in each ICD version. *(Reproduced with permission from Jacobs JP, Franklin RCG, Béland MJ, et al. Nomenclature for pediatric and congenital cardiac care: unification of clinical and administrative nomenclature - The 2021 International Paediatric and Congenital Cardiac Code [IPCCC] and the Eleventh Revision of the International Classification of Diseases [ICD-11]. Cardiol Young. 2021;31[7]:1057-1188 and Jacobs JP, Franklin RCG, Béland MJ, et al. Nomenclature for pediatric and congenital cardiac care: unification of clinical and administrative nomenclature - The 2021 International Paediatric and Congenital Cardiac Code [IPCCC] and the Eleventh Revision of the International Classification of Diseases [ICD-11]. World J Pediatr Congenit Heart Surg. 2021;12[5]:E1-E18.)*
...
- Digital curation
- Incorporation of wide peer review
...
Populating ICD-11 by the content-specific TAGs required extensive deliberations between the Rare Diseases TAG and several Internal Medicine Topic Advisory Workings Groups, including the Cardiovascular Working Group, over the hierarchy to be included or excluded. E-Tables 27.1 and 27.2 (see online version) present the diagnostic hierarchy and definitions of the 318 codes submitted by ISNPCHD to compose the IPCCC ICD-11 Nomenclature, as well as an additional 49 scientifically correct or legacy terms added by the WHO ICD-11 team. As these additional 49 entities have now been added to IPCCC, ISNPCHD has provided the needed definitions for these terms. Other legacy and scientifically incorrect terms (inserted into the ICD-11 Foundation by the WHO ICD-11 team that ISNPCHD judged to be obsolete or meaningless), such as "Transposition of the aorta" and "Accessory heart," are labeled "obsolete" within the system, meaning that these terms are retained for legacy purposes but not visible or easily searchable. Therefore, E-Tables 27.1, 27.2, and 27.3 (see online version) present the 367 terms that are part of IPCCC and also the pediatric and congenital cardiac component of ICD-11, a nomenclature system that harmonizes the administrative nomenclature for pediatric and congenital cardiac care with the clinical nomenclature for pediatric and congenital cardiac care, for the first time ever.

An understanding of the structure and rationale of two versions of ICD-11 is important:

- *ICD-11 Foundation* is the full ICD-11 content and represents the entire ICD-11 universe.
- *ICD-11 Mortality and Morbidity Statistics version (ICD-11-MMS)* is the nearest equivalent to previous ICD versions, includes a printed copy of top-level terms, and is designed to collect global data at a level of detail sufficient to capture important trends in the causes of death and prevalence of major disease entities. ICD-11-MMS is also the likely diagnostic coding system that will be used by countries for billing purposes. To create ICD-MMS, WHO in effect "top-sliced" the ICD-11 Foundation level content to include relevant higher-level terms, although not always with the input of clinicians.

<details class="med-details"><summary>

#### The Foundation Component of ICD-11 (ICD-11 Foundation)</summary><div class="details-content">

The full ICD-11 content is known as the *ICD-11 Foundation* and represents the entire ICD-11 universe, divided into 26 sections, and accessed digitally at the following Website: [https://icd.who.int/dev11/f/en#/http%3a%2f%2fid.who.int%2ficd%2fentity%2f455013390]. The 318 diagnostic terms for CHD that were submitted by ISNPCHD in 2018 reside in the *Foundation Component of ICD-11*, within the *Developmental Anomalies section*, with the parent term "Structural developmental anomaly of heart or great vessels," along with the additional 49 terms added to IPCCC by the WHO ICD-11 team since 2018.

</div></details>

<details class="med-details"><summary>

#### The ICD-11 Mortality and Morbidity Statistics Version (ICD-11 MMS)</summary><div class="details-content">

An important feature of ICD-11 is that it produces so-called linearizations or "Tabular Lists" that are designed to be explicitly stratified to cater to different users, including:
...
The *ISNPCHD* has published multiple review articles that provide a unified and comprehensive classification, with definitions, for several simple and complex congenital cardiac malformations, including the following lesions:

- The functionally univentricular heart
- Hypoplastic left heart syndrome
- Discordant atrioventricular connections
- Cardiac structures in the setting of heterotaxy
- VSD

These review articles include definitions and a complete listing of the relevant codes and terms in both versions of the IPCCC. The six definitions shown later are the current IPCCC and ICD-11 definitions of several of the terms defined in these review articles; these definitions exemplify the approach utilized by *ISNPCHD* in the creation of IPCCC:

- **Functionally univentricular heart** is defined as a spectrum of congenital cardiac malformations in which the ventricular mass may not readily lend itself to partitioning that commits one ventricular pump to the systemic circulation and another to the pulmonary circulation (see Chapter 52).
...
- **Congenitally corrected transposition of great arteries** is synonymous with the term "discordant atrioventricular & ventriculoarterial connections" and is defined as a congenital cardiovascular malformation in which the morphologically right atrium connects to the morphologically left ventricle, the morphologically left atrium connects to the morphologically right ventricle, the morphologically right ventricle connects to the aorta, and the morphologically left ventricle connects to the pulmonary trunk (see Chapter 47).
- **Visceral heterotaxy** is defined as a congenital malformation in which the internal thoracoabdominal organs demonstrate abnormal arrangement across the left-right axis of the body (see Chapter 53). By convention, heterotaxy syndrome does not include patients with complete mirror-imaged arrangement of the internal organs along the left-right axis also known as "situs inversus totalis."
- **Ventricular septal defect** is defined as a congenital cardiac malformation in which there is a hole or pathway between the ventricular chambers (see Chapter 33).
- **Perimembranous central ventricular septal defect** is defined as a congenital cardiovascular malformation in which there is a VSD that (1) occupies the space that is usually closed by the interventricular part of the membranous septum, (2) is adjacent to the area of fibrous continuity between the leaflets of an atrioventricular valve and an arterial valve, (3) is adjacent to an area of mitral-tricuspid fibrous continuity, and (4) is located at the center of the base of the ventricular mass.

</div></details>

<details class="med-details"><summary>

#### Virtual Atlas</summary><div class="details-content">

The ISNPCHD created, organized, and defined the terms of IPCCC to standardize nomenclature for pediatric and congenital cardiac care and promote accurate coding, sharing of information, and analysis of data. ISNPCHD believed from the start that the concept of "illustration" of the terms would be very important to advance these goals. Concurrent with its involvement in developing ICD-11, as described in detail later, ISNPCHD began creating the IPCCC ICD-11 Congenital Heart Atlas to illustrate the terms listed in the "Structural developmental anomaly of heart or great vessels" section of ICD-11. In addition to the terms, definitions, and data about coding that is published in ICD-11, the IPCCC ICD-11 Congenital Heart Atlas is currently being built to contain drawings, photographs of anatomical specimens, images and videos from various imaging modalities, and intraoperative photographs and videos, all designed to help healthcare professionals better select the correct designation for the cardiac phenotypes listed in ICD-11, as well as for educational purposes. The IPCCC ICD-11 Congenital Heart Atlas is freely accessible on the ISNPCHD Website [https://www.IPCCC.net].
