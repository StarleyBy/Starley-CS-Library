...
### Paediatric heart transplantation epidemiology
* **Most common diagnoses:** Congenital heart disease (50% of infants, decreases with age) and cardiomyopathy (65% of adolescents). Retransplantation is rare.
* **Clinical indications:** IV inotropic or MCS dependence, complex CHD not amenable to repair, progressive ventricular dysfunction despite therapy, survived arrest/malignant arrhythmia, progressive pulmonary hypertension, growth failure from heart failure, poor quality of life.
...
### Contraindications and pre-transplant management
* **Absolute contraindications:** Active infection, recent neoplasm, active ulcer disease, renal failure (unless renal transplant planned), liver dysfunction, non‑reactive pulmonary hypertension, PE, drug use, non‑adherence.
* **Chronic heart failure medical therapy:** Diuretics, ACEi/ARB, beta‑blockers (metoprolol, carvedilol), digoxin. Sacubitril/valsartan (neprilysin inhibitor) for HFrEF.
* **Acute decompensated HF:** Volume overload → diuretics + vasodilators; cardiogenic shock → afterload reduction, then inotropes (milrinone, dobutamine, epinephrine). MCS (ECMO, VAD) for worsening failure.

### Recipient evaluation and pulmonary hypertension
* **Cardiac evaluation:** ECG, echo, often cath (PVR, venous anomalies). PRA for HLA antibodies.
* **Elevated PVR:** Reactive PVR (response to NO) safe if PVR <5–6 Wood units × BSA. LV unloading with VAD may reverse PVR if duration <1–2 years. Oversized donor hearts reduce RV failure risk. Fixed/non‑reactive PH with poor LV function → heart‑lung transplant.

### Donor evaluation and organ allocation (UNOS/OPTN)
* **Donor factors:** Size (oversizing up to 3:1 may be used in infants, but excessive large heart causes compression), age, immunologic match, distance, function, infection history.
* **Paediatric listing status:**
    * **1A (highest):** Ventilator/MCS/balloon pump; infant <6mo with reactive PH >50% systemic; high‑dose or multiple inotropes; life expectancy <14 days.
    * **1B:** Low‑dose single inotrope; infant <6mo not 1A; growth failure (<5th percentile or ≥1.5 SD below expected).
    * **2:** All other suitable children.
* **Waiting time:** Median ~30 days; 10% die on waitlist (highest for infants <1y and CHD).

### ABO‑incompatible transplantation and mechanical circulatory support
* **ABO‑incompatible:** Feasible in infants <12mo (no isoagglutinins). Reduces waitlist mortality in Europe/Canada; in US used only for sickest infants or after no compatible match.
* **Bridge to transplant with MCS:** Used in ~20% of recipients.
    * **ECMO:** Rapid, any age, but complications (bleeding, thromboemboli) high after >1–2 weeks; requires sedation, debility.
    * **Short‑term VAD (PediMag, CentriMag):** Simpler circuit, no oxygenator, still limited duration.
    * **Durable VAD (Berlin Heart EXCOR):** Pulsatile, any age, 90% survival vs 40–60% ECMO; allows ambulation.
    * **Continuous‑flow VAD (HeartMate II, HVAD):** For BSA >1.0 m² (reports down to 0.7 m²), fully implantable, hospital discharge possible.
    * **Single‑ventricle patients:** ECMO or VAD; BiVAD may be needed in Fontan with high pulmonary pressures.

### Surgical technique and special considerations for CHD
* **Standard technique (bicaval left atrial cuff):** CPB, bicaval cannulation, left atrial and aortic anastomoses first, then IVC, SVC, PA.
* **CHD modifications:**
    * **Left SVC (LSVC):** Ligate if bridging vein present; else reroute to donor RA using donor innominate vein or intra‑atrial baffle.
    * **Transposition of great arteries:** Use extra donor vessel length or move native pulmonary arteriotomy leftward.
    * **Univentricular heart/Fontan/hybrid:** PA reconstruction with donor branch PA patch; ductal stent removal requires Norwood‑like aortic reconstruction with donor aorta or homograft.
    * **Situs inversus:** Shift arterial anastomoses to midline; LSVC routed to RA; left IVC extended to donor IVC.

### Immunosuppression and outcomes after heart transplant
* **Triple therapy:** Corticosteroids + calcineurin inhibitor (tacrolimus > cyclosporine) + anti‑proliferative (mycophenolate mofetil > azathioprine). Induction (anti‑thymocyte globulin or IL‑2 antagonist) in ~70%.
* **Survival:** 1‑year: 82% (<1y) vs 88% (older); 10‑year: 66% (<1y) vs 55% (older). Median survival: 19.7y (<1y), 16.8y (1–5y), 14.5y (6–10y), 12.4y (11–17y).
* **Conditional survival (1‑year survivors) – median:** >21y (<1y), 20.6y (1–5y), 16.7y (6–10y), 16.1y (11–17y).
* **MCS impact on post‑transplant survival:** VAD‑bridged patients have excellent post‑transplant survival; ECMO‑bridged have 20–30% excess early mortality.
* **Causes of death:** Graft failure (#1 early and late); multisystem organ failure, infection, acute rejection (first year); CAV (#2 after year 3).

### Paediatric lung transplantation – indications, allocation and outcomes
* **Volume:** ~100/year worldwide (vs >500 heart transplants). 70% recipients are adolescents.
* **Indications by age:** <6y – idiopathic PAH, CHD, surfactant deficiency; >6y – cystic fibrosis (>50%).
* **Contraindications:** Recent neoplasm, active systemic infection, chronic pulmonary infection (TB, resistant atypical mycobacteria, *Burkholderia cepacia* genomovar 3, other MDR organisms). Concomitant irreparable CHD or ventricular dysfunction → consider heart‑lung.
* **Heart‑lung transplantation:** For end‑stage lung disease + uncorrectable CHD or LV dysfunction (EF<35%). Most common: Eisenmenger syndrome, end‑stage lung disease with LV failure.
* **Allocation (UNOS/OPTN):**
    * **Age ≥12y:** Lung Allocation Score (LAS) based on diagnosis, age, BMI, bilirubin, CI, CVP, ventilator status, diabetes, FVC, functional status, O₂ requirement, pCO₂, PAP, 6‑min walk.
    * **Age <12y:** Priority 1 (respiratory failure or severe PH criteria) or Priority 2.
* **Donor evaluation:** ABO compatibility essential, pO₂/FiO₂ >300, size match (avoid undersizing), bronchoscopy.

### ECMO, lung assist devices and surgical principles
* **Bridge to lung transplant:** ~35% on ventilator, ~8% on ECMO (ECMO bridge associated with worse post‑transplant survival).
* **Pumpless paracorporeal lung assist (Novalung iLA, Quadrox iD):** For patients with preserved ventricular function; uses RV to drive blood through oxygenator (PA‑LA circuit); allows extubation/rehab but anticoagulation risks remain.
* **Surgery:** Bilateral lung transplant on CPB (sternotomy, clamshell, or bilateral thoracotomies). Bronchial anastomosis: absorbable monofilament, running on membranous, interrupted on cartilaginous to allow growth; wrap with pericardium/peribronchial tissue. Then pulmonary venous (left atrial cuff) and pulmonary artery anastomoses.

### Post‑operative management and long‑term outcomes
* **Complications:** Bleeding, infection, primary graft dysfunction, acute/hyperacute rejection, airway dehiscence/stenosis.
* **Immunosuppression:** Similar to heart but higher dosing; induction (anti‑thymocyte globulin or IL‑2 antagonist) + maintenance (corticosteroids, tacrolimus, mycophenolate mofetil).
* **Survival:** Median overall 5.1y (paediatric) vs 5.6y (adult). By age: 6.4–6.7y (0–11y), 4.7y (12–17y). Conditional (1‑year) median survival: 9.7–11.2y (0–11y), 7.7y (12–17y).
* **Bronchiolitis obliterans syndrome (BOS):** Fibroproliferative small‑airway obliteration; affects >50% of 5‑year survivors; only 50% survive >3y after BOS diagnosis. Treatment: steroids/advanced immunosuppression; retransplantation for progressive BOS.
* **Post‑transplant lymphoproliferative disease (PTLD):** EBV‑driven, incidence ~15% within 5y (higher than adults).
* **Lung retransplantation:** Uncommon, most often >1y after primary, indication BOS (>50%). 5‑year survival 33% (vs 52% primary); if inter‑transplant interval ≥1y, survival approaches primary.
...
- b) patients with cardiogenic shock (inadequate tissue perfusion) are often initially managed with afterload reduction, with inotropes being reserved for those patients who remain decompensated with clinical evidence of poor cardiac output. Milrinone, dobutamine, and epinephrine are examples of inotropes used in acute paediatric heart failure.
...
In general, patients with reactive PVR (responsive to nitric oxide or other pulmonary vasodilators) can be safely transplanted as long as PVR adjusted for BSA is <5-6 Woods units. These patients may display some degree of right heart failure and evidence of a stiff heart (diastolic dysfunction with elevated CVP) postoperatively, which requires higher filling pressures.
...
As in adult heart transplantation, paediatric patients are listed as Status 1A, 1B or 2 according to medical urgency. Matching is then performed based on urgency status, immunologic and donor-recipient size matching, and geographical distance between the donor and recipient.
...
- d) <6 months old with congenital or acquired heart disease exhibiting reactive pulmonary hypertension >50% of systemic level (the child may be treated with prostaglandin E<sub>1</sub> to maintain patency of the ductus arteriosus);
...
- b) 16.8 years for children aged 1-5 years;
- c) 14.5 years for children aged 6-10 years;
- d) 12.4 years for adolescents aged 11-17 years.
...
Median conditional survival for recipients surviving the first year post-transplant is:
- a) >21 years for infants aged <1 year;
- b) 20.6 years for children aged 1-5 years;
- c) 16.7 years for children aged 6-10 years;
- d) 16.1 years for adolescents aged 11-17 years.
...
Of the approximately 40 centres performing paediatric lung transplants, most perform only 1-4 per year, as compared to about 100 centres performing heart transplants, also with an average volume of 1-4 per year.
...
- c) chronic pulmonary infections such as tuberculosis, resistant atypical mycobacteria, *Burkholderia cepacia* (particularly genomovar 3) and other multi-resistant organisms.
...
- j) functional status;
- k) amount of O<sub>2</sub> needed to maintain oxygen saturation ≥88% at rest;
- l) pCO<sub>2</sub>;
...
- ii) requiring supplemental FiO<sub>2</sub> >50% to maintain oxygen saturation >90%;
- iii) arterial or capillary pCO<sub>2</sub> >50mmHg;
- iv) venous pCO<sub>2</sub> >56mmHg;
...
- iii) cardiac index <2L/min/m<sup>2</sup>;
- iv) recurrent syncope;
- v) haemoptysis;

or an exception case approved by the UNOS Lung Review Board.
...
- c) smoking history;
- d) adequacy of gas exchange (arterial pO<sub>2</sub> to FiO<sub>2</sub> ratio >300);
...
An end-to-end pulmonary venous anastomosis is then made to the left atrial cuff with running polypropylene suture, followed by an end-to-end pulmonary artery anastomosis in similar fashion.
