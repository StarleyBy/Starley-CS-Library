...
### Chapter 1: Introduction – Evolution of Thoracic Surgery
* General thoracic surgery emerged in early 1900s treating tuberculosis and war trauma; later merged with cardiac surgery but thoracic training was secondary. Dr. F. Griffith Pearson (Toronto) established first dedicated division of general thoracic surgery in North America.
* Lung cancer replaced tuberculosis as primary focus in second half of 20th century. Surgical complete macroscopic resection remains foundation for solid tumors.
* Specialized training tracks, integrated programs, and fellowships (minimally invasive, robotic, thoracic oncology) have strengthened the discipline.
* Key advice: clarity of purpose and focused attention (“sharp pick” parable) essential for progress.

### Chapter 2: Thoracic Incisions
* **Posterolateral thoracotomy:** workhorse, centered on 5th intercostal space → best view of entire hemithorax. Spares serratus anterior. “Shingling” rib increases spread without mid‑shaft fracture.
* **Anterolateral thoracotomy:** 4th/5th interspace, smaller, quicker recovery, preserves latissimus dorsi. Limited posterior visualization.
* **Axillary thoracotomy:** 1st–3rd interspace, access to apex, minimal pain. Risk to long thoracic, thoracodorsal, intercostobrachial nerves.
* **Clamshell (bilateral thoracosternotomy):** broad exposure both hemithoraces; high morbidity; not for frail patients.
* **Median sternotomy:** precise midline; excellent for anterior/upper mediastinum, cardiac procedures; re‑do risk of heart adherence.
* **Partial sternotomy:** splits manubrium, preserves lower ribs → less pain, shorter lifting restrictions (3 vs 8 weeks).
* **Cervical mediastinoscopy:** small incision above sternal notch; key for lung cancer staging (paratracheal/subcarinal nodes). Risk of catastrophic bleeding; sternal saw must be available.
* **Anterior mediastinoscopy (Chamberlain):** parasternal for aortopulmonary window nodes or anterior masses; can be done under local.
* **Open thoracostomy (Eloesser flap / Clagett window):** for chronic empyema; creates permanent chest wall defect but controls sepsis in frail patients.

### Chapter 3: Chest Imaging (CT, PET/CT, MRI)
* **CT:** backbone for preoperative evaluation. Hounsfield units (water 0, air –1000, bone +1000). Intravenous contrast for staging (caution in renal impairment: eGFR <30 → avoid). High‑resolution CT (1–2 mm) for diffuse lung disease.
* **PET/CT:** ¹⁸F‑FDG tracer; upstages 30%, downstages 15% of lung cancers. Reliable for nodules ≥7–8 mm. False positives (inflammation) and negatives (AIS, carcinoid). Does NOT exclude brain metastases.
* **MRI:** superior for fascial planes, brachial plexus, thoracic outlet, mesothelioma (diaphragm integrity). Gadolinium restricted (nephrogenic systemic fibrosis).
* **Fleischner Society nodule guidelines ([Table 3-1](#table-3-1)):** ≤4 mm – no follow‑up (low risk); 4–6 mm – if no change at 12 mo stop; 6–8 mm – CT at 6–12 mo, then 18–24 mo; >8 mm – CT 3,9,24 mo or contrast/PET/biopsy.
* **Mediastinal mass differential ([Table 3-3](#table-3-3)):** anterior – thymoma, lymphoma, germ cell; middle – duplication cyst, lymphadenopathy (Castleman enhances), pericardial cyst; posterior – neurogenic tumor, extramedullary hematopoiesis.

### Chapter 4: Preoperative Evaluation
* **Two goals:** define risk, identify modifiable factors (not “clearing”).
* **Charlson Comorbidity Index** predicts survival better than individual comorbidities in NSCLC.
* **Smoking cessation:** ≥4 weeks reduces complications (41% RRR). Pharmacotherapy (nicotine, bupropion, varenicline) improves success.
* **Predicted postoperative (ppo) lung function:** ppo‑FEV₁ = preop FEV₁ × (1 – segments resected/total segments). Traditional high risk if ppo‑FEV₁ or D<sub>LCO</sub> ≤40%; now may accept 30% in selected cases. PPP = ppo‑FEV₁ × ppo‑D<sub>LCO</sub>; <1650 → high mortality.
* **Functional capacity:** stair climbing (3 flights for lobectomy, 5 for pneumonectomy); CPET (MVO₂ >15–20 mL/kg/min acceptable, <10 high risk). ATS/ACCP/ERS guidelines ([Figs. 4-1](#fig-4-1), [4-2](#fig-4-2)).
* **Cardiac assessment (ACC/AHA 2007):** thoracic procedures are high‑risk (>5%) or intermediate risk (1–5%). Active cardiac conditions (unstable angina, recent MI, decompensated HF, significant arrhythmias, severe valvular disease) mandate delay/cancellation. Revised Cardiac Risk Index: history of ischemic heart disease, HF, cerebrovascular disease, diabetes, renal insufficiency. Beta‑blockers indicated.

### Chapter 5: Anesthesia Management
* **Standard thoracotomy strategy:** general anesthesia + paralysis, arterial line (± central), double‑lumen tube (left DLT default), thoracic epidural, immediate extubation.
* **High‑risk inductions:** threatened airway (tracheal lumen <50%, supine/expiratory symptoms) – awake fiberoptic or inhalation induction; threatened venous return (large effusions, masses) – preemptive vasoconstrictors, volume, avoid epidural test dose; SVC syndrome – lower‑extremity IV.
* **Auto‑PEEP:** failure to fully expire → dynamic hyperinflation, impairs gas exchange, hemodynamic instability. Detected by end‑expiratory flow. Reduce by shortening T<sub>I</sub>, decreasing V̇<sub>E</sub>, increasing expiratory time.
* **OLV hypoxemia treatment ([Table 5-3](#table-5-3)):** F<sub>I</sub>O₂ =1, bronchoscopy, PEEP to dependent lung, CPAP to nondependent (5–10 cm H₂O), reinflate, cross‑clamp pulmonary artery.
* **Thoracic epidural:** placed before induction (awake test dose). Reduces pulmonary (infection, atelectasis) and cardiac (MI) complications; superior dynamic analgesia. Contraindications: coagulopathy, infection, patient refusal.
* **Postpneumonectomy pulmonary edema (PPE):** 2–4%, high mortality. Risk factors: right side, high fluid, high ventilatory pressures. Restrict fluids (<20 mL/kg first 24 h, <2 L crystalloid intraop). Limit OLV tidal volumes to 6–7 mL/kg.

### Chapter 6: Critical Care
* **Secretion retention/atelectasis:** prevent with early extubation, analgesia, ambulation, chest physiotherapy. Treatment: humidified O₂, nebulized bronchodilators, N‑acetylcysteine/dornase, bronchoscopy, inexsufflator, early tracheostomy if severe.
* **Atrial arrhythmias:** incidence up to 44% after extrapleural pneumonectomy. Prophylaxis: beta blockers or calcium channel blockers (~50% reduction). Acute treatment: rate control (beta blocker, CCB, digoxin). Amiodarone second line (can cause acute lung toxicity). Most return to sinus rhythm within 6 weeks.
* **Right ventricular failure / pulmonary hypertension:** correct hypoxia, hypercarbia, acidosis, pain, fever. Inotropes (dopamine, epinephrine, norepinephrine) and inodilators (dobutamine, milrinone). Pulmonary vasodilators: inhaled nitric oxide or epoprostenol (cheaper). Long‑term: prostanoids, endothelin antagonists, PDE5 inhibitors.
* **ARDS management (ARDSNet):** low tidal volume (6 mL/kg IBW), plateau pressure ≤30 cm H₂O → 8% mortality reduction. Restrictive fluid (CVP ≤4 mm Hg if not in shock) → earlier liberation. Corticosteroids NOT routine.
* **Sepsis (Surviving Sepsis Campaign):** first 6 h: cultures, broad‑spectrum antibiotics, fluid to CVP 8–12 mm Hg, MAP >65 mm Hg (vasopressors), ScvO₂ ≥70% (inotropes or transfusion to Hct 30% if needed).
* **VAP prevention bundle:** head of bed ≥30°, chlorhexidine oral care q12h, sedation holiday + readiness to extubate, protocolized weaning. Subglottic suctioning ET tubes if intubation >72 h.
* **Hyperglycemia:** target 140–180 mg/dL (NICE‑SUGAR trial); start insulin >180 mg/dL.
* **Critical illness polyneuropathy:** avoid unnecessary corticosteroids, limit neuromuscular blockers <48 h, daily physical therapy.

### Chapter 7: Mechanical Ventilation – Postoperative
* **Extubation of stable patient:** intact mental status, ability to cough and protect airway, analgesic protocol without depression. Risk of recurrent laryngeal nerve injury (left side) – weak voice after extubation → laryngoscopy.
* **Ventilator modes:** ACMV (assist/control) – every breath full V<sub>T</sub>, not for weaning. PCV (pressure‑controlled) – time‑cycled, pressure‑limited; limits stress on suture lines. PSV (pressure support) – patient‑triggered, flow‑cycled; requires intact drive. CPAP – no backup, test of extubation readiness.
* **VAP bundle:** head elevation, oral decontamination, sedation holidays, protocolized weaning. Specialized ET tubes (subglottic suction, silver coating) reduce VAP.
* **ARDS / hypoxemic failure:** low tidal volume (6 mL/kg), PEEP to avoid cyclic collapse, permissive hypercapnia. Prone positioning improves oxygenation but no mortality benefit; not safe after pneumonectomy. Inhaled prostacyclin (cheaper than NO) also effective.
* **Weaning ([Fig. 7-6](#fig-7-6)):** 75% of patients: assessment of readiness → spontaneous breathing trial → extubation. Daily assessment. Potentially reversible factors ([Table 7-2](#table-7-2)) include increased demand, increased resistive/elastic load, neuromuscular weakness, reduced drive, myocardial ischemia.
* **Pneumonectomy special considerations:** mediastinal shift due to fluid accumulation → restrictive load and pseudo‑obstruction (wheezing refractory to bronchodilators). Drain fluid to restore midline. Hemodynamic instability: rapid fluid accumulation ↓ preload, or removing air/fluid ↑ RV afterload.

### Chapter 8: Postoperative Management
* **Early ambulation** promotes airway clearance, decreases pneumonia, reduces DVT. BRAT staging protocol quantifies activity tolerance ([Table 8-1](#table-8-1)).
* **Chest tube management:** suction = minimum for full expansion. Large swings in water seal chamber → large residual pleural space. Tube not draining pneumothorax → loss of suction or leak overwhelming suction (50 L/min → central communication). When weaning suction, a rush of air at higher setting means previous setting inadequate. Small/intermittent leak: clamp, place on suction, release clamp – rush of air indicates accumulation.
* **Aspiration:** high risk after esophagectomy (complete vagotomy → dysmotility) and left pneumonectomy (elevated diaphragm, single remaining lung). Reverse Trendelenburg position (entire bed tilted). Large‑volume gastric aspiration → intubation, bronchoscopy, broad‑spectrum antibiotics.
* **Atrial fibrillation (30% of major thoracic surgery):** onset 24–96 h. Rate control (beta blockers, CCB, digoxin) over rhythm control (acute rhythm control rarely successful, most return to sinus within 6 weeks). Hyperperfusion pulmonary edema can occur with rapid AF in pneumonectomy patients → treat with esmolol.
* **Pulmonary embolism:** prophylax all thoracic patients (heparin, LMWH, compression). Helical CT angiography (PE‑CT) more sensitive than perfusion scan. D‑dimer useful.
* **Thoracic duct injury:** suspect if chest tube output >1 L/day after esophagectomy/mediastinal dissection. Milky fluid after enteral feeds, elevated triglycerides. Small leaks (<1 L/day) → water seal, maintain nutrition. Large (3–5 L/day) → surgical ligation (pledget, caudal in right chest) or transabdominal embolization.
* **Vocal cord paralysis (left RLN):** after mediastinoscopy or esophagectomy. Weak voice, ineffective cough, glottal gap on laryngoscopy. Treatment: temporary injection (absorbable material) or lateral laryngeal implant.
* **Sleeve lobectomy pulmonary edema:** impaired lymphatic drainage → 500 mL lung water in first 2 days → hypoxemia day 2‑3. Treatment: vigorous diuresis (~250 mL/h × 4 h = 20% of blood volume).
* **Esophageal anastomotic leak:** early (≤48 h) – technical, bilious drainage, mediastinitis. Late (7‑10 d) – ischemia of graft; cervical leaks (20%) can be drained by opening neck incision, usually not life‑threatening.
* **Bronchopleural fistula:** breakdown of stump weeks‑months postop → brown/rust sputum, new infiltrate, decreased air‑fluid level. Initial drainage (tube thoracostomy under local). If respiratory failure → open thoracic window (Clagett or Eloesser), pack tightly with mineral oil gauze to permit positive‑pressure ventilation. Close after 6 weeks – 6 months with muscle flap.

### Chapter 9: Pleural Drainage and Chest Tube Management
* **Safe triangle** for insertion: anterior border of latissimus dorsi, lateral border of pectoralis major, line superior to nipple. Tube above 5th rib to avoid diaphragm.
* **Technique ([Table 9-2](#table-9-2)):** local anesthesia, 3–4 cm incision, blunt dissection (Kelly clamp) on superior surface of rib (avoids neurovascular bundle), puncture pleura, digital exploration, insert tube (anticlockwise wrist for apical pneumothorax), secure with suture wrapped around tube.
* **Water seal systems:** traditional 3‑bottle (collection, water seal, suction) or modern disposable single‑chamber or three‑chamber ([Figs. 9-3 – 9-5](#fig-9-3)).
* **Complications ([Table 9-3](#table-9-3)):** intercostal artery perforation, perforation of lung/heart/diaphragm/abdominal organs, major vessels, intercostal neuralgia, subcutaneous emphysema, reexpansion pulmonary edema, infection, malposition/blockage.
* **Removal criteria:** no evidence that drainage threshold ≤200 mL/day increases reaccumulation (Younes trial). Respiratory phase at removal (end‑inspiration vs end‑expiration) does not affect recurrence (Bell trial). Institutional algorithms (Brigham and Women’s – [Figs. 9-6 – 9-8](#fig-9-6)) guide chest tube management, air leak, and water seal trial.

</div></details>

<details class="med-details"><summary>

## Chapter 1: Introduction</summary><div class="details-content">
...
The ongoing divergence of the two subspecialties of cardiothoracic surgery is attributable to the specialization of skills and knowledge required for the diagnosis and treatment of cardiac versus lung and chest wall disease. While it has been demonstrated that surgeons who work hard and keep abreast of their personal continuing medical education can be competent in both cardiac and thoracic operations, it is my personal belief that to create new knowledge in either field and to train dedicated cardiac or thoracic residents, a career dedicated to one or the other discipline is prerequisite. It goes without saying, for example, that acquiring sufficient knowledge to teach residents about the multitude of new cardiac valve replacement prostheses necessarily precludes the level of knowledge required to teach residents about the appropriate chemotherapy approaches in the multidisciplinary care of thoracic oncologic processes.
...
## Chapter 2: Thoracic Incisions</summary><div class="details-content">
...
### POSTEROLATERAL THORACOTOMY</summary><div class="details-content">

<details class="med-details"><summary>

#### General Use</summary><div class="details-content">
...
#### Advantage</summary><div class="details-content">

The posterolateral thoracotomy incision provides the best unobstructed view of the entire hemithorax ([Fig. 2-4](#fig-2-4)).
...
### ANTEROLATERAL THORACOTOMY</summary><div class="details-content">
...
These incisions generally are placed in the fourth or fifth intercostal space ([Fig. 2-5](#fig-2-5)). The fourth interspace (over the top of the fifth rib) provides excellent visualization of the anterior mediastinum and hilum at the level of the superior pulmonary vein. The fifth intercostal space (over the top of the sixth rib) provides better visualization for a middle lobectomy because it provides visualization of both the lower portion of the superior pulmonary vein and the top portion of the inferior pulmonary vein ([Fig. 2-6](#fig-2-6)).
...
#### Advantages</summary><div class="details-content">
...
The major structures in danger of injury are the long thoracic nerve to the serratus anterior muscle, the thoracodorsal nerve to the latissimus dorsi muscle, and the intercostobrachial nerve ([Fig. 2-7](#fig-2-7)). The long thoracic nerve can be identified as it passes under the axillary vein at the level of the second rib. It travels inferiorly along the serratus anterior muscle parallel with the lateral thoracic artery. The thoracodorsal nerve can be identified posterior to the long thoracic nerve, just anterior to the border of the latissimus dorsi muscle. The higher the interspace chosen, the shorter is the length of the bordering ribs, and the higher is the probability of injury to these nerves, especially if the incision is extended posteriorly. If the incision is placed in the first intercostal space, the intercostobrachial nerve also can be injured, resulting in numbness to the medial side of the arm.
...
### CLAMSHELL INCISION (BILATERAL THORACOSTERNOTOMY)</summary><div class="details-content">

<details class="med-details"><summary>

#### General Use</summary><div class="details-content">

This incision is used in rare circumstances where broad exposure is needed within both hemithoraces simultaneously ([Fig. 2-9](#fig-2-9)). Examples include double lung transplant, removal of bulky anterior mediastinal masses with lateral extensions beyond the midclavicular lines, and removal of bilateral multiple suspected metastases.
...
### MEDIAN STERNOTOMY</summary><div class="details-content">
...
### PARTIAL STERNOTOMY</summary><div class="details-content">
...
A partial sternotomy provides nearly the same visualization of the upper anterior mediastinum. Since the angle of Louis corresponds with the carina, any structure in the anterior or middle mediastinal compartment above the level of the carina can be easily approached with this incision. The extension into the neck with a hockey stick incision or a transverse collar incision allows proximal and distal control of the subclavian and carotid arteries, aortic arch, and internal jugular, subclavian, innominate, and brachiocephalic veins. This incision keeps the lower body of the sternum and the costal margins intact. This preserves the respiratory function of the lower ribs for patients with compromised respiratory function. There is less pain and fewer lifting restrictions are required owing to the partial osteotomy. Lifting after partial sternotomy is frequently limited to 20 lbs for 3 weeks, whereas with median sternotomy the lifting restrictions are generally imposed for 8 weeks. Finally, for obese patients, there is less lateral pull to disrupt the partial sternal closure because the lower body of the sternum is intact.

</div></details>

<details class="med-details"><summary>

#### Disadvantage</summary><div class="details-content">
...
### CERVICAL MEDIASTINOSCOPY</summary><div class="details-content">
...
### ANTERIOR MEDIASTINOSCOPY (PARASTERNAL, CHAMBERLAIN)</summary><div class="details-content">
...
This incision can be placed in either a right or left parasternal location, within the second to fourth interspace ([Fig. 2-14](#fig-2-14)). The most common location is over the top of the third rib in the left parasternal location, which provides access to the aortopulmonic window nodes. A 2‑cm transverse incision is made just to the left of the edge of the sternum (approximately 2 cm lateral to the midpoint of the sternum) and extended over the top of the third rib. Pectoralis major fibers are split along their course, and pectoralis minor fibers generally are more lateral. At the fascia over the external intercostal muscle, a branch of the internal mammary vessels generally can be identified, localizing the hidden vertical course of those vessels. The superficial and deep intercostal muscles are lifted from the top of the third rib down to the level of the intact pleura. The pleura is kept closed and is dissected bluntly from beneath the medial aspect of the incision, separating the pleura from the internal mammary vessels. Blunt dissection is continued beneath the sternum and onto the lateral border of the ascending aorta. At this point, a mediastinoscope is inserted, and dissection is continued with blunt insertion of the scope and a sucker tip to the level of the aortopulmonic window. Some surgeons prefer a double‑lumen endotracheal tube for lung isolation, which may facilitate keeping the pleura closed during the mediastinal dissection. The vacuum within the pleural space pulls the mediastinal pleura laterally during deflation of the ipsilateral lung.
...
### OPEN THORACOSTOMY (ELOESSER FLAP AND CLAGETT WINDOW)</summary><div class="details-content">
...
## Chapter 3: Chest Imaging: Role of CT, PET/CT, and MRI</summary><div class="details-content">
...
### POSITRON‑EMISSION TOMOGRAPHY WITH REGISTERED CT</summary><div class="details-content">
...
**Figure 3-2.** Transaxial CT and transaxial PET images presented over a fused transaxial image and projection image, which also can rotate during interpretation. Small nodule in right upper lobe demonstrates no ¹⁸F‑FDG avidity. This determination is reliable only for nodules larger than 7 mm in diameter.
...
### RADIOLOGIC ANATOMY</summary><div class="details-content">
...
#### Pleura</summary><div class="details-content">
...
| Lung cancer | Spiculated, lobulated, or smooth margins<br>Dystrophic calcifications<br>Large lesions with necrosis<br>Cavitation in squamous cell carcinoma and adenocarcinoma |
...
| Solid pulmonary metastasis | Nonspecific, although may have appearance characteristic of primary tumor |
...
##### Benign Nodules</summary><div class="details-content">
...
##### Carcinoid</summary><div class="details-content">
...
##### TABLE 3-3: DIFFERENTIAL DIAGNOSIS OF MEDIASTINAL MASSES</summary><div class="details-content">

| MASS | DIFFERENTIAL DIAGNOSIS | LOCATION | FEATURES |
|------|------------------------|----------|----------|
| Anterior mediastinal mass | Thyroid mass<br>Thymoma or thymic cyst<br>Lymphoma and small cell lung cancer<br>Germ cell tumor | Contiguous with thyroid gland<br>Thymic bed<br>All lymph node stations in superior mediastinum, thymic bed, prevascular space, aorticopulmonic window<br>Variable, including prevascular space and thymic bed | Deviation of trachea<br>Smoothly marginated<br>May be lobulated<br>Mass may involve multiple lymph node groups<br>Hilar lymph node enlargement may be asymmetric<br>Hodgkin disease spreads from thymic bed to middle mediastinum to hilar lymph nodes<br>Fat, hair, and teeth are diagnostic<br>May be homogeneous with smooth margins |
| Middle mediastinal mass | Duplication cyst (includes bronchogenic cyst)<br>Lymphadenopathy<br>Pericardial cyst<br>Thyroid mass (intrathoracic goiter)<br>Tracheal tumor<br>Vascular variants and abnormalities | Most often located at bifurcation of trachea and central airways<br>All lymph node stations, including subcarinal space<br>Adjacent to heart, especially in cardiophrenic sulcus<br>Thyroid, extending into thorax (15% extend behind trachea)<br>Within or surrounding trachea<br>Posterior to trachea<br>Anterior or posterior to esophagus | Smoothly marginated<br>High‑attenuation fluid<br>May appear as separate enlarged nodes or as a multiple lymph node mass<br>Low attenuation indicates tuberculosis<br>Single site with enhancement indicates Castleman disease<br>Smoothly marginated<br>Water attenuation<br>Can represent pericardial diverticulum if history of mediastinoscopy<br>Appearance of thyroid tissue heterogeneous, can include calcifications and focal fluid<br>Narrowing of trachea<br>Adenoid cystic carcinoma has more tumor outside trachea (“toothpaste” lesion)<br>Diverticulum of Kommerell with aberrant subclavian artery<br>Vascular rings and slings |
| Posterior mediastinal mass | Esophageal abnormalities and masses<br>Neurogenic tumor<br>Extramedullary hematopoiesis | Large esophageal mass can occupy middle and posterior compartments<br>Connected to neural foramen<br>Paraspinal masses | Esophageal cancer<br>Foregut duplication cyst<br>Smoothly marginated or lobulated<br>May have low attenuation<br>May contain fat<br>Masses are often paired<br>Smoothly marginated |
...
### Horizons: CT screening and tumor ablation</summary><div class="details-content">
...
## Chapter 4: Preoperative Evaluation of Thoracic Surgery Patient</summary><div class="details-content">
...
### MOST COMMON COMPLICATIONS AFTER THORACIC SURGERY</summary><div class="details-content">
...
### GOALS OF PREOPERATIVE EVALUATION</summary><div class="details-content">
...
Although the field of thoracic surgery has been dramatically altered by the development of new technologies, both in imaging and in therapeutics, the history and physical examination remain the most important components of the preoperative evaluation. There is no substitute for a careful history and physical examination when it is performed by an experienced clinician. [Table 4-1](#table-4-1) highlights the important components of the patient history. Although age is a risk factor for perioperative morbidity and often a factor used by both patient and physician to assess the risk and potential benefit of surgery, much of this added risk is a consequence of the accompanying comorbidities. Recent publications suggest age alone is not an independent factor predicting mortality. Chambers et al. showed that 30‑day mortality rates, hospital length of stay, and global quality of life (QoL) were not influenced by age (age <70 years vs. age ≥70 years). Similar findings were found by Okami et al., who reported that octogenarian patients with stage I lung cancer had reasonable long‑term outcomes.
...
##### TABLE 4-1: IMPORTANT COMPONENTS OF THE HISTORY IN PREOPERATIVE EVALUATION</summary><div class="details-content">
...
### Laboratory Studies</summary><div class="details-content">
...
### Imaging Studies</summary><div class="details-content">
...
### Pulmonary Function Testing</summary><div class="details-content">
...
Preoperative pulmonary function testing is mandatory for patients who are being considered for pulmonary parenchymal resection. Although a number of pulmonary function tests have been examined in this setting, two have emerged with predictive value for postoperative complications. These are the forced expiratory volume in 1 second (FEV₁) measured during spirometry and the diffusing capacity of the lung for carbon monoxide (D<sub>LCO</sub>). Either of these values can be used to provide an estimate of the risk of operative morbidity and mortality. In addition, they are used to calculate the *predicted postoperative* (*ppo*) values for FEV₁ and D<sub>LCO</sub> (ppo‑FEV₁ and ppo‑D<sub>LCO</sub>, respectively).

<details class="med-details"><summary>

#### Prediction of Postoperative Lung Function</summary><div class="details-content">
...
Simple calculation is based on the assumption that the patient’s lung function is homogeneously distributed. The calculation requires knowledge of the number of segments to be resected and the preoperative value. For FEV₁, the formula is ppo‑FEV₁ = preoperative FEV₁ × (1 – (number of unobstructed segments to be resected/total number of unobstructed segments)). The calculation is similar for D<sub>LCO</sub>. For most patients, this simple approach to calculation is sufficient and, as mentioned earlier, results in a conservative prediction of pulmonary function after recovery from surgery. Traditionally, a ppo‑FEV₁ or D<sub>LCO</sub> of 40% or lower was used to categorize a patient as a high risk for lung surgery. However, advances in perioperative management and surgical techniques (concomitant lung volume reduction and minimally invasive surgery) have further reduced the lower ppo limit to 30% in selected cases. For patients with ppo‑FEV₁ or ppo‑D<sub>LCO</sub> values <40%, the predicted postoperative product (PPP) may be used (where PPP = ppo‑FEV₁ × ppo‑D<sub>LCO</sub>). Patients with PPP <1650 have been shown to have a high risk of operative mortality.

In certain situations, simple calculation does not predict postoperative lung function accurately. The clinical situations for which regional assessment of lung function is indicated are summarized in [Table 4-2](#table-4-2). A number of approaches have been used to attempt to assess the regional distribution of lung function, including lateral position testing, bronchospirometry, quantitative radionuclide ventilation/perfusion scanning, and quantitative CT scanning. Although quantitative CT scanning holds promise in this regard, the current standard test is radionuclide scanning. Typically, the data from quantitative radionuclide perfusion scans are reported as the percent function contributed by the six lung regions: upper third, middle third, and lower third of each hemithorax. These data, combined with the preoperative lung function value and the location and planned extent of surgical resection, permit a calculation to be made of the ppo value. Using the quantitative V̇/Q̇ data, the ppo‑FEV₁ or ppo‑D<sub>LCO</sub> is calculated as ppo value = baseline value × (100 – percent perfusion in the region of planned resection)/100.

<span id="table-4-2"></span>
<details class="med-details"><summary>

##### TABLE 4-2: INDICATIONS FOR PREOPERATIVE ASSESSMENT OF THE REGIONAL DISTRIBUTION OF LUNG FUNCTION</summary><div class="details-content">

- Significant airflow obstruction on spirometry (FEV₁ <65% of predicted and FEV₁/FVC <0.70)
...
### CARDIAC ASSESSMENT</summary><div class="details-content">
...
## Chapter 5: Anesthesia Management</summary><div class="details-content">
...
### OVERVIEW: CONDUCT OF THORACIC ANESTHESIA FOR PULMONARY RESECTION</summary><div class="details-content">
...
Induction risk is increased in patients with threatened major airways, tamponade physiology, difficult airway anatomy, and traumatic or emergency scenarios. Paraneoplastic or associated syndromes (e.g., carcinoid syndrome, myasthenia gravis, Eaton‑Lambert syndrome) have specific management implications (see below). Factors predictive of desaturation during OLV may be identified in advance ([Table 5-1](#table-5-1)).

Patient medication regimens, in general, should not be disrupted, with the exception of insulin, oral hypoglycemic agents, and anticoagulants. Guidelines for how long anticoagulants should be held before placing an epidural have been published in a consensus statement by the American Society of Regional Anesthesia ([Table 5-2](#table-5-2)). Patients with ischemic cardiac disease may benefit from thoracic epidural analgesia (TEA) and invasive hemodynamic monitoring despite a minimally invasive surgical approach. In such patients, perioperative beta‑adrenergic blockade should not be withheld for fear of bronchospasm. Avoiding inhalational anesthetics and narcotics by use of total intravenous anesthetic (TIVA) techniques, together with TEA, may enable early extubation despite severe obstructive lung disease.

<span id="table-5-1"></span>
<details class="med-details"><summary>

#### TABLE 5-1: FACTORS ASSOCIATED WITH DESATURATION DURING OLV</summary><div class="details-content">
...
#### TABLE 5-2: RECOMMENDED DURATION TO HOLD ANTICOAGULANTS BEFORE EPIDURAL</summary><div class="details-content">
...
| Low‑molecular‑weight heparin – high dose | 24 h |
| Low‑molecular‑weight heparin – low dose | 12 h |
| Coumadin | 3 d |
...
### INDUCTION</summary><div class="details-content">
...
#### Physiology of Induction</summary><div class="details-content">
...
### AUTO‑PEEP</summary><div class="details-content">

Failure to fully expire the preceding tidal volume at inspiration results in air trapping or auto‑PEEP ([Fig. 5-3](#fig-5-3)). Auto‑PEEP may lead to hemodynamic instability (including cardiac arrest) and barotrauma from dynamic hyperinflation. During OLV, excessive auto‑PEEP in the dependent lung impairs gas exchange by diverting pulmonary blood flow to the nondependent lung. The incidence and severity of auto‑PEEP roughly correlate with the severity of obstructive disease ([Fig. 5-4](#fig-5-4)) and is further exacerbated by the higher airflow resistance of DLTs and by inappropriate ventilator settings.

<span id="fig-5-3"></span>![](_page_45_Figure_2.jpeg)

**Figure 5-3.** Schematic depiction of the development of dynamic pulmonary hyperinflation (auto‑PEEP) and its resolution with a period of apnea. (Reproduced with permission.)

<span id="fig-5-4"></span>![](_page_45_Figure_16.jpeg)

**Figure 5-4.** Relationship between the degree of airflow obstruction (FEV₁/FVC) and dynamic pulmonary hyperinflation (auto‑PEEP). (Reproduced with permission.)

</div></details>

<details class="med-details"><summary>

### LUNG ISOLATION</summary><div class="details-content">

Options for lung isolation remain threefold: DLTs, BBs, and endobronchial intubation.

<details class="med-details"><summary>

#### Double‑Lumen Tubes</summary><div class="details-content">

The default choice for lung isolation in most cases is a left DLT for its ease of insertion, comfortable margin for error, and capacity to deflate either lung depending on which lumen is clamped. Auscultation may be used to confirm position, but direct visualization by fiberoptic bronchoscopy is increasingly a standard of care ([Fig. 5-5](#fig-5-5)). Up to 30% of patients with DLTs positioned by auscultation require repositioning when subsequently examined by fiberoptic bronchoscopy. If the left DLT passes into the right main stem bronchus instead of the left, the fiberoptic bronchoscope may be used as a stylette via the bronchial lumen to guide the tube into the left bronchus after withdrawal to the trachea. Reconfirmation of DLT position should be performed after turning the patient to the lateral decubitus position.

Right‑sided DLTs have a fenestration in the bronchial lumen for the right upper lobe that must be aligned by fiberoptic bronchoscopy ([Fig. 5-6](#fig-5-6)). Common indications include any surgery in which pathology exists or any surgery intended in the left main stem bronchus (e.g., left pneumonectomy, sleeve resection, bronchopleural fistula repair, or left single‑lung transplant). The likelihood of displacement is greater for a right‑sided DLT than for a left‑sided DLT. Because of this, some practitioners prefer to use a left‑sided DLT (or a BB) for left pneumonectomy and to withdraw the apparatus before division of the bronchus. Right‑sided DLTs cannot accommodate an anomalously short right main stem bronchus.
...
**Figure 5-7.** A. Arndt wire‑guided BB passed through a single‑lumen tube into the left main stem bronchus. B. Bronchoscopic view of the same BB.

</div></details>

<details class="med-details"><summary>

#### Endobronchial Intubation</summary><div class="details-content">
...
#### Special Lung Isolation Situations</summary><div class="details-content">
...
#### HYPOXEMIA DURING OLV</summary><div class="details-content">

The incidence of hypoxemia during OLV has dropped from more than 20% in the 1970s to less than 1% owing to improved DLT designs, increased use of the fiberoptic bronchoscope, and improved understanding of the physiology of OLV. Treatment options for hypoxemia during OLV are listed in [Table 5-3](#table-5-3). Which maneuver to employ first depends on the clinical scenario. In rapid, severe desaturation, reinflation should be the first move, coordinated with the surgeon. If time permits, passage of a bronchoscope to confirm tube/blocker position and to rule out secretions, blood, kinks, or other causes of obstruction is prudent.

<span id="table-5-3"></span>
<details class="med-details"><summary>

##### TABLE 5-3: TREATMENT OPTIONS FOR HYPOXEMIA DURING OLV</summary><div class="details-content">

- F<sub>I</sub>O₂ = 1
- Bronchoscopy to rule out tube malposition, secretions, other sources of obstruction
...
#### CPAP and Optimal PEEP During OLV</summary><div class="details-content">
...
#### Other Strategies to Improve Oxygenation During OLV</summary><div class="details-content">
...
### FLUID MANAGEMENT AND POSTPNEUMONECTOMY PULMONARY EDEMA</summary><div class="details-content">
...
**Figure 5-8.** Sanders jet ventilator.

</div></details>

<details class="med-details"><summary>

### PAIN MANAGEMENT</summary><div class="details-content">
...
#### Thoracic Epidural Analgesia</summary><div class="details-content">
...
The most common side effect from TEA is hypotension from local anesthetic blockade of presynaptic sympathetic nerves. Sympatholysis results in dilation of venous capacitance vessels, venous pooling (especially in the splanchnic bed), and possibly reduced cardiac contractility. Treatment consists of intravascular volume expansion, vasopressors, and inotropes. Other complications of TEA are listed in [Table 5-4](#table-5-4).
...
##### TABLE 5‑4: COMPLICATIONS OF THORACIC EPIDURAL ANALGESIA</summary><div class="details-content">
...
#### Pain Management Other Than TEA</summary><div class="details-content">
...
### SYNOPSIS OF ANESTHETIC ISSUES FOR SPECIFIC PROCEDURES</summary><div class="details-content">
...
**Tracheostomy**
- Low F<sub>I</sub>O₂ during electrocautery with open trachea (fire hazard).
...
**Laser Core‑Out**
- Lowest possible F<sub>I</sub>O₂; avoid N₂O (supports combustion).
...
#### Atrial Arrhythmias</summary><div class="details-content">

Atrial fibrillation and atrial flutter are common after thoracic surgery. The incidence can be as high as 44% following extrapleural pneumonectomy. A number of factors have been associated with the occurrence of atrial arrhythmias ([Table 6-2](#table-6-2)). Etiologies may include elevated catecholamines, myocardial ischemia, pulmonary hypertension, atrial enlargement, hypoxemia, electrolyte imbalances, mechanical displacement of the heart, and vagal nerve irritation. Trials in the cardiac surgery population have shown that prophylaxis with beta blockers, calcium channel blockers, sotalol, amiodarone, statins, or corticosteroids may decrease the incidence of atrial fibrillation.
...
##### TABLE 6‑2: FACTORS ASSOCIATED WITH ATRIAL ARRHYTHMIAS</summary><div class="details-content">
...
#### Bronchospasm and Chronic Obstructive Pulmonary Disease Exacerbation</summary><div class="details-content">
...
#### Hypotension</summary><div class="details-content">
...
#### Pulmonary Hypertension and Right Ventricular Failure</summary><div class="details-content">
...
#### Bronchopleural Fistula</summary><div class="details-content">
...
### CARE OF THE PATIENT WITH ARDS</summary><div class="details-content">
...
### GOAL‑DIRECTED MANAGEMENT OF THE SEPTIC PATIENT</summary><div class="details-content">
...
### PREVENTION OF SECONDARY COMPLICATIONS</summary><div class="details-content">
...
#### Malnutrition</summary><div class="details-content">
...
#### Hyperglycemia</summary><div class="details-content">
...
#### Nosocomial Blood Stream Infection</summary><div class="details-content">
...
#### Critical Illness Polyneuropathy and Acute Myopathy</summary><div class="details-content">
...
## Chapter 7: Mechanical Ventilation</summary><div class="details-content">
...
### EFFECTS OF ANESTHESIA AND THORACIC SURGERY ON RESPIRATORY SYSTEM PHYSIOLOGY</summary><div class="details-content">
...
### POSTOPERATIVE VENTILATOR STRATEGIES</summary><div class="details-content">
...
### EXTUBATION OF THE STABLE PATIENT</summary><div class="details-content">
...
### VENTILATOR SUPPORT WITH POSTOPERATIVE RESPIRATORY COMPROMISE</summary><div class="details-content">
...
2. Early weaning of F<sub>I</sub>O₂ to prevent adsorption atelectasis and limit possible oxygen toxicity, especially in patients receiving medications that have been associated with free‑radical lung injury (e.g., bleomycin).
...
### ANATOMY OF THE VENTILATOR</summary><div class="details-content">
...
### CONVENTIONAL MODES OF VENTILATION</summary><div class="details-content">
...
#### Assist/Control Mode Ventilation (ACMV)</summary><div class="details-content">

In *assist*/*control mode ventilation* (ACMV), an inspiratory cycle is initiated either by the patient’s breathing effort or, if no patient effort is detected within a specified time window, by a timer signal within the ventilator based on user‑specified parameters. Every breath delivered, whether patient‑ or timer‑triggered, consists of the operator‑specified tidal volume. Ventilatory rate is determined either by the patient or by the operator‑specified backup rate, whichever is of higher frequency ([Fig. 7-2](#fig-7-2)). ACMV is used commonly for initiation of mechanical ventilation because it ensures a backup minute ventilation in the absence of an intact respiratory drive and allows for synchronization of the ventilator cycle with the patient’s inspiratory effort.
...
#### Continuous Positive Airway Pressure (CPAP)</summary><div class="details-content">

CPAP is not a true support mode of ventilation because ventilation occurs through the patient’s spontaneous efforts. The ventilator provides fresh gas to the breathing circuit with each inspiration and charges the circuit to a constant operator‑specified pressure that can range from 0 to 20 cm H₂O ([Fig. 7-5](#fig-7-5)). CPAP is used to assess extubation potential in patients who have been weaned effectively and are requiring little ventilator support.
...
Finally, there is increasing evidence that some prophylactic interventions commonly used in the inpatient setting may have unintended consequences. Recently, Herzig et al. demonstrated that in a single‑center survey of over 63,000 hospital admissions, medical suppression of gastric acid was associated with a 30% increased odds of hospital‑acquired pneumonia. These data and other investigations linking pharmacologic acid suppression to VAP suggest that altering the pH of gastric secretions may facilitate pathologic colonization. Further investigation is required to determined how best to weigh the apparent risks of these medications with their obvious benefits.

</div></details>

<details class="med-details"><summary>

### VENTILATION OF THE POSTOPERATIVE THORACIC SURGERY PATIENT WITH HYPOXEMIC RESPIRATORY FAILURE</summary><div class="details-content">

A commonly used metric to assess the severity of hypoxemic respiratory failure is the ratio of the partial pressure of oxygen in the arterial blood (PaO₂) divided by the fraction of inspired oxygen (F<sub>I</sub>O₂: ranging from 0.21 or ambient gas to 1 which corresponds to 100% oxygen). A patient with a PaO₂/F<sub>I</sub>O₂ ratio less than 300 but more than 200 is categorized as having ALI whereas those with a ratio less than or equal to 200 is categorized as having acute respiratory distress syndrome (ARDS). It is estimated that the mortality associated with ARDS is between 25% and 40%. And while it is increasingly clear that one of the greatest risks for the development of this condition is the presence of ALI, there are no specific recommendations pertaining to ventilatory strategies in this cohort.
...
#### TABLE 7‑2: POTENTIALLY REVERSIBLE FACTORS THAT MAY CONTRIBUTE TO DISCONTINUATION FAILURE</summary><div class="details-content">

1. **Increased ventilatory demand**
   - Increased dead space (pulmonary embolism, hypoperfusion, V/Q mismatch)
   - Increased CO₂ production (fever, sepsis, overfeeding)
   - Metabolic acidosis
   - Anxiety, pain
...
### PRINCIPLES OF POSTOPERATIVE CARE</summary><div class="details-content">
...
### Extubation</summary><div class="details-content">
...
### Pain</summary><div class="details-content">
...
### Air Leak/Chest Tube Management</summary><div class="details-content">
...
A CT scan of the chest may be needed to determine the amount of air in the thoracic cavity and assess the relative advantage of placing additional chest drains ([Fig. 8-1](#fig-8-1)).
...
### Fluid Management</summary><div class="details-content">
...
All patients benefit from reverse Trendelenburg positioning, which tilts the entire plane of the bed such that the head is elevated with respect to the legs ([Fig. 8-2](#fig-8-2)). Merely raising the head end of the bed by 30 degrees is inadequate because it is difficult to maintain the patient in this position and can even increase intraabdominal pressure. Patients who have had a left pneumonectomy are at particular risk for aspiration. The elevated left hemidiaphragm compromises hiatal antireflux mechanisms, and the single remaining lung makes any aspiration life threatening. Other patients at high risk for aspiration are esophagectomy patients. These patients may have prolonged gastrointestinal dysmotility because of acute thoracic vagotomy. To improve drainage of the gastric interposition graft, a pyloroplasty usually is performed, and some type of tube compression is often required for up to a week after surgery.
...
### Ventilation</summary><div class="details-content">
...
Antiarrhythmic agents typically are classified by the Vaughan Williams classification system. This scheme attempts to classify agents based on their mechanism of action but is limited by the need to account for agents with multiple mechanisms (e.g., sotalol) or active metabolites with disparate functions (e.g., procainamide) ([Table 8-2](#table-8-2)).
...
#### TABLE 8‑2: VAUGHAN WILLIAMS CLASSIFICATION OF ANTIARRHYTHMIC AGENTS</summary><div class="details-content">

| CLASS | MECHANISM | EXAMPLES |
|-------|-----------|----------|
| Ia | Interfere with Na⁺ channel | Quinidine, Procainamide |
| II | Slow conduction through atrioventricular node | Esmolol, Propranolol, Metoprolol |
| III | Blocks K⁺ channel and prolongs repolarization | Amiodarone, Ibutilide, Sotalol |
| IV | Calcium channel blockers slow AV node conduction | Verapamil, Diltiazem |
| V | Other mechanisms | Adenosine, Digoxin |

Source: From Hagens VE, et al. J Am Coll Cardiol. 2004;43(2):241–247.
...
### Pulmonary Embolism</summary><div class="details-content">
...
#### Thoracic Duct Injury</summary><div class="details-content">
...
#### Vocal Cord Paralysis</summary><div class="details-content">
...
#### Pulmonary Edema After Sleeve Lobectomy</summary><div class="details-content">
...
#### Esophageal Anastomotic Leak</summary><div class="details-content">
...
## Chapter 9: Techniques for Pleural Drainage and Chest Tube Management</summary><div class="details-content">
...
Chest tubes are indicated for both emergent and elective situations. The most common indication for tube thoracostomy is pneumothorax and/or hemothorax. Other indications are summarized in [Table 9-1](#table-9-1). There are no absolute contraindications to drainage by means of chest tube, especially in the case of life‑threatening emergency. Relative contraindications to chest tube insertion include postoperative inflammatory and infective pleural space adhesions, presence of a diaphragmatic hernia, or hepatic hydrothorax with documented coagulopathy.

<span id="table-9-1"></span>
<details class="med-details"><summary>

#### TABLE 9‑1: INDICATIONS FOR CHEST TUBE INSERTION</summary><div class="details-content">
...
Complications of chest tube insertion are summarized in [Table 9-3](#table-9-3). The most important complications include bleeding from intercostal artery perforation, perforation of visceral organs (lung, heart, diaphragm, or intra‑abdominal organs), and perforation of major vascular structures.

<span id="table-9-3"></span>
<details class="med-details"><summary>

#### TABLE 9‑3: COMPLICATIONS OF CHEST TUBE INSERTION</summary><div class="details-content">
...
### CHEST TUBE MANAGEMENT</summary><div class="details-content">
