...
* **Literature review outcomes:** R0 resection 76-100%; median lymph node retrieval 14-38; conversion rate mean 4% (0-15%); anastomotic leak average 17%.
...
* **Complete remission rate (MG):** Robotic 39.25% vs. VATS 20.3% at 42 months (p=0.01).
* **Thymoma outcomes (Masaoka I-II, 1-12 cm):** 5-year survival 90%.
...
* **Failed conventional techniques:** Blue dye — obscured by anthracotic (black) nodes; radioisotope — "shine through" from injection site.
* **Near-infrared (NIR) imaging with ICG:** FDA-approved fluorophore; NIR light penetrates 1 cm tissue; success rate >90% in large animals; 80% identification rate in clinical trials.

### Genomics and Targeted Therapy in NSCLC
* **Driver mutations in adenocarcinoma:** EGFR (10-15%), KRAS (20-25%), BRAF (3-4%), ALK fusion (3-7%).
* **EGFR TKI response (activating mutations):** RR 70-80%, median PFS 9-13 months.
* **ALK inhibitor crizotinib:** RR 53-57%; FDA approved for ALK-positive NSCLC.

### Genomics and Targeted Therapy in Esophageal Cancer
* **EAC progression sequence:** Barrett metaplasia → dysplasia → adenocarcinoma.
* **HER2/neu in EAC:** Amplification frequent, associated with worse prognosis; targeted by trastuzumab.
* **ToGA trial:** Trastuzumab + chemotherapy improved OS in HER2+ advanced gastric/GEJ cancer.

### Nanoparticle Therapy in Lung Cancer
* **NP advantages:** Increase solubility of insoluble drugs (paclitaxel, docetaxel); alter pharmacokinetics; potential tissue targeting.
* **Abraxane (nab-paclitaxel):** No Cremophor EL; higher MTD; improved overall response rate vs. conventional paclitaxel.
...
* **Toronto technique (prolonged normothermic EVLP):** Acellular perfusate; PAP 10-13 mm Hg, LA pressure 5 mm Hg; ventilation: TV 7 mL/kg, rate 7 bpm, PEEP 5 cm H₂O; duration up to 12 hours.
* **Clinical outcomes:** PGD3 at 72 hours: 2% (EVLP) vs. 8.5% (controls); 1-year survival 87% (EVLP) vs. 86% (controls).

### Endoscopic Resection Techniques for Esophageal Cancer
* **Indications — Barrett adenocarcinoma:** High-grade intraepithelial neoplasia (HGIN) and mucosal cancer; long-term complete response 94.5%.
* **ER with ligation device:** Suction lesion into cylinder → release rubber band → resect pseudopolyp with snare.
* **ER with transparent cap:** Submucosal injection → suction lesion into cap → resect with snare.
* **Endoscopic submucosal dissection (ESD):** En bloc resection up to >10 cm; higher complication rate, requires experience.

</div></details>

<details class="med-details"><summary>

## Chapter 165: Robotics: Lobectomy</summary><div class="details-content">
...
The operating room technical staff sets up the robotic surgical system (surgical cart, surgeon's console, vision system) in the room. In the beginning of the case the nursing staff power up the system, run the appropriate diagnostics, and drape the robotic arms and camera. This requires two individuals and typically takes 5 to 10 minutes for staff who are trained and are familiar with the process and occurs prior to or while the patient is undergoing induction of anesthesia and positioning.
...
Completion of the fissure is performed last, just prior to removal of the specimen. For upper lobectomy the entire fissure is divided with endoscopic staplers; for middle and lower lobectomies the anterior portion of the fissure is often divided with electrocautery in the course of dissection of the hilar structures. The remaining posterior portion of the fissure is then completed using the endoscopic staplers.
...
## Chapter 166: Robotics: Esophagectomy</summary><div class="details-content">
...
## Chapter 167: Robotics: Thymectomy</summary><div class="details-content">
...
## Chapter 168: Sentinel Node Mapping in Lung Cancer</summary><div class="details-content">
...
The search for a better technique has led surgical groups to innovate by exploring nonradioactive agents that not only promise more reliable and accurate SLN identification but also the potential for therapeutic intraoperative targeting of nodal metastases.
...
## Chapter 169: Genomics, Molecular Markers, and Targeted Therapies in Non Small-Cell Lung Cancer</summary><div class="details-content">
...
The EML4-ALK fusion oncogene results from the fusion of the N-terminal portion of the protein encoded by the echinoderm microtubule-associated protein-like 4 (*EML4*) gene with the intracellular signaling portion of the ALK receptor tyrosine kinase on the short arm of chromosome 2. ALK-positive patients are usually younger than the wild-type counterparts, never or light smokers, and have histology characterized by more than 10% signet ring cells. Kwak and colleagues evaluated the role of the ALK inhibitor crizotinib in 82 patients with advanced NSCLC and ALK rearrangement by fluorescence in situ hybridization (FISH), which was defined as positive if more than 15% of scored tumors had split *ALK*5' and 3' probe signals or isolated 3' signals. Among the enrolled patients, 62 (76%) were never smokers and only 5 (5%) were chemotherapy-naïve. The treatment was well tolerated with mild nausea and diarrhea as the most common toxicities. RRs were observed in 47 (53%) patients, whereas 27 (33%) had stable disease, and 6 (7%) had progressive disease. The estimated probability of PFS at 6 months was 72% with median PFS not reached. Based on these results, crizotinib received accelerated FDA approval for patients with advanced NSCLC and *ALK*-positive tumors. The PROFILE 1014 is a phase III trial comparing crizotinib to platinum plus pemetrexed as first-line therapy in patients with translocation or inversion involving the *ALK* gene locus.
...
## Chapter 170: Genomics, Molecular Markers, and Targeted Therapies in Esophageal Cancer</summary><div class="details-content">
...
## Chapter 171: Nanoparticle Therapy in Lung Cancer</summary><div class="details-content">
...
## Chapter 172: Ex Vivo Lung Perfusion</summary><div class="details-content">
...
## Chapter 173: Endoscopic Resection Techniques</summary><div class="details-content">
...
A common method is ER with a ligation device, also used for ligation of esophageal varices. With this method, the target lesion is sucked into the cylinder of the ligation device and a rubber band is then released to create a pseudopolyp that has the rubber band at its base. After this, the pseudopolyp is resected with a reusable snare underneath the rubber band to achieve larger resection specimens.
