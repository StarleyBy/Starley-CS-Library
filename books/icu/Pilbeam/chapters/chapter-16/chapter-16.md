...
* **Coronary blood flow:** Reduced by ↓ cardiac output, ↓ BP, coronary compression from high intrathoracic pressure. Coronary perfusion pressure = mean aortic diastolic pressure – LV end-diastolic pressure (for LV). Decreased gradient → myocardial ischemia.
...
* **Beneficial effects in LV dysfunction:** Positive pressure ↓ preload (improves length-tension in failing ventricle) and ↓ transmural LV systolic pressure (↓ afterload). Improved oxygenation from PEEP may also help.
